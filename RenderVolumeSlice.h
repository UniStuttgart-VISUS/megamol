...
#ifndef MEGAMOLCORE_RENDERVOLUMESLICE_H_INCLUDED
#define MEGAMOLCORE_RENDERVOLUMESLICE_H_INCLUDED
...
namespace core {
     ...
     */
    class RenderVolumeSlice : public view::Renderer3DModule {
    public:
...
#endif /* MEGAMOLCORE_RENDERVOLUMESLICE_H_INCLUDED */
