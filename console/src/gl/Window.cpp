...
void gl::Window::glfw_onKey_func(GLFWwindow* wnd, int k, int s, int a, int m) {
    ...
    // Different modifier behaviour between X Server and Windows, see https://github.com/glfw/glfw/issues/1630.
    // Emulate Windows behaviour for uniform interface within MegaMol.
#ifdef _WIN32
