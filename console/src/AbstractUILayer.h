...
namespace gl {
    ...
    public:
        ...
        enum class MouseButton : int { // based on GLFW
            Left = 0,
            Middle = 2,
            Right = 1,
            Button_1 = 0,
        ...
        // return true when event was consumed
        virtual void onResize(int w, int h);
        virtual void onDraw();
        // use platform dependent 'scancode' iff 'key' is 'KEY_UNKNOWN'
    ...
    protected:
        ...
        AbstractUILayer(gl::Window& wnd);
        virtual ~AbstractUILayer();
