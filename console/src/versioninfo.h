...
#define MEGAMOL_CONSOLE_MAJOR_VER MEGAMOL_VERSION_MAJOR
#define MEGAMOL_CONSOLE_MINOR_VER MEGAMOL_VERSION_MINOR
...
#define MEGAMOL_CONSOLE_COMMENTS "MegaMol Core API " MEGAMOL_STRINGIZE(MEGAMOL_CORE_COMP_REV) "\n" MEGAMOL_CONSOLE_DIRTYTEXT
