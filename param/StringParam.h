...
#ifndef MEGAMOLCORE_STRINGPARAM_H_INCLUDED
#define MEGAMOLCORE_STRINGPARAM_H_INCLUDED
...
namespace param {
     ...
     */
    class MEGAMOLCORE_API StringParam : public AbstractParam {
    public:
         ...
         * @param initVal The initial value
         */
        StringParam(const char *initVal);
         ...
         * @param initVal The initial value
         */
        StringParam(const wchar_t *initVal);
...
#endif /* MEGAMOLCORE_STRINGPARAM_H_INCLUDED */
