 ...
 */
void megamol::console::utility::CmdLineParser::GetParameterValueOptions(
        vislib::Map<vislib::TString, vislib::TString>& outParamValues) const {
...
unsigned int megamol::console::utility::CmdLineParser::parseAsLogLevel(
    ...
    try {
        ...
        if (str.Equals("error", false)) {
            return vislib::sys::Log::LEVEL_ERROR;
        } else if (str.Equals("warn", false)) {
            return vislib::sys::Log::LEVEL_WARN;
        } else if (str.Equals("warning", false)) {
            return vislib::sys::Log::LEVEL_WARN;
        } else if (str.Equals("info", false)) {
            return vislib::sys::Log::LEVEL_INFO;
        } else if (str.Equals("none", false)) {
            return vislib::sys::Log::LEVEL_NONE;
        } else if (str.Equals("null", false)) {
            return vislib::sys::Log::LEVEL_NONE;
        } else if (str.Equals("zero", false)) {
            return vislib::sys::Log::LEVEL_NONE;
        } else if (str.Equals("all", false)) {
