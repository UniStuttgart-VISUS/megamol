...
open my $batch, ">", "NGSphereTest.bat" or die "cannot open batch file";
...
foreach my $f (@outfiles) {
    ...
    print $fh qq{mmCreateModule("NGSphereRenderer", "::rnd")\n};
    ...
    print $fh qq{mmSetParamValue("::imgmaker::filename", "}.getcwd().qq{/$f.png")\n};
