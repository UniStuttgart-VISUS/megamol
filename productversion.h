...
#define MEGAMOL_PRODUCT_MAJOR_VER 0
#define MEGAMOL_PRODUCT_MINOR_VER 4
#define MEGAMOL_PRODUCT_MAJOR_REV 0
#define MEGAMOL_PRODUCT_MINOR_REV 0


#define MEGAMOL_DIRTYWARNING "UNCLEAN PRERELEASE VERSION. ONLY USE FOR DEVELOPMENT WITHIN VISUS.\n"
...
#define MEGAMOL_PRODUCT_COMPANY "VISUS (Universitaet Stuttgart, Germany)"
