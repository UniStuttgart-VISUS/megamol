...
#ifndef MEGAMOLCORE_EXTBEZIERRAYCASTRENDERER_H_INCLUDED
#define MEGAMOLCORE_EXTBEZIERRAYCASTRENDERER_H_INCLUDED
...
namespace misc {
     ...
     */
    class ExtBezierRaycastRenderer : public AbstractBezierRaycastRenderer {
    public:
...
#endif /* MEGAMOLCORE_EXTBEZIERRAYCASTRENDERER_H_INCLUDED */
