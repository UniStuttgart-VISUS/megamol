...
namespace moldyn {
    ...
    public:
        ...
        public:
            ...
            inline BrickInfo(UINT64 offset, UINT64 length,
                const BrickStatsType& left, const BrickStatsType& bottom, const BrickStatsType& back,
                const BrickStatsType& right, const BrickStatsType& top, const BrickStatsType& front,
                const BrickStatsType& meanX, const BrickStatsType& meanY, const BrickStatsType& meanZ,
                const BrickStatsType& stdDevX, const BrickStatsType& stdDevY, const BrickStatsType& stdDevZ) : 
