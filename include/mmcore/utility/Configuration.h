...
namespace xml {
    ...
    public:
         ...
         */
        const void * GetValue(mmcConfigID id, const char *name,
         ...
         */
        inline InstanceRequest
        GetNextInstantiationRequest(void) {
         ...
         */
        inline void AddPluginLoadInfo(const vislib::TString& dir,
                const vislib::TString& name, bool inc) {
            PluginLoadInfo pli;
