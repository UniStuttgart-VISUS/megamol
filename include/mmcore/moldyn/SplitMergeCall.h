...
#ifndef MEGAMOL_PROTEIN_SPLITMERGECALL_H_INCLUDED
#define MEGAMOL_PROTEIN_SPLITMERGECALL_H_INCLUDED
...
namespace moldyn {
	...
	class MEGAMOLCORE_API SplitMergeCall : public megamol::core::Call {
	public:
		...
		class MEGAMOLCORE_API SplitMergeGuide {
		public:
		 ...
		 */
		class MEGAMOLCORE_API SplitMergeSeries {
		public:
			/** Ctor. */
		 ...
		 */
		class MEGAMOLCORE_API SplitMergeTransition {
		public:
			/** Ctor. */
