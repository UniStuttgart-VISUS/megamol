...
#ifndef MMPROTEINPLUGIN_CRYSTALSTRCUTUREDATACALL_H_INCLUDED
#define MMPROTEINPLUGIN_CRYSTALSTRCUTUREDATACALL_H_INCLUDED
...
namespace moldyn{
	 ...
	 */
	class MEGAMOLCORE_API CrystalStructureDataCall : public megamol::core::AbstractGetData3DCall {
	public:
		 ...
		 */
		void SetAtoms(const float* atomPos, const AtomType* atomType,
	...
	typedef core::factories::CallAutoDescription<CrystalStructureDataCall>
		CrystalStructureDataCallDescription;

} /* end namespace moldyn */
} /* end namespace core */
} /* end namespace megamol */

#endif /* MMPROTEINPLUGIN_CRYSTALSTRCUTUREDATACALL_H_INCLUDED */
