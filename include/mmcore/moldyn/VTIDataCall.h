...
namespace moldyn {
	...
	class MEGAMOLCORE_API VTIDataCall : public core::AbstractGetData3DCall {
	...
	public:
		...
		inline Vec3i GetGridsize() const {
			return Vec3i(
				this->data->GetWholeExtent().Width() + 1,
				this->data->GetWholeExtent().Height() + 1,
		 ...
		 */
		inline VTKImageData::DataArray::DataType GetPiecePointArrayType(
		 ...
		 * @return The type of the data array.
		 */
		inline VTKImageData::DataArray::DataType GetPieceCellArrayType(
			unsigned int dataIdx,
			unsigned int pieceIdx) const {
		 ...
		 */
		inline size_t GetPiecePointArraySize(unsigned int dataIdx,
			unsigned int pieceIdx) const {
		 ...
		 * @return The number of elements in the array.
		 */
		inline size_t GetPieceCellArraySize(unsigned int dataIdx,
			unsigned int pieceIdx) const {
