...
#ifndef MEGAMOL_PROTEIN_SELECTIONCALL_H_INCLUDED
#define MEGAMOL_PROTEIN_SELECTIONCALL_H_INCLUDED
...
namespace moldyn {
	...
	class MEGAMOLCORE_API IntSelectionCall : public megamol::core::Call {
	public:
		/**
