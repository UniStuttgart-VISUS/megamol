...
#ifndef MEGAMOLCORE_MOLDYN_MOLECULARDATACALL_H_INCLUDED
#define MEGAMOLCORE_MOLDYN_MOLECULARDATACALL_H_INCLUDED
...
#endif /* MEGAMOLCORE_MOLDYN_MOLECULARDATACALL_H_INCLUDED */
