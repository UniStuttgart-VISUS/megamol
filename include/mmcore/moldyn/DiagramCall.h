...
namespace moldyn {
	...
	class MEGAMOLCORE_API DiagramCall : public megamol::core::Call {
	public:
		...
		class MEGAMOLCORE_API DiagramGuide {
		public:
		 ...
		 */
		class MEGAMOLCORE_API DiagramMarker {
		public:

			/** Ctor. */
			DiagramMarker(SIZE_T index, MarkerTypes type,
				void *userData = NULL) : index(index),
		 ...
		 */
		class MEGAMOLCORE_API DiagramSeries {
		public:
			/** Ctor. */
