/*
    ...
    GLX loader generated by glad 0.1.14a0 on Wed Aug  9 11:06:29 2017.
...
GLAPI int isGLXExtAvailable(const char *extensionName) {
...
GLAPI int areGLXExtsAvailable(const char *extensionsNames) {
