...
GLLOADAPI int glXext_3DFX_multisample = 0;
GLLOADAPI int glXext_AMD_gpu_association = 0;
GLLOADAPI int glXext_ARB_create_context = 0;
GLLOADAPI int glXext_ARB_create_context_profile = 0;
GLLOADAPI int glXext_ARB_create_context_robustness = 0;
GLLOADAPI int glXext_ARB_fbconfig_float = 0;
GLLOADAPI int glXext_ARB_framebuffer_sRGB = 0;
GLLOADAPI int glXext_ARB_get_proc_address = 0;
GLLOADAPI int glXext_ARB_multisample = 0;
GLLOADAPI int glXext_ARB_robustness_application_isolation = 0;
GLLOADAPI int glXext_ARB_robustness_share_group_isolation = 0;
GLLOADAPI int glXext_ARB_vertex_buffer_object = 0;
GLLOADAPI int glXext_EXT_buffer_age = 0;
GLLOADAPI int glXext_EXT_create_context_es2_profile = 0;
GLLOADAPI int glXext_EXT_create_context_es_profile = 0;
GLLOADAPI int glXext_EXT_fbconfig_packed_float = 0;
GLLOADAPI int glXext_EXT_framebuffer_sRGB = 0;
GLLOADAPI int glXext_EXT_import_context = 0;
GLLOADAPI int glXext_EXT_swap_control = 0;
GLLOADAPI int glXext_EXT_swap_control_tear = 0;
GLLOADAPI int glXext_EXT_texture_from_pixmap = 0;
GLLOADAPI int glXext_EXT_visual_info = 0;
GLLOADAPI int glXext_EXT_visual_rating = 0;
GLLOADAPI int glXext_INTEL_swap_event = 0;
GLLOADAPI int glXext_MESA_agp_offset = 0;
GLLOADAPI int glXext_MESA_copy_sub_buffer = 0;
GLLOADAPI int glXext_MESA_pixmap_colormap = 0;
GLLOADAPI int glXext_MESA_release_buffers = 0;
GLLOADAPI int glXext_MESA_set_3dfx_mode = 0;
GLLOADAPI int glXext_NV_copy_image = 0;
GLLOADAPI int glXext_NV_float_buffer = 0;
GLLOADAPI int glXext_NV_multisample_coverage = 0;
GLLOADAPI int glXext_NV_present_video = 0;
GLLOADAPI int glXext_NV_swap_group = 0;
GLLOADAPI int glXext_NV_video_capture = 0;
GLLOADAPI int glXext_NV_video_output = 0;
GLLOADAPI int glXext_OML_swap_method = 0;
GLLOADAPI int glXext_OML_sync_control = 0;
GLLOADAPI int glXext_SGIS_blended_overlay = 0;
GLLOADAPI int glXext_SGIS_multisample = 0;
GLLOADAPI int glXext_SGIS_shared_multisample = 0;
GLLOADAPI int glXext_SGIX_fbconfig = 0;
GLLOADAPI int glXext_SGIX_pbuffer = 0;
GLLOADAPI int glXext_SGIX_swap_barrier = 0;
GLLOADAPI int glXext_SGIX_swap_group = 0;
GLLOADAPI int glXext_SGIX_video_resize = 0;
GLLOADAPI int glXext_SGIX_visual_select_group = 0;
GLLOADAPI int glXext_SGI_cushion = 0;
GLLOADAPI int glXext_SGI_make_current_read = 0;
GLLOADAPI int glXext_SGI_swap_control = 0;
GLLOADAPI int glXext_SGI_video_sync = 0;
GLLOADAPI int glXext_SUN_get_transparent_index = 0;

GLLOADAPI PFNGLXCREATECONTEXTATTRIBSARBPROC _funcptr_glXCreateContextAttribsARB = NULL;
...
GLLOADAPI PFNGLXGETPROCADDRESSARBPROC _funcptr_glXGetProcAddressARB = NULL;
...
GLLOADAPI PFNGLXFREECONTEXTEXTPROC _funcptr_glXFreeContextEXT = NULL;
GLLOADAPI PFNGLXGETCONTEXTIDEXTPROC _funcptr_glXGetContextIDEXT = NULL;
GLLOADAPI PFNGLXGETCURRENTDISPLAYEXTPROC _funcptr_glXGetCurrentDisplayEXT = NULL;
GLLOADAPI PFNGLXIMPORTCONTEXTEXTPROC _funcptr_glXImportContextEXT = NULL;
GLLOADAPI PFNGLXQUERYCONTEXTINFOEXTPROC _funcptr_glXQueryContextInfoEXT = NULL;
...
GLLOADAPI PFNGLXSWAPINTERVALEXTPROC _funcptr_glXSwapIntervalEXT = NULL;
...
GLLOADAPI PFNGLXBINDTEXIMAGEEXTPROC _funcptr_glXBindTexImageEXT = NULL;
GLLOADAPI PFNGLXRELEASETEXIMAGEEXTPROC _funcptr_glXReleaseTexImageEXT = NULL;
...
GLLOADAPI PFNGLXGETAGPOFFSETMESAPROC _funcptr_glXGetAGPOffsetMESA = NULL;
...
GLLOADAPI PFNGLXCOPYSUBBUFFERMESAPROC _funcptr_glXCopySubBufferMESA = NULL;
...
GLLOADAPI PFNGLXCREATEGLXPIXMAPMESAPROC _funcptr_glXCreateGLXPixmapMESA = NULL;
...
GLLOADAPI PFNGLXRELEASEBUFFERSMESAPROC _funcptr_glXReleaseBuffersMESA = NULL;
...
GLLOADAPI PFNGLXSET3DFXMODEMESAPROC _funcptr_glXSet3DfxModeMESA = NULL;
...
GLLOADAPI PFNGLXCOPYIMAGESUBDATANVPROC _funcptr_glXCopyImageSubDataNV = NULL;
...
GLLOADAPI PFNGLXBINDVIDEODEVICENVPROC _funcptr_glXBindVideoDeviceNV = NULL;
GLLOADAPI PFNGLXENUMERATEVIDEODEVICESNVPROC _funcptr_glXEnumerateVideoDevicesNV = NULL;
...
GLLOADAPI PFNGLXBINDSWAPBARRIERNVPROC _funcptr_glXBindSwapBarrierNV = NULL;
GLLOADAPI PFNGLXJOINSWAPGROUPNVPROC _funcptr_glXJoinSwapGroupNV = NULL;
GLLOADAPI PFNGLXQUERYFRAMECOUNTNVPROC _funcptr_glXQueryFrameCountNV = NULL;
GLLOADAPI PFNGLXQUERYMAXSWAPGROUPSNVPROC _funcptr_glXQueryMaxSwapGroupsNV = NULL;
GLLOADAPI PFNGLXQUERYSWAPGROUPNVPROC _funcptr_glXQuerySwapGroupNV = NULL;
GLLOADAPI PFNGLXRESETFRAMECOUNTNVPROC _funcptr_glXResetFrameCountNV = NULL;
...
GLLOADAPI PFNGLXBINDVIDEOCAPTUREDEVICENVPROC _funcptr_glXBindVideoCaptureDeviceNV = NULL;
GLLOADAPI PFNGLXENUMERATEVIDEOCAPTUREDEVICESNVPROC _funcptr_glXEnumerateVideoCaptureDevicesNV = NULL;
GLLOADAPI PFNGLXLOCKVIDEOCAPTUREDEVICENVPROC _funcptr_glXLockVideoCaptureDeviceNV = NULL;
GLLOADAPI PFNGLXQUERYVIDEOCAPTUREDEVICENVPROC _funcptr_glXQueryVideoCaptureDeviceNV = NULL;
GLLOADAPI PFNGLXRELEASEVIDEOCAPTUREDEVICENVPROC _funcptr_glXReleaseVideoCaptureDeviceNV = NULL;
...
GLLOADAPI PFNGLXBINDVIDEOIMAGENVPROC _funcptr_glXBindVideoImageNV = NULL;
GLLOADAPI PFNGLXGETVIDEODEVICENVPROC _funcptr_glXGetVideoDeviceNV = NULL;
GLLOADAPI PFNGLXGETVIDEOINFONVPROC _funcptr_glXGetVideoInfoNV = NULL;
GLLOADAPI PFNGLXRELEASEVIDEODEVICENVPROC _funcptr_glXReleaseVideoDeviceNV = NULL;
GLLOADAPI PFNGLXRELEASEVIDEOIMAGENVPROC _funcptr_glXReleaseVideoImageNV = NULL;
GLLOADAPI PFNGLXSENDPBUFFERTOVIDEONVPROC _funcptr_glXSendPbufferToVideoNV = NULL;
...
GLLOADAPI PFNGLXGETMSCRATEOMLPROC _funcptr_glXGetMscRateOML = NULL;
GLLOADAPI PFNGLXGETSYNCVALUESOMLPROC _funcptr_glXGetSyncValuesOML = NULL;
GLLOADAPI PFNGLXSWAPBUFFERSMSCOMLPROC _funcptr_glXSwapBuffersMscOML = NULL;
GLLOADAPI PFNGLXWAITFORMSCOMLPROC _funcptr_glXWaitForMscOML = NULL;
GLLOADAPI PFNGLXWAITFORSBCOMLPROC _funcptr_glXWaitForSbcOML = NULL;
...
GLLOADAPI PFNGLXCHOOSEFBCONFIGSGIXPROC _funcptr_glXChooseFBConfigSGIX = NULL;
GLLOADAPI PFNGLXCREATECONTEXTWITHCONFIGSGIXPROC _funcptr_glXCreateContextWithConfigSGIX = NULL;
GLLOADAPI PFNGLXCREATEGLXPIXMAPWITHCONFIGSGIXPROC _funcptr_glXCreateGLXPixmapWithConfigSGIX = NULL;
GLLOADAPI PFNGLXGETFBCONFIGATTRIBSGIXPROC _funcptr_glXGetFBConfigAttribSGIX = NULL;
GLLOADAPI PFNGLXGETFBCONFIGFROMVISUALSGIXPROC _funcptr_glXGetFBConfigFromVisualSGIX = NULL;
GLLOADAPI PFNGLXGETVISUALFROMFBCONFIGSGIXPROC _funcptr_glXGetVisualFromFBConfigSGIX = NULL;
...
GLLOADAPI PFNGLXCREATEGLXPBUFFERSGIXPROC _funcptr_glXCreateGLXPbufferSGIX = NULL;
GLLOADAPI PFNGLXDESTROYGLXPBUFFERSGIXPROC _funcptr_glXDestroyGLXPbufferSGIX = NULL;
GLLOADAPI PFNGLXGETSELECTEDEVENTSGIXPROC _funcptr_glXGetSelectedEventSGIX = NULL;
GLLOADAPI PFNGLXQUERYGLXPBUFFERSGIXPROC _funcptr_glXQueryGLXPbufferSGIX = NULL;
GLLOADAPI PFNGLXSELECTEVENTSGIXPROC _funcptr_glXSelectEventSGIX = NULL;
...
GLLOADAPI PFNGLXBINDSWAPBARRIERSGIXPROC _funcptr_glXBindSwapBarrierSGIX = NULL;
GLLOADAPI PFNGLXQUERYMAXSWAPBARRIERSSGIXPROC _funcptr_glXQueryMaxSwapBarriersSGIX = NULL;
...
GLLOADAPI PFNGLXJOINSWAPGROUPSGIXPROC _funcptr_glXJoinSwapGroupSGIX = NULL;
...
GLLOADAPI PFNGLXBINDCHANNELTOWINDOWSGIXPROC _funcptr_glXBindChannelToWindowSGIX = NULL;
GLLOADAPI PFNGLXCHANNELRECTSGIXPROC _funcptr_glXChannelRectSGIX = NULL;
GLLOADAPI PFNGLXCHANNELRECTSYNCSGIXPROC _funcptr_glXChannelRectSyncSGIX = NULL;
GLLOADAPI PFNGLXQUERYCHANNELDELTASSGIXPROC _funcptr_glXQueryChannelDeltasSGIX = NULL;
GLLOADAPI PFNGLXQUERYCHANNELRECTSGIXPROC _funcptr_glXQueryChannelRectSGIX = NULL;
...
GLLOADAPI PFNGLXCUSHIONSGIPROC _funcptr_glXCushionSGI = NULL;
...
GLLOADAPI PFNGLXGETCURRENTREADDRAWABLESGIPROC _funcptr_glXGetCurrentReadDrawableSGI = NULL;
GLLOADAPI PFNGLXMAKECURRENTREADSGIPROC _funcptr_glXMakeCurrentReadSGI = NULL;
...
GLLOADAPI PFNGLXSWAPINTERVALSGIPROC _funcptr_glXSwapIntervalSGI = NULL;
...
GLLOADAPI PFNGLXGETVIDEOSYNCSGIPROC _funcptr_glXGetVideoSyncSGI = NULL;
GLLOADAPI PFNGLXWAITVIDEOSYNCSGIPROC _funcptr_glXWaitVideoSyncSGI = NULL;
...
GLLOADAPI PFNGLXGETTRANSPARENTINDEXSUNPROC _funcptr_glXGetTransparentIndexSUN = NULL;
...
GLLOADAPI int FindGLXExt(const char *extensionName) {
    glx_StrToExtMap *entry = FindExtEntry(extensionName);
    if (entry != NULL && *(entry->extensionVariable) == glx_LOAD_SUCCEEDED) {
        return glx_LOAD_SUCCEEDED;
    }
    return glx_LOAD_FAILED;
}
...
GLLOADAPI int glx_LoadFunctions(Display *display, int screen)
{
	int numFailed = 0;
