...
GLLOADAPI int wglext_3DFX_multisample = 0;
GLLOADAPI int wglext_3DL_stereo_control = 0;
GLLOADAPI int wglext_AMD_gpu_association = 0;
GLLOADAPI int wglext_ARB_buffer_region = 0;
GLLOADAPI int wglext_ARB_create_context = 0;
GLLOADAPI int wglext_ARB_create_context_profile = 0;
GLLOADAPI int wglext_ARB_create_context_robustness = 0;
GLLOADAPI int wglext_ARB_extensions_string = 0;
GLLOADAPI int wglext_ARB_framebuffer_sRGB = 0;
GLLOADAPI int wglext_ARB_make_current_read = 0;
GLLOADAPI int wglext_ARB_multisample = 0;
GLLOADAPI int wglext_ARB_pbuffer = 0;
GLLOADAPI int wglext_ARB_pixel_format = 0;
GLLOADAPI int wglext_ARB_pixel_format_float = 0;
GLLOADAPI int wglext_ARB_render_texture = 0;
GLLOADAPI int wglext_ARB_robustness_application_isolation = 0;
GLLOADAPI int wglext_ARB_robustness_share_group_isolation = 0;
GLLOADAPI int wglext_ATI_pixel_format_float = 0;
GLLOADAPI int wglext_EXT_create_context_es2_profile = 0;
GLLOADAPI int wglext_EXT_create_context_es_profile = 0;
GLLOADAPI int wglext_EXT_depth_float = 0;
GLLOADAPI int wglext_EXT_display_color_table = 0;
GLLOADAPI int wglext_EXT_extensions_string = 0;
GLLOADAPI int wglext_EXT_framebuffer_sRGB = 0;
GLLOADAPI int wglext_EXT_make_current_read = 0;
GLLOADAPI int wglext_EXT_multisample = 0;
GLLOADAPI int wglext_EXT_pbuffer = 0;
GLLOADAPI int wglext_EXT_pixel_format = 0;
GLLOADAPI int wglext_EXT_pixel_format_packed_float = 0;
GLLOADAPI int wglext_EXT_swap_control = 0;
GLLOADAPI int wglext_EXT_swap_control_tear = 0;
GLLOADAPI int wglext_I3D_digital_video_control = 0;
GLLOADAPI int wglext_I3D_gamma = 0;
GLLOADAPI int wglext_I3D_genlock = 0;
GLLOADAPI int wglext_I3D_image_buffer = 0;
GLLOADAPI int wglext_I3D_swap_frame_lock = 0;
GLLOADAPI int wglext_I3D_swap_frame_usage = 0;
GLLOADAPI int wglext_NV_DX_interop = 0;
GLLOADAPI int wglext_NV_DX_interop2 = 0;
GLLOADAPI int wglext_NV_copy_image = 0;
GLLOADAPI int wglext_NV_float_buffer = 0;
GLLOADAPI int wglext_NV_gpu_affinity = 0;
GLLOADAPI int wglext_NV_multisample_coverage = 0;
GLLOADAPI int wglext_NV_present_video = 0;
GLLOADAPI int wglext_NV_render_depth_texture = 0;
GLLOADAPI int wglext_NV_render_texture_rectangle = 0;
GLLOADAPI int wglext_NV_swap_group = 0;
GLLOADAPI int wglext_NV_vertex_array_range = 0;
GLLOADAPI int wglext_NV_video_capture = 0;
GLLOADAPI int wglext_NV_video_output = 0;
GLLOADAPI int wglext_OML_sync_control = 0;

GLLOADAPI PFNWGLSETSTEREOEMITTERSTATE3DLPROC _funcptr_wglSetStereoEmitterState3DL = NULL;
...
GLLOADAPI PFNWGLBLITCONTEXTFRAMEBUFFERAMDPROC _funcptr_wglBlitContextFramebufferAMD = NULL;
GLLOADAPI PFNWGLCREATEASSOCIATEDCONTEXTAMDPROC _funcptr_wglCreateAssociatedContextAMD = NULL;
GLLOADAPI PFNWGLCREATEASSOCIATEDCONTEXTATTRIBSAMDPROC _funcptr_wglCreateAssociatedContextAttribsAMD = NULL;
GLLOADAPI PFNWGLDELETEASSOCIATEDCONTEXTAMDPROC _funcptr_wglDeleteAssociatedContextAMD = NULL;
GLLOADAPI PFNWGLGETCONTEXTGPUIDAMDPROC _funcptr_wglGetContextGPUIDAMD = NULL;
GLLOADAPI PFNWGLGETCURRENTASSOCIATEDCONTEXTAMDPROC _funcptr_wglGetCurrentAssociatedContextAMD = NULL;
GLLOADAPI PFNWGLGETGPUIDSAMDPROC _funcptr_wglGetGPUIDsAMD = NULL;
GLLOADAPI PFNWGLGETGPUINFOAMDPROC _funcptr_wglGetGPUInfoAMD = NULL;
GLLOADAPI PFNWGLMAKEASSOCIATEDCONTEXTCURRENTAMDPROC _funcptr_wglMakeAssociatedContextCurrentAMD = NULL;
...
GLLOADAPI PFNWGLCREATEBUFFERREGIONARBPROC _funcptr_wglCreateBufferRegionARB = NULL;
GLLOADAPI PFNWGLDELETEBUFFERREGIONARBPROC _funcptr_wglDeleteBufferRegionARB = NULL;
GLLOADAPI PFNWGLRESTOREBUFFERREGIONARBPROC _funcptr_wglRestoreBufferRegionARB = NULL;
GLLOADAPI PFNWGLSAVEBUFFERREGIONARBPROC _funcptr_wglSaveBufferRegionARB = NULL;
...
GLLOADAPI PFNWGLCREATECONTEXTATTRIBSARBPROC _funcptr_wglCreateContextAttribsARB = NULL;
...
GLLOADAPI PFNWGLGETEXTENSIONSSTRINGARBPROC _funcptr_wglGetExtensionsStringARB = NULL;
...
GLLOADAPI PFNWGLGETCURRENTREADDCARBPROC _funcptr_wglGetCurrentReadDCARB = NULL;
GLLOADAPI PFNWGLMAKECONTEXTCURRENTARBPROC _funcptr_wglMakeContextCurrentARB = NULL;
...
GLLOADAPI PFNWGLCREATEPBUFFERARBPROC _funcptr_wglCreatePbufferARB = NULL;
GLLOADAPI PFNWGLDESTROYPBUFFERARBPROC _funcptr_wglDestroyPbufferARB = NULL;
GLLOADAPI PFNWGLGETPBUFFERDCARBPROC _funcptr_wglGetPbufferDCARB = NULL;
GLLOADAPI PFNWGLQUERYPBUFFERARBPROC _funcptr_wglQueryPbufferARB = NULL;
GLLOADAPI PFNWGLRELEASEPBUFFERDCARBPROC _funcptr_wglReleasePbufferDCARB = NULL;
...
GLLOADAPI PFNWGLCHOOSEPIXELFORMATARBPROC _funcptr_wglChoosePixelFormatARB = NULL;
GLLOADAPI PFNWGLGETPIXELFORMATATTRIBFVARBPROC _funcptr_wglGetPixelFormatAttribfvARB = NULL;
GLLOADAPI PFNWGLGETPIXELFORMATATTRIBIVARBPROC _funcptr_wglGetPixelFormatAttribivARB = NULL;
...
GLLOADAPI PFNWGLBINDTEXIMAGEARBPROC _funcptr_wglBindTexImageARB = NULL;
GLLOADAPI PFNWGLRELEASETEXIMAGEARBPROC _funcptr_wglReleaseTexImageARB = NULL;
GLLOADAPI PFNWGLSETPBUFFERATTRIBARBPROC _funcptr_wglSetPbufferAttribARB = NULL;
...
GLLOADAPI PFNWGLBINDDISPLAYCOLORTABLEEXTPROC _funcptr_wglBindDisplayColorTableEXT = NULL;
GLLOADAPI PFNWGLCREATEDISPLAYCOLORTABLEEXTPROC _funcptr_wglCreateDisplayColorTableEXT = NULL;
GLLOADAPI PFNWGLDESTROYDISPLAYCOLORTABLEEXTPROC _funcptr_wglDestroyDisplayColorTableEXT = NULL;
GLLOADAPI PFNWGLLOADDISPLAYCOLORTABLEEXTPROC _funcptr_wglLoadDisplayColorTableEXT = NULL;
...
GLLOADAPI PFNWGLGETEXTENSIONSSTRINGEXTPROC _funcptr_wglGetExtensionsStringEXT = NULL;
...
GLLOADAPI PFNWGLGETCURRENTREADDCEXTPROC _funcptr_wglGetCurrentReadDCEXT = NULL;
GLLOADAPI PFNWGLMAKECONTEXTCURRENTEXTPROC _funcptr_wglMakeContextCurrentEXT = NULL;
...
GLLOADAPI PFNWGLCREATEPBUFFEREXTPROC _funcptr_wglCreatePbufferEXT = NULL;
GLLOADAPI PFNWGLDESTROYPBUFFEREXTPROC _funcptr_wglDestroyPbufferEXT = NULL;
GLLOADAPI PFNWGLGETPBUFFERDCEXTPROC _funcptr_wglGetPbufferDCEXT = NULL;
GLLOADAPI PFNWGLQUERYPBUFFEREXTPROC _funcptr_wglQueryPbufferEXT = NULL;
GLLOADAPI PFNWGLRELEASEPBUFFERDCEXTPROC _funcptr_wglReleasePbufferDCEXT = NULL;
...
GLLOADAPI PFNWGLCHOOSEPIXELFORMATEXTPROC _funcptr_wglChoosePixelFormatEXT = NULL;
GLLOADAPI PFNWGLGETPIXELFORMATATTRIBFVEXTPROC _funcptr_wglGetPixelFormatAttribfvEXT = NULL;
GLLOADAPI PFNWGLGETPIXELFORMATATTRIBIVEXTPROC _funcptr_wglGetPixelFormatAttribivEXT = NULL;
...
GLLOADAPI PFNWGLGETSWAPINTERVALEXTPROC _funcptr_wglGetSwapIntervalEXT = NULL;
GLLOADAPI PFNWGLSWAPINTERVALEXTPROC _funcptr_wglSwapIntervalEXT = NULL;
...
GLLOADAPI PFNWGLGETDIGITALVIDEOPARAMETERSI3DPROC _funcptr_wglGetDigitalVideoParametersI3D = NULL;
GLLOADAPI PFNWGLSETDIGITALVIDEOPARAMETERSI3DPROC _funcptr_wglSetDigitalVideoParametersI3D = NULL;
...
GLLOADAPI PFNWGLGETGAMMATABLEI3DPROC _funcptr_wglGetGammaTableI3D = NULL;
GLLOADAPI PFNWGLGETGAMMATABLEPARAMETERSI3DPROC _funcptr_wglGetGammaTableParametersI3D = NULL;
GLLOADAPI PFNWGLSETGAMMATABLEI3DPROC _funcptr_wglSetGammaTableI3D = NULL;
GLLOADAPI PFNWGLSETGAMMATABLEPARAMETERSI3DPROC _funcptr_wglSetGammaTableParametersI3D = NULL;
...
GLLOADAPI PFNWGLDISABLEGENLOCKI3DPROC _funcptr_wglDisableGenlockI3D = NULL;
GLLOADAPI PFNWGLENABLEGENLOCKI3DPROC _funcptr_wglEnableGenlockI3D = NULL;
GLLOADAPI PFNWGLGENLOCKSAMPLERATEI3DPROC _funcptr_wglGenlockSampleRateI3D = NULL;
GLLOADAPI PFNWGLGENLOCKSOURCEDELAYI3DPROC _funcptr_wglGenlockSourceDelayI3D = NULL;
GLLOADAPI PFNWGLGENLOCKSOURCEEDGEI3DPROC _funcptr_wglGenlockSourceEdgeI3D = NULL;
GLLOADAPI PFNWGLGENLOCKSOURCEI3DPROC _funcptr_wglGenlockSourceI3D = NULL;
GLLOADAPI PFNWGLGETGENLOCKSAMPLERATEI3DPROC _funcptr_wglGetGenlockSampleRateI3D = NULL;
GLLOADAPI PFNWGLGETGENLOCKSOURCEDELAYI3DPROC _funcptr_wglGetGenlockSourceDelayI3D = NULL;
GLLOADAPI PFNWGLGETGENLOCKSOURCEEDGEI3DPROC _funcptr_wglGetGenlockSourceEdgeI3D = NULL;
GLLOADAPI PFNWGLGETGENLOCKSOURCEI3DPROC _funcptr_wglGetGenlockSourceI3D = NULL;
GLLOADAPI PFNWGLISENABLEDGENLOCKI3DPROC _funcptr_wglIsEnabledGenlockI3D = NULL;
GLLOADAPI PFNWGLQUERYGENLOCKMAXSOURCEDELAYI3DPROC _funcptr_wglQueryGenlockMaxSourceDelayI3D = NULL;
...
GLLOADAPI PFNWGLASSOCIATEIMAGEBUFFEREVENTSI3DPROC _funcptr_wglAssociateImageBufferEventsI3D = NULL;
GLLOADAPI PFNWGLCREATEIMAGEBUFFERI3DPROC _funcptr_wglCreateImageBufferI3D = NULL;
GLLOADAPI PFNWGLDESTROYIMAGEBUFFERI3DPROC _funcptr_wglDestroyImageBufferI3D = NULL;
GLLOADAPI PFNWGLRELEASEIMAGEBUFFEREVENTSI3DPROC _funcptr_wglReleaseImageBufferEventsI3D = NULL;
...
GLLOADAPI PFNWGLDISABLEFRAMELOCKI3DPROC _funcptr_wglDisableFrameLockI3D = NULL;
GLLOADAPI PFNWGLENABLEFRAMELOCKI3DPROC _funcptr_wglEnableFrameLockI3D = NULL;
GLLOADAPI PFNWGLISENABLEDFRAMELOCKI3DPROC _funcptr_wglIsEnabledFrameLockI3D = NULL;
GLLOADAPI PFNWGLQUERYFRAMELOCKMASTERI3DPROC _funcptr_wglQueryFrameLockMasterI3D = NULL;
...
GLLOADAPI PFNWGLBEGINFRAMETRACKINGI3DPROC _funcptr_wglBeginFrameTrackingI3D = NULL;
GLLOADAPI PFNWGLENDFRAMETRACKINGI3DPROC _funcptr_wglEndFrameTrackingI3D = NULL;
GLLOADAPI PFNWGLGETFRAMEUSAGEI3DPROC _funcptr_wglGetFrameUsageI3D = NULL;
GLLOADAPI PFNWGLQUERYFRAMETRACKINGI3DPROC _funcptr_wglQueryFrameTrackingI3D = NULL;
...
GLLOADAPI PFNWGLDXCLOSEDEVICENVPROC _funcptr_wglDXCloseDeviceNV = NULL;
GLLOADAPI PFNWGLDXLOCKOBJECTSNVPROC _funcptr_wglDXLockObjectsNV = NULL;
GLLOADAPI PFNWGLDXOBJECTACCESSNVPROC _funcptr_wglDXObjectAccessNV = NULL;
GLLOADAPI PFNWGLDXOPENDEVICENVPROC _funcptr_wglDXOpenDeviceNV = NULL;
GLLOADAPI PFNWGLDXREGISTEROBJECTNVPROC _funcptr_wglDXRegisterObjectNV = NULL;
GLLOADAPI PFNWGLDXSETRESOURCESHAREHANDLENVPROC _funcptr_wglDXSetResourceShareHandleNV = NULL;
GLLOADAPI PFNWGLDXUNLOCKOBJECTSNVPROC _funcptr_wglDXUnlockObjectsNV = NULL;
GLLOADAPI PFNWGLDXUNREGISTEROBJECTNVPROC _funcptr_wglDXUnregisterObjectNV = NULL;
...
GLLOADAPI PFNWGLCOPYIMAGESUBDATANVPROC _funcptr_wglCopyImageSubDataNV = NULL;
...
GLLOADAPI PFNWGLCREATEAFFINITYDCNVPROC _funcptr_wglCreateAffinityDCNV = NULL;
GLLOADAPI PFNWGLDELETEDCNVPROC _funcptr_wglDeleteDCNV = NULL;
GLLOADAPI PFNWGLENUMGPUDEVICESNVPROC _funcptr_wglEnumGpuDevicesNV = NULL;
GLLOADAPI PFNWGLENUMGPUSFROMAFFINITYDCNVPROC _funcptr_wglEnumGpusFromAffinityDCNV = NULL;
GLLOADAPI PFNWGLENUMGPUSNVPROC _funcptr_wglEnumGpusNV = NULL;
...
GLLOADAPI PFNWGLBINDVIDEODEVICENVPROC _funcptr_wglBindVideoDeviceNV = NULL;
GLLOADAPI PFNWGLENUMERATEVIDEODEVICESNVPROC _funcptr_wglEnumerateVideoDevicesNV = NULL;
GLLOADAPI PFNWGLQUERYCURRENTCONTEXTNVPROC _funcptr_wglQueryCurrentContextNV = NULL;
...
GLLOADAPI PFNWGLBINDSWAPBARRIERNVPROC _funcptr_wglBindSwapBarrierNV = NULL;
GLLOADAPI PFNWGLJOINSWAPGROUPNVPROC _funcptr_wglJoinSwapGroupNV = NULL;
GLLOADAPI PFNWGLQUERYFRAMECOUNTNVPROC _funcptr_wglQueryFrameCountNV = NULL;
GLLOADAPI PFNWGLQUERYMAXSWAPGROUPSNVPROC _funcptr_wglQueryMaxSwapGroupsNV = NULL;
GLLOADAPI PFNWGLQUERYSWAPGROUPNVPROC _funcptr_wglQuerySwapGroupNV = NULL;
GLLOADAPI PFNWGLRESETFRAMECOUNTNVPROC _funcptr_wglResetFrameCountNV = NULL;
...
GLLOADAPI PFNWGLALLOCATEMEMORYNVPROC _funcptr_wglAllocateMemoryNV = NULL;
GLLOADAPI PFNWGLFREEMEMORYNVPROC _funcptr_wglFreeMemoryNV = NULL;
...
GLLOADAPI PFNWGLBINDVIDEOCAPTUREDEVICENVPROC _funcptr_wglBindVideoCaptureDeviceNV = NULL;
GLLOADAPI PFNWGLENUMERATEVIDEOCAPTUREDEVICESNVPROC _funcptr_wglEnumerateVideoCaptureDevicesNV = NULL;
GLLOADAPI PFNWGLLOCKVIDEOCAPTUREDEVICENVPROC _funcptr_wglLockVideoCaptureDeviceNV = NULL;
GLLOADAPI PFNWGLQUERYVIDEOCAPTUREDEVICENVPROC _funcptr_wglQueryVideoCaptureDeviceNV = NULL;
GLLOADAPI PFNWGLRELEASEVIDEOCAPTUREDEVICENVPROC _funcptr_wglReleaseVideoCaptureDeviceNV = NULL;
...
GLLOADAPI PFNWGLBINDVIDEOIMAGENVPROC _funcptr_wglBindVideoImageNV = NULL;
GLLOADAPI PFNWGLGETVIDEODEVICENVPROC _funcptr_wglGetVideoDeviceNV = NULL;
GLLOADAPI PFNWGLGETVIDEOINFONVPROC _funcptr_wglGetVideoInfoNV = NULL;
GLLOADAPI PFNWGLRELEASEVIDEODEVICENVPROC _funcptr_wglReleaseVideoDeviceNV = NULL;
GLLOADAPI PFNWGLRELEASEVIDEOIMAGENVPROC _funcptr_wglReleaseVideoImageNV = NULL;
GLLOADAPI PFNWGLSENDPBUFFERTOVIDEONVPROC _funcptr_wglSendPbufferToVideoNV = NULL;
...
GLLOADAPI PFNWGLGETMSCRATEOMLPROC _funcptr_wglGetMscRateOML = NULL;
GLLOADAPI PFNWGLGETSYNCVALUESOMLPROC _funcptr_wglGetSyncValuesOML = NULL;
GLLOADAPI PFNWGLSWAPBUFFERSMSCOMLPROC _funcptr_wglSwapBuffersMscOML = NULL;
GLLOADAPI PFNWGLSWAPLAYERBUFFERSMSCOMLPROC _funcptr_wglSwapLayerBuffersMscOML = NULL;
GLLOADAPI PFNWGLWAITFORMSCOMLPROC _funcptr_wglWaitForMscOML = NULL;
GLLOADAPI PFNWGLWAITFORSBCOMLPROC _funcptr_wglWaitForSbcOML = NULL;
...
GLLOADAPI int FindWGLExt(const char *extensionName) {
    wgl_StrToExtMap *entry = FindExtEntry(extensionName);
    if (entry != NULL && *(entry->extensionVariable) == wgl_LOAD_SUCCEEDED) {
...
GLLOADAPI int wgl_LoadFunctions(HDC hdc)
{
	int numFailed = 0;
