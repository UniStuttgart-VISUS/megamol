...
extern "C" {
#endif /*__cplusplus*/
extern GLLOADAPI int wglext_3DFX_multisample;
extern GLLOADAPI int wglext_3DL_stereo_control;
extern GLLOADAPI int wglext_AMD_gpu_association;
extern GLLOADAPI int wglext_ARB_buffer_region;
extern GLLOADAPI int wglext_ARB_create_context;
extern GLLOADAPI int wglext_ARB_create_context_profile;
extern GLLOADAPI int wglext_ARB_create_context_robustness;
extern GLLOADAPI int wglext_ARB_extensions_string;
extern GLLOADAPI int wglext_ARB_framebuffer_sRGB;
extern GLLOADAPI int wglext_ARB_make_current_read;
extern GLLOADAPI int wglext_ARB_multisample;
extern GLLOADAPI int wglext_ARB_pbuffer;
extern GLLOADAPI int wglext_ARB_pixel_format;
extern GLLOADAPI int wglext_ARB_pixel_format_float;
extern GLLOADAPI int wglext_ARB_render_texture;
extern GLLOADAPI int wglext_ARB_robustness_application_isolation;
extern GLLOADAPI int wglext_ARB_robustness_share_group_isolation;
extern GLLOADAPI int wglext_ATI_pixel_format_float;
extern GLLOADAPI int wglext_EXT_create_context_es2_profile;
extern GLLOADAPI int wglext_EXT_create_context_es_profile;
extern GLLOADAPI int wglext_EXT_depth_float;
extern GLLOADAPI int wglext_EXT_display_color_table;
extern GLLOADAPI int wglext_EXT_extensions_string;
extern GLLOADAPI int wglext_EXT_framebuffer_sRGB;
extern GLLOADAPI int wglext_EXT_make_current_read;
extern GLLOADAPI int wglext_EXT_multisample;
extern GLLOADAPI int wglext_EXT_pbuffer;
extern GLLOADAPI int wglext_EXT_pixel_format;
extern GLLOADAPI int wglext_EXT_pixel_format_packed_float;
extern GLLOADAPI int wglext_EXT_swap_control;
extern GLLOADAPI int wglext_EXT_swap_control_tear;
extern GLLOADAPI int wglext_I3D_digital_video_control;
extern GLLOADAPI int wglext_I3D_gamma;
extern GLLOADAPI int wglext_I3D_genlock;
extern GLLOADAPI int wglext_I3D_image_buffer;
extern GLLOADAPI int wglext_I3D_swap_frame_lock;
extern GLLOADAPI int wglext_I3D_swap_frame_usage;
extern GLLOADAPI int wglext_NV_DX_interop;
extern GLLOADAPI int wglext_NV_DX_interop2;
extern GLLOADAPI int wglext_NV_copy_image;
extern GLLOADAPI int wglext_NV_float_buffer;
extern GLLOADAPI int wglext_NV_gpu_affinity;
extern GLLOADAPI int wglext_NV_multisample_coverage;
extern GLLOADAPI int wglext_NV_present_video;
extern GLLOADAPI int wglext_NV_render_depth_texture;
extern GLLOADAPI int wglext_NV_render_texture_rectangle;
extern GLLOADAPI int wglext_NV_swap_group;
extern GLLOADAPI int wglext_NV_vertex_array_range;
extern GLLOADAPI int wglext_NV_video_capture;
extern GLLOADAPI int wglext_NV_video_output;
extern GLLOADAPI int wglext_OML_sync_control;
...
extern GLLOADAPI PFNWGLSETSTEREOEMITTERSTATE3DLPROC _funcptr_wglSetStereoEmitterState3DL;
...
extern GLLOADAPI PFNWGLBLITCONTEXTFRAMEBUFFERAMDPROC _funcptr_wglBlitContextFramebufferAMD;
#define wglBlitContextFramebufferAMD _funcptr_wglBlitContextFramebufferAMD
extern GLLOADAPI PFNWGLCREATEASSOCIATEDCONTEXTAMDPROC _funcptr_wglCreateAssociatedContextAMD;
#define wglCreateAssociatedContextAMD _funcptr_wglCreateAssociatedContextAMD
extern GLLOADAPI PFNWGLCREATEASSOCIATEDCONTEXTATTRIBSAMDPROC _funcptr_wglCreateAssociatedContextAttribsAMD;
#define wglCreateAssociatedContextAttribsAMD _funcptr_wglCreateAssociatedContextAttribsAMD
extern GLLOADAPI PFNWGLDELETEASSOCIATEDCONTEXTAMDPROC _funcptr_wglDeleteAssociatedContextAMD;
#define wglDeleteAssociatedContextAMD _funcptr_wglDeleteAssociatedContextAMD
extern GLLOADAPI PFNWGLGETCONTEXTGPUIDAMDPROC _funcptr_wglGetContextGPUIDAMD;
#define wglGetContextGPUIDAMD _funcptr_wglGetContextGPUIDAMD
extern GLLOADAPI PFNWGLGETCURRENTASSOCIATEDCONTEXTAMDPROC _funcptr_wglGetCurrentAssociatedContextAMD;
#define wglGetCurrentAssociatedContextAMD _funcptr_wglGetCurrentAssociatedContextAMD
extern GLLOADAPI PFNWGLGETGPUIDSAMDPROC _funcptr_wglGetGPUIDsAMD;
#define wglGetGPUIDsAMD _funcptr_wglGetGPUIDsAMD
extern GLLOADAPI PFNWGLGETGPUINFOAMDPROC _funcptr_wglGetGPUInfoAMD;
#define wglGetGPUInfoAMD _funcptr_wglGetGPUInfoAMD
extern GLLOADAPI PFNWGLMAKEASSOCIATEDCONTEXTCURRENTAMDPROC _funcptr_wglMakeAssociatedContextCurrentAMD;
...
extern GLLOADAPI PFNWGLCREATEBUFFERREGIONARBPROC _funcptr_wglCreateBufferRegionARB;
#define wglCreateBufferRegionARB _funcptr_wglCreateBufferRegionARB
extern GLLOADAPI PFNWGLDELETEBUFFERREGIONARBPROC _funcptr_wglDeleteBufferRegionARB;
#define wglDeleteBufferRegionARB _funcptr_wglDeleteBufferRegionARB
extern GLLOADAPI PFNWGLRESTOREBUFFERREGIONARBPROC _funcptr_wglRestoreBufferRegionARB;
#define wglRestoreBufferRegionARB _funcptr_wglRestoreBufferRegionARB
extern GLLOADAPI PFNWGLSAVEBUFFERREGIONARBPROC _funcptr_wglSaveBufferRegionARB;
...
extern GLLOADAPI PFNWGLCREATECONTEXTATTRIBSARBPROC _funcptr_wglCreateContextAttribsARB;
...
extern GLLOADAPI PFNWGLGETEXTENSIONSSTRINGARBPROC _funcptr_wglGetExtensionsStringARB;
...
extern GLLOADAPI PFNWGLGETCURRENTREADDCARBPROC _funcptr_wglGetCurrentReadDCARB;
#define wglGetCurrentReadDCARB _funcptr_wglGetCurrentReadDCARB
extern GLLOADAPI PFNWGLMAKECONTEXTCURRENTARBPROC _funcptr_wglMakeContextCurrentARB;
...
extern GLLOADAPI PFNWGLCREATEPBUFFERARBPROC _funcptr_wglCreatePbufferARB;
#define wglCreatePbufferARB _funcptr_wglCreatePbufferARB
extern GLLOADAPI PFNWGLDESTROYPBUFFERARBPROC _funcptr_wglDestroyPbufferARB;
#define wglDestroyPbufferARB _funcptr_wglDestroyPbufferARB
extern GLLOADAPI PFNWGLGETPBUFFERDCARBPROC _funcptr_wglGetPbufferDCARB;
#define wglGetPbufferDCARB _funcptr_wglGetPbufferDCARB
extern GLLOADAPI PFNWGLQUERYPBUFFERARBPROC _funcptr_wglQueryPbufferARB;
#define wglQueryPbufferARB _funcptr_wglQueryPbufferARB
extern GLLOADAPI PFNWGLRELEASEPBUFFERDCARBPROC _funcptr_wglReleasePbufferDCARB;
...
extern GLLOADAPI PFNWGLCHOOSEPIXELFORMATARBPROC _funcptr_wglChoosePixelFormatARB;
#define wglChoosePixelFormatARB _funcptr_wglChoosePixelFormatARB
extern GLLOADAPI PFNWGLGETPIXELFORMATATTRIBFVARBPROC _funcptr_wglGetPixelFormatAttribfvARB;
#define wglGetPixelFormatAttribfvARB _funcptr_wglGetPixelFormatAttribfvARB
extern GLLOADAPI PFNWGLGETPIXELFORMATATTRIBIVARBPROC _funcptr_wglGetPixelFormatAttribivARB;
...
extern GLLOADAPI PFNWGLBINDTEXIMAGEARBPROC _funcptr_wglBindTexImageARB;
#define wglBindTexImageARB _funcptr_wglBindTexImageARB
extern GLLOADAPI PFNWGLRELEASETEXIMAGEARBPROC _funcptr_wglReleaseTexImageARB;
#define wglReleaseTexImageARB _funcptr_wglReleaseTexImageARB
extern GLLOADAPI PFNWGLSETPBUFFERATTRIBARBPROC _funcptr_wglSetPbufferAttribARB;
...
extern GLLOADAPI PFNWGLBINDDISPLAYCOLORTABLEEXTPROC _funcptr_wglBindDisplayColorTableEXT;
#define wglBindDisplayColorTableEXT _funcptr_wglBindDisplayColorTableEXT
extern GLLOADAPI PFNWGLCREATEDISPLAYCOLORTABLEEXTPROC _funcptr_wglCreateDisplayColorTableEXT;
#define wglCreateDisplayColorTableEXT _funcptr_wglCreateDisplayColorTableEXT
extern GLLOADAPI PFNWGLDESTROYDISPLAYCOLORTABLEEXTPROC _funcptr_wglDestroyDisplayColorTableEXT;
#define wglDestroyDisplayColorTableEXT _funcptr_wglDestroyDisplayColorTableEXT
extern GLLOADAPI PFNWGLLOADDISPLAYCOLORTABLEEXTPROC _funcptr_wglLoadDisplayColorTableEXT;
...
extern GLLOADAPI PFNWGLGETEXTENSIONSSTRINGEXTPROC _funcptr_wglGetExtensionsStringEXT;
...
extern GLLOADAPI PFNWGLGETCURRENTREADDCEXTPROC _funcptr_wglGetCurrentReadDCEXT;
#define wglGetCurrentReadDCEXT _funcptr_wglGetCurrentReadDCEXT
extern GLLOADAPI PFNWGLMAKECONTEXTCURRENTEXTPROC _funcptr_wglMakeContextCurrentEXT;
...
extern GLLOADAPI PFNWGLCREATEPBUFFEREXTPROC _funcptr_wglCreatePbufferEXT;
#define wglCreatePbufferEXT _funcptr_wglCreatePbufferEXT
extern GLLOADAPI PFNWGLDESTROYPBUFFEREXTPROC _funcptr_wglDestroyPbufferEXT;
#define wglDestroyPbufferEXT _funcptr_wglDestroyPbufferEXT
extern GLLOADAPI PFNWGLGETPBUFFERDCEXTPROC _funcptr_wglGetPbufferDCEXT;
#define wglGetPbufferDCEXT _funcptr_wglGetPbufferDCEXT
extern GLLOADAPI PFNWGLQUERYPBUFFEREXTPROC _funcptr_wglQueryPbufferEXT;
#define wglQueryPbufferEXT _funcptr_wglQueryPbufferEXT
extern GLLOADAPI PFNWGLRELEASEPBUFFERDCEXTPROC _funcptr_wglReleasePbufferDCEXT;
...
extern GLLOADAPI PFNWGLCHOOSEPIXELFORMATEXTPROC _funcptr_wglChoosePixelFormatEXT;
#define wglChoosePixelFormatEXT _funcptr_wglChoosePixelFormatEXT
extern GLLOADAPI PFNWGLGETPIXELFORMATATTRIBFVEXTPROC _funcptr_wglGetPixelFormatAttribfvEXT;
#define wglGetPixelFormatAttribfvEXT _funcptr_wglGetPixelFormatAttribfvEXT
extern GLLOADAPI PFNWGLGETPIXELFORMATATTRIBIVEXTPROC _funcptr_wglGetPixelFormatAttribivEXT;
...
extern GLLOADAPI PFNWGLGETSWAPINTERVALEXTPROC _funcptr_wglGetSwapIntervalEXT;
#define wglGetSwapIntervalEXT _funcptr_wglGetSwapIntervalEXT
extern GLLOADAPI PFNWGLSWAPINTERVALEXTPROC _funcptr_wglSwapIntervalEXT;
...
extern GLLOADAPI PFNWGLGETDIGITALVIDEOPARAMETERSI3DPROC _funcptr_wglGetDigitalVideoParametersI3D;
#define wglGetDigitalVideoParametersI3D _funcptr_wglGetDigitalVideoParametersI3D
extern GLLOADAPI PFNWGLSETDIGITALVIDEOPARAMETERSI3DPROC _funcptr_wglSetDigitalVideoParametersI3D;
...
extern GLLOADAPI PFNWGLGETGAMMATABLEI3DPROC _funcptr_wglGetGammaTableI3D;
#define wglGetGammaTableI3D _funcptr_wglGetGammaTableI3D
extern GLLOADAPI PFNWGLGETGAMMATABLEPARAMETERSI3DPROC _funcptr_wglGetGammaTableParametersI3D;
#define wglGetGammaTableParametersI3D _funcptr_wglGetGammaTableParametersI3D
extern GLLOADAPI PFNWGLSETGAMMATABLEI3DPROC _funcptr_wglSetGammaTableI3D;
#define wglSetGammaTableI3D _funcptr_wglSetGammaTableI3D
extern GLLOADAPI PFNWGLSETGAMMATABLEPARAMETERSI3DPROC _funcptr_wglSetGammaTableParametersI3D;
...
extern GLLOADAPI PFNWGLDISABLEGENLOCKI3DPROC _funcptr_wglDisableGenlockI3D;
#define wglDisableGenlockI3D _funcptr_wglDisableGenlockI3D
extern GLLOADAPI PFNWGLENABLEGENLOCKI3DPROC _funcptr_wglEnableGenlockI3D;
#define wglEnableGenlockI3D _funcptr_wglEnableGenlockI3D
extern GLLOADAPI PFNWGLGENLOCKSAMPLERATEI3DPROC _funcptr_wglGenlockSampleRateI3D;
#define wglGenlockSampleRateI3D _funcptr_wglGenlockSampleRateI3D
extern GLLOADAPI PFNWGLGENLOCKSOURCEDELAYI3DPROC _funcptr_wglGenlockSourceDelayI3D;
#define wglGenlockSourceDelayI3D _funcptr_wglGenlockSourceDelayI3D
extern GLLOADAPI PFNWGLGENLOCKSOURCEEDGEI3DPROC _funcptr_wglGenlockSourceEdgeI3D;
#define wglGenlockSourceEdgeI3D _funcptr_wglGenlockSourceEdgeI3D
extern GLLOADAPI PFNWGLGENLOCKSOURCEI3DPROC _funcptr_wglGenlockSourceI3D;
#define wglGenlockSourceI3D _funcptr_wglGenlockSourceI3D
extern GLLOADAPI PFNWGLGETGENLOCKSAMPLERATEI3DPROC _funcptr_wglGetGenlockSampleRateI3D;
#define wglGetGenlockSampleRateI3D _funcptr_wglGetGenlockSampleRateI3D
extern GLLOADAPI PFNWGLGETGENLOCKSOURCEDELAYI3DPROC _funcptr_wglGetGenlockSourceDelayI3D;
#define wglGetGenlockSourceDelayI3D _funcptr_wglGetGenlockSourceDelayI3D
extern GLLOADAPI PFNWGLGETGENLOCKSOURCEEDGEI3DPROC _funcptr_wglGetGenlockSourceEdgeI3D;
#define wglGetGenlockSourceEdgeI3D _funcptr_wglGetGenlockSourceEdgeI3D
extern GLLOADAPI PFNWGLGETGENLOCKSOURCEI3DPROC _funcptr_wglGetGenlockSourceI3D;
#define wglGetGenlockSourceI3D _funcptr_wglGetGenlockSourceI3D
extern GLLOADAPI PFNWGLISENABLEDGENLOCKI3DPROC _funcptr_wglIsEnabledGenlockI3D;
#define wglIsEnabledGenlockI3D _funcptr_wglIsEnabledGenlockI3D
extern GLLOADAPI PFNWGLQUERYGENLOCKMAXSOURCEDELAYI3DPROC _funcptr_wglQueryGenlockMaxSourceDelayI3D;
...
extern GLLOADAPI PFNWGLASSOCIATEIMAGEBUFFEREVENTSI3DPROC _funcptr_wglAssociateImageBufferEventsI3D;
#define wglAssociateImageBufferEventsI3D _funcptr_wglAssociateImageBufferEventsI3D
extern GLLOADAPI PFNWGLCREATEIMAGEBUFFERI3DPROC _funcptr_wglCreateImageBufferI3D;
#define wglCreateImageBufferI3D _funcptr_wglCreateImageBufferI3D
extern GLLOADAPI PFNWGLDESTROYIMAGEBUFFERI3DPROC _funcptr_wglDestroyImageBufferI3D;
#define wglDestroyImageBufferI3D _funcptr_wglDestroyImageBufferI3D
extern GLLOADAPI PFNWGLRELEASEIMAGEBUFFEREVENTSI3DPROC _funcptr_wglReleaseImageBufferEventsI3D;
...
extern GLLOADAPI PFNWGLDISABLEFRAMELOCKI3DPROC _funcptr_wglDisableFrameLockI3D;
#define wglDisableFrameLockI3D _funcptr_wglDisableFrameLockI3D
extern GLLOADAPI PFNWGLENABLEFRAMELOCKI3DPROC _funcptr_wglEnableFrameLockI3D;
#define wglEnableFrameLockI3D _funcptr_wglEnableFrameLockI3D
extern GLLOADAPI PFNWGLISENABLEDFRAMELOCKI3DPROC _funcptr_wglIsEnabledFrameLockI3D;
#define wglIsEnabledFrameLockI3D _funcptr_wglIsEnabledFrameLockI3D
extern GLLOADAPI PFNWGLQUERYFRAMELOCKMASTERI3DPROC _funcptr_wglQueryFrameLockMasterI3D;
...
extern GLLOADAPI PFNWGLBEGINFRAMETRACKINGI3DPROC _funcptr_wglBeginFrameTrackingI3D;
#define wglBeginFrameTrackingI3D _funcptr_wglBeginFrameTrackingI3D
extern GLLOADAPI PFNWGLENDFRAMETRACKINGI3DPROC _funcptr_wglEndFrameTrackingI3D;
#define wglEndFrameTrackingI3D _funcptr_wglEndFrameTrackingI3D
extern GLLOADAPI PFNWGLGETFRAMEUSAGEI3DPROC _funcptr_wglGetFrameUsageI3D;
#define wglGetFrameUsageI3D _funcptr_wglGetFrameUsageI3D
extern GLLOADAPI PFNWGLQUERYFRAMETRACKINGI3DPROC _funcptr_wglQueryFrameTrackingI3D;
...
extern GLLOADAPI PFNWGLDXCLOSEDEVICENVPROC _funcptr_wglDXCloseDeviceNV;
#define wglDXCloseDeviceNV _funcptr_wglDXCloseDeviceNV
extern GLLOADAPI PFNWGLDXLOCKOBJECTSNVPROC _funcptr_wglDXLockObjectsNV;
#define wglDXLockObjectsNV _funcptr_wglDXLockObjectsNV
extern GLLOADAPI PFNWGLDXOBJECTACCESSNVPROC _funcptr_wglDXObjectAccessNV;
#define wglDXObjectAccessNV _funcptr_wglDXObjectAccessNV
extern GLLOADAPI PFNWGLDXOPENDEVICENVPROC _funcptr_wglDXOpenDeviceNV;
#define wglDXOpenDeviceNV _funcptr_wglDXOpenDeviceNV
extern GLLOADAPI PFNWGLDXREGISTEROBJECTNVPROC _funcptr_wglDXRegisterObjectNV;
#define wglDXRegisterObjectNV _funcptr_wglDXRegisterObjectNV
extern GLLOADAPI PFNWGLDXSETRESOURCESHAREHANDLENVPROC _funcptr_wglDXSetResourceShareHandleNV;
#define wglDXSetResourceShareHandleNV _funcptr_wglDXSetResourceShareHandleNV
extern GLLOADAPI PFNWGLDXUNLOCKOBJECTSNVPROC _funcptr_wglDXUnlockObjectsNV;
#define wglDXUnlockObjectsNV _funcptr_wglDXUnlockObjectsNV
extern GLLOADAPI PFNWGLDXUNREGISTEROBJECTNVPROC _funcptr_wglDXUnregisterObjectNV;
...
extern GLLOADAPI PFNWGLCOPYIMAGESUBDATANVPROC _funcptr_wglCopyImageSubDataNV;
...
extern GLLOADAPI PFNWGLCREATEAFFINITYDCNVPROC _funcptr_wglCreateAffinityDCNV;
#define wglCreateAffinityDCNV _funcptr_wglCreateAffinityDCNV
extern GLLOADAPI PFNWGLDELETEDCNVPROC _funcptr_wglDeleteDCNV;
#define wglDeleteDCNV _funcptr_wglDeleteDCNV
extern GLLOADAPI PFNWGLENUMGPUDEVICESNVPROC _funcptr_wglEnumGpuDevicesNV;
#define wglEnumGpuDevicesNV _funcptr_wglEnumGpuDevicesNV
extern GLLOADAPI PFNWGLENUMGPUSFROMAFFINITYDCNVPROC _funcptr_wglEnumGpusFromAffinityDCNV;
#define wglEnumGpusFromAffinityDCNV _funcptr_wglEnumGpusFromAffinityDCNV
extern GLLOADAPI PFNWGLENUMGPUSNVPROC _funcptr_wglEnumGpusNV;
...
extern GLLOADAPI PFNWGLBINDVIDEODEVICENVPROC _funcptr_wglBindVideoDeviceNV;
#define wglBindVideoDeviceNV _funcptr_wglBindVideoDeviceNV
extern GLLOADAPI PFNWGLENUMERATEVIDEODEVICESNVPROC _funcptr_wglEnumerateVideoDevicesNV;
#define wglEnumerateVideoDevicesNV _funcptr_wglEnumerateVideoDevicesNV
extern GLLOADAPI PFNWGLQUERYCURRENTCONTEXTNVPROC _funcptr_wglQueryCurrentContextNV;
...
extern GLLOADAPI PFNWGLBINDSWAPBARRIERNVPROC _funcptr_wglBindSwapBarrierNV;
#define wglBindSwapBarrierNV _funcptr_wglBindSwapBarrierNV
extern GLLOADAPI PFNWGLJOINSWAPGROUPNVPROC _funcptr_wglJoinSwapGroupNV;
#define wglJoinSwapGroupNV _funcptr_wglJoinSwapGroupNV
extern GLLOADAPI PFNWGLQUERYFRAMECOUNTNVPROC _funcptr_wglQueryFrameCountNV;
#define wglQueryFrameCountNV _funcptr_wglQueryFrameCountNV
extern GLLOADAPI PFNWGLQUERYMAXSWAPGROUPSNVPROC _funcptr_wglQueryMaxSwapGroupsNV;
#define wglQueryMaxSwapGroupsNV _funcptr_wglQueryMaxSwapGroupsNV
extern GLLOADAPI PFNWGLQUERYSWAPGROUPNVPROC _funcptr_wglQuerySwapGroupNV;
#define wglQuerySwapGroupNV _funcptr_wglQuerySwapGroupNV
extern GLLOADAPI PFNWGLRESETFRAMECOUNTNVPROC _funcptr_wglResetFrameCountNV;
...
extern GLLOADAPI PFNWGLALLOCATEMEMORYNVPROC _funcptr_wglAllocateMemoryNV;
#define wglAllocateMemoryNV _funcptr_wglAllocateMemoryNV
extern GLLOADAPI PFNWGLFREEMEMORYNVPROC _funcptr_wglFreeMemoryNV;
...
extern GLLOADAPI PFNWGLBINDVIDEOCAPTUREDEVICENVPROC _funcptr_wglBindVideoCaptureDeviceNV;
#define wglBindVideoCaptureDeviceNV _funcptr_wglBindVideoCaptureDeviceNV
extern GLLOADAPI PFNWGLENUMERATEVIDEOCAPTUREDEVICESNVPROC _funcptr_wglEnumerateVideoCaptureDevicesNV;
#define wglEnumerateVideoCaptureDevicesNV _funcptr_wglEnumerateVideoCaptureDevicesNV
extern GLLOADAPI PFNWGLLOCKVIDEOCAPTUREDEVICENVPROC _funcptr_wglLockVideoCaptureDeviceNV;
#define wglLockVideoCaptureDeviceNV _funcptr_wglLockVideoCaptureDeviceNV
extern GLLOADAPI PFNWGLQUERYVIDEOCAPTUREDEVICENVPROC _funcptr_wglQueryVideoCaptureDeviceNV;
#define wglQueryVideoCaptureDeviceNV _funcptr_wglQueryVideoCaptureDeviceNV
extern GLLOADAPI PFNWGLRELEASEVIDEOCAPTUREDEVICENVPROC _funcptr_wglReleaseVideoCaptureDeviceNV;
...
extern GLLOADAPI PFNWGLBINDVIDEOIMAGENVPROC _funcptr_wglBindVideoImageNV;
#define wglBindVideoImageNV _funcptr_wglBindVideoImageNV
extern GLLOADAPI PFNWGLGETVIDEODEVICENVPROC _funcptr_wglGetVideoDeviceNV;
#define wglGetVideoDeviceNV _funcptr_wglGetVideoDeviceNV
extern GLLOADAPI PFNWGLGETVIDEOINFONVPROC _funcptr_wglGetVideoInfoNV;
#define wglGetVideoInfoNV _funcptr_wglGetVideoInfoNV
extern GLLOADAPI PFNWGLRELEASEVIDEODEVICENVPROC _funcptr_wglReleaseVideoDeviceNV;
#define wglReleaseVideoDeviceNV _funcptr_wglReleaseVideoDeviceNV
extern GLLOADAPI PFNWGLRELEASEVIDEOIMAGENVPROC _funcptr_wglReleaseVideoImageNV;
#define wglReleaseVideoImageNV _funcptr_wglReleaseVideoImageNV
extern GLLOADAPI PFNWGLSENDPBUFFERTOVIDEONVPROC _funcptr_wglSendPbufferToVideoNV;
...
extern GLLOADAPI PFNWGLGETMSCRATEOMLPROC _funcptr_wglGetMscRateOML;
#define wglGetMscRateOML _funcptr_wglGetMscRateOML
extern GLLOADAPI PFNWGLGETSYNCVALUESOMLPROC _funcptr_wglGetSyncValuesOML;
#define wglGetSyncValuesOML _funcptr_wglGetSyncValuesOML
extern GLLOADAPI PFNWGLSWAPBUFFERSMSCOMLPROC _funcptr_wglSwapBuffersMscOML;
#define wglSwapBuffersMscOML _funcptr_wglSwapBuffersMscOML
extern GLLOADAPI PFNWGLSWAPLAYERBUFFERSMSCOMLPROC _funcptr_wglSwapLayerBuffersMscOML;
#define wglSwapLayerBuffersMscOML _funcptr_wglSwapLayerBuffersMscOML
extern GLLOADAPI PFNWGLWAITFORMSCOMLPROC _funcptr_wglWaitForMscOML;
#define wglWaitForMscOML _funcptr_wglWaitForMscOML
extern GLLOADAPI PFNWGLWAITFORSBCOMLPROC _funcptr_wglWaitForSbcOML;
