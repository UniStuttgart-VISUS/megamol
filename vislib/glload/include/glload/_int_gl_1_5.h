...
extern GLLOADAPI PFNGLBEGINQUERYPROC _funcptr_glBeginQuery;
#define glBeginQuery _funcptr_glBeginQuery
extern GLLOADAPI PFNGLBINDBUFFERPROC _funcptr_glBindBuffer;
#define glBindBuffer _funcptr_glBindBuffer
extern GLLOADAPI PFNGLBUFFERDATAPROC _funcptr_glBufferData;
#define glBufferData _funcptr_glBufferData
extern GLLOADAPI PFNGLBUFFERSUBDATAPROC _funcptr_glBufferSubData;
#define glBufferSubData _funcptr_glBufferSubData
extern GLLOADAPI PFNGLDELETEBUFFERSPROC _funcptr_glDeleteBuffers;
#define glDeleteBuffers _funcptr_glDeleteBuffers
extern GLLOADAPI PFNGLDELETEQUERIESPROC _funcptr_glDeleteQueries;
#define glDeleteQueries _funcptr_glDeleteQueries
extern GLLOADAPI PFNGLENDQUERYPROC _funcptr_glEndQuery;
#define glEndQuery _funcptr_glEndQuery
extern GLLOADAPI PFNGLGENBUFFERSPROC _funcptr_glGenBuffers;
#define glGenBuffers _funcptr_glGenBuffers
extern GLLOADAPI PFNGLGENQUERIESPROC _funcptr_glGenQueries;
#define glGenQueries _funcptr_glGenQueries
extern GLLOADAPI PFNGLGETBUFFERPARAMETERIVPROC _funcptr_glGetBufferParameteriv;
#define glGetBufferParameteriv _funcptr_glGetBufferParameteriv
extern GLLOADAPI PFNGLGETBUFFERPOINTERVPROC _funcptr_glGetBufferPointerv;
#define glGetBufferPointerv _funcptr_glGetBufferPointerv
extern GLLOADAPI PFNGLGETBUFFERSUBDATAPROC _funcptr_glGetBufferSubData;
#define glGetBufferSubData _funcptr_glGetBufferSubData
extern GLLOADAPI PFNGLGETQUERYOBJECTIVPROC _funcptr_glGetQueryObjectiv;
#define glGetQueryObjectiv _funcptr_glGetQueryObjectiv
extern GLLOADAPI PFNGLGETQUERYOBJECTUIVPROC _funcptr_glGetQueryObjectuiv;
#define glGetQueryObjectuiv _funcptr_glGetQueryObjectuiv
extern GLLOADAPI PFNGLGETQUERYIVPROC _funcptr_glGetQueryiv;
#define glGetQueryiv _funcptr_glGetQueryiv
extern GLLOADAPI PFNGLISBUFFERPROC _funcptr_glIsBuffer;
#define glIsBuffer _funcptr_glIsBuffer
extern GLLOADAPI PFNGLISQUERYPROC _funcptr_glIsQuery;
#define glIsQuery _funcptr_glIsQuery
extern GLLOADAPI PFNGLMAPBUFFERPROC _funcptr_glMapBuffer;
#define glMapBuffer _funcptr_glMapBuffer
extern GLLOADAPI PFNGLUNMAPBUFFERPROC _funcptr_glUnmapBuffer;
