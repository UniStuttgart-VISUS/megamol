...
extern GLLOADAPI PFNGLBLENDFUNCSEPARATEPROC _funcptr_glBlendFuncSeparate;
#define glBlendFuncSeparate _funcptr_glBlendFuncSeparate
extern GLLOADAPI PFNGLMULTIDRAWARRAYSPROC _funcptr_glMultiDrawArrays;
#define glMultiDrawArrays _funcptr_glMultiDrawArrays
extern GLLOADAPI PFNGLMULTIDRAWELEMENTSPROC _funcptr_glMultiDrawElements;
#define glMultiDrawElements _funcptr_glMultiDrawElements
extern GLLOADAPI PFNGLPOINTPARAMETERFPROC _funcptr_glPointParameterf;
#define glPointParameterf _funcptr_glPointParameterf
extern GLLOADAPI PFNGLPOINTPARAMETERFVPROC _funcptr_glPointParameterfv;
#define glPointParameterfv _funcptr_glPointParameterfv
extern GLLOADAPI PFNGLPOINTPARAMETERIPROC _funcptr_glPointParameteri;
#define glPointParameteri _funcptr_glPointParameteri
extern GLLOADAPI PFNGLPOINTPARAMETERIVPROC _funcptr_glPointParameteriv;
