...
extern GLLOADAPI PFNGLACTIVETEXTUREPROC _funcptr_glActiveTexture;
#define glActiveTexture _funcptr_glActiveTexture
extern GLLOADAPI PFNGLCOMPRESSEDTEXIMAGE1DPROC _funcptr_glCompressedTexImage1D;
#define glCompressedTexImage1D _funcptr_glCompressedTexImage1D
extern GLLOADAPI PFNGLCOMPRESSEDTEXIMAGE2DPROC _funcptr_glCompressedTexImage2D;
#define glCompressedTexImage2D _funcptr_glCompressedTexImage2D
extern GLLOADAPI PFNGLCOMPRESSEDTEXIMAGE3DPROC _funcptr_glCompressedTexImage3D;
#define glCompressedTexImage3D _funcptr_glCompressedTexImage3D
extern GLLOADAPI PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC _funcptr_glCompressedTexSubImage1D;
#define glCompressedTexSubImage1D _funcptr_glCompressedTexSubImage1D
extern GLLOADAPI PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC _funcptr_glCompressedTexSubImage2D;
#define glCompressedTexSubImage2D _funcptr_glCompressedTexSubImage2D
extern GLLOADAPI PFNGLCOMPRESSEDTEXSUBIMAGE3DPROC _funcptr_glCompressedTexSubImage3D;
#define glCompressedTexSubImage3D _funcptr_glCompressedTexSubImage3D
extern GLLOADAPI PFNGLGETCOMPRESSEDTEXIMAGEPROC _funcptr_glGetCompressedTexImage;
#define glGetCompressedTexImage _funcptr_glGetCompressedTexImage
extern GLLOADAPI PFNGLSAMPLECOVERAGEPROC _funcptr_glSampleCoverage;
