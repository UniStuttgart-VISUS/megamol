...
extern GLLOADAPI PFNGLBLENDCOLORPROC _funcptr_glBlendColor;
#define glBlendColor _funcptr_glBlendColor
extern GLLOADAPI PFNGLBLENDEQUATIONPROC _funcptr_glBlendEquation;
#define glBlendEquation _funcptr_glBlendEquation
extern GLLOADAPI PFNGLCOPYTEXSUBIMAGE3DPROC _funcptr_glCopyTexSubImage3D;
#define glCopyTexSubImage3D _funcptr_glCopyTexSubImage3D
extern GLLOADAPI PFNGLDRAWRANGEELEMENTSPROC _funcptr_glDrawRangeElements;
#define glDrawRangeElements _funcptr_glDrawRangeElements
extern GLLOADAPI PFNGLTEXIMAGE3DPROC _funcptr_glTexImage3D;
#define glTexImage3D _funcptr_glTexImage3D
extern GLLOADAPI PFNGLTEXSUBIMAGE3DPROC _funcptr_glTexSubImage3D;
