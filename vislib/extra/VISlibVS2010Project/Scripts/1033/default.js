...
{
    try {
        // CUSTOMISATION: Set additional symbols
        var now = new Date();
        var today = now.getDate() + '.' + (now.getMonth() + 1) + '.' + now.getFullYear();
        wizard.AddSymbol('CURRENT_DATE', today);
        wizard.AddSymbol('CURRENT_YEAR', now.getFullYear());
...
function AddConfig(proj, strProjectName)
{
    try
    {
        ...
        // CUSTOMISATION: Set compiler options
        CLTool.PreprocessorDefinitions = '_WIN32;_DEBUG;WIN32;DEBUG';
        ...
        // CUSTOMISATION: Add our property sheets etc.
        config.IntermediateDirectory = "$(PlatformName)\\$(Configuration)";
        config.OutputDirectory = "$(PlatformName)\\$(Configuration)";

        var defProp = wizard.FindSymbol("VISLIB_DIR") + "\\VSProps\\TargetDebug32.props";
        var libProp = ".\\" + wizard.FindSymbol("PROPS_FILENAME");
        //TODO: The following two lines cause VS2010 to crash:
        //config.AddPropertySheet(defProp.toString());
        //config.AddPropertySheet(libProp.toString());
        // END CUSTOMISATION
        ...
        var CLTool = config.Tools('VCCLCompilerTool');
        // CUSTOMISATION: Set compiler options
        CLTool.PreprocessorDefinitions = '_WIN32;_NDEBUG;WIN32;_NDEBUG';
        CLTool.UsePrecompiledHeader = pchOption.pchNone;
        // END CUSTOMISATION
...
function GetTargetName(strName, strProjectName)
{
    try
    {
        ...
        // CUSTOMISATION: Rename files
        if (strName == 'extlibs.props') {
