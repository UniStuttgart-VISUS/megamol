...
public:
     ...
     *         +1 if (this > 'rhs')
     */
    inline Size Compare(const String& rhs, const bool isCaseSensitive) const {
     ...
     */
    inline bool Contains(const Char* str, const Size beginningAt = 0) const {
     ...
     * @return true if 'str' is found at 'beginningAt' or after that.
     */
    inline bool Contains(const String& str, const Size beginningAt = 0) const {
     ...
     *                        will be case-insensitive.
     */
    inline bool Equals(const String& rhs, const bool isCaseSensitive = true) const {
     ...
     */
    inline bool EscapeCharacters(const Char ec, const String& normChars, const String& escpdChars) {
        return this->EscapeCharacters(ec, normChars.PeekBuffer(), escpdChars.PeekBuffer());
    }
     ...
     *         'false' if there was an error.
     */
    bool EscapeCharacters(const Char ec, const Char* normChars, const Char* escpdChars);
     ...
     */
    Size FindLast(const Char* str, const Size beginningAt = INVALID_POS) const;
     ...
     *         INVALID_POS, if 'str' was not found.
     */
    inline Size FindLast(const String& str, const Size beginningAt = INVALID_POS) const {
     ...
     */
    Size LevenshteinDistance(
        const Char* rhs, const Size costAdd = 1, const Size costDelete = 1, const Size costChange = 1) const;
     ...
     *                        result cannot be allocated.
     */
    inline Size LevenshteinDistance(
        const String& rhs, const Size costAdd = 1, const Size costDelete = 1, const Size costChange = 1) const {
        return this->LevenshteinDistance(rhs.data, costAdd, costDelete, costChange);
    }
     ...
     */
    Size Replace(const Char oldChar, const Char newChar, const Size limit = NO_LIMIT);
     ...
     */
    Size Replace(const Char* oldStr, const Char* newStr, const Size limit = NO_LIMIT);
     ...
     * @return The number of replacements made.
     */
    inline Size Replace(const String& oldStr, const String& newStr, const Size limit = NO_LIMIT) {
     ...
     * @return The number of replacements made.
     */
    inline Size Replace(const Char oldChar, const Char* newStr, const Size limit = NO_LIMIT) {
     ...
     * @return The number of replacements made.
     */
    inline Size Replace(const Char oldChar, const String& newStr, const Size limit = NO_LIMIT) {
     ...
     * @return The number of replacements made.
     */
    inline Size Replace(const Char* oldStr, const Char newChar, const Size limit = NO_LIMIT) {
     ...
     * @return The number of replacements made.
     */
    inline Size Replace(const String& oldStr, const Char newChar, const Size limit = NO_LIMIT) {
     ...
     */
    bool StartsWith(const Char* str, const bool isCaseSensitive = true) const;
     ...
     *         'false' if there was an error.
     */
    inline bool UnescapeCharacters(const Char ec, const String& normChars, const String& escpdChars) {
        return this->UnescapeCharacters(ec, normChars.PeekBuffer(), escpdChars.PeekBuffer());
    }
     ...
     *         'false' if there was an error.
     */
    bool UnescapeCharacters(const Char ec, const Char* normChars, const Char* escpdChars);
     ...
     */
    template<class U>
    String& operator=(const String<U>& rhs);
 ...
 */
template<class T>
String<T>::String(const Char* data) : data(NULL) {
 ...
 */
template<class T>
String<T>::String(const Char* data, const Size cnt) : data(NULL) {
    Size newLen = cnt;
...
template<class T>
template<class U>
String<T>::String(const String<U>& data) {
    Size newLen = data.Length() + 1;
    this->data = new Char[newLen];
    U::Convert(this->data, newLen, static_cast<const typename U::Char*>(data));
}
 ...
 */
template<class T>
String<T>::String(const Char c, const Size cnt) : data(NULL) {
 ...
 */
template<class T>
String<T>::String(const String& rhs) : data(NULL) {
 ...
 */
template<class T>
void String<T>::Append(const Char* rhs, const Size cnt) {
 ...
 */
template<class T>
typename String<T>::Size String<T>::Compare(const Char* rhs, const bool isCaseSensitive) const {
    ...
    if (isCaseSensitive) {
        ...
        while (((retval = T::ToLower(*lhs) - T::ToLower(*rhs)) == 0) && (*lhs != 0)) {
            lhs++;
            rhs++;
        }
    }
 ...
 */
template<class T>
bool String<T>::EndsWith(const Char c) const {
    Size len = this->Length();
 ...
 */
template<class T>
bool String<T>::EndsWith(const Char* str) const {
 ...
 */
template<class T>
bool String<T>::EscapeCharacters(const Char ec, const Char* normChars, const Char* escpdChars) {
 ...
 */
template<class T>
typename String<T>::Size String<T>::Find(const Char c, const Size beginningAt) const {
    Size len = this->Length();
 ...
 */
template<class T>
typename String<T>::Size String<T>::Find(const Char* str, const Size beginningAt) const {
 ...
 */
template<class T>
typename String<T>::Size String<T>::FindLast(const Char c, const Size beginningAt) const {
 ...
 */
template<class T>
typename String<T>::Size String<T>::FindLast(const Char* str, const Size beginningAt) const {
    // TODO: Naive implementation, consider Rabin-Karp
    ...
    for (Size i = len; i >= 0; i--) {
        for (j = strLen; (j >= 0) && (this->data[i - strLen + j] == str[j]); j--)
            ;
 ...
 */
template<class T>
void String<T>::Format(const Char* fmt, ...) {
    va_list argptr;
    Size size = 0;
 ...
 */
template<class T>
void String<T>::Format(const String* fmt, ...) {
 ...
 */
template<class T>
void String<T>::FormatVa(const Char* fmt, va_list argptr) {
    va_list argptrtmp;
    Size size = 0;
 ...
 */
template<class T>
void String<T>::Insert(const Size pos, const Char c) {
    Size len = this->Length();
    ...
    if ((pos >= 0) && (pos <= len)) {
        ...
        str[pos] = c;
        ::memcpy(str + pos + 1, this->data + pos, (len - pos + 1) * T::CharSize());

        delete[] this->data;
        this->data = str;
    } else {
        throw OutOfRangeException(pos, 0, static_cast<int>(len), __FILE__, __LINE__);
    }
}
 ...
 */
template<class T>
void String<T>::Insert(const Size pos, const Char* str) {
    Size len = this->Length();
    Size strLen = 0;
    ...
    if ((pos >= 0) && (pos <= len)) {
        if ((strLen = T::SafeStringLength(str)) > 0) {
            ...
            ::memcpy(newData + pos + strLen, this->data + pos, (len - pos + 1) * T::CharSize());
 ...
 */
template<class T>
typename String<T>::Size String<T>::LevenshteinDistance(
    const Char* rhs, const Size costAdd, const Size costDelete, const Size costChange) const {
    // mueller: Adapted from wbcore. I am not completely sure whether this
    // works ...
#define VL_LVS_ARY_IDX(i, j) ((i) * (len2 + 1) + (j))
#define VL_LVS_MIN3(a, b, c) (((a) < (b)) ? (((c) < (a)) ? (c) : (a)) : (((c) < (b)) ? (c) : (b)))
    ...
    for (Size i = 1; i <= len1; i++) {
        for (Size j = 1; j <= len2; j++) {
            dist[VL_LVS_ARY_IDX(i, j)] =
                VL_LVS_MIN3(dist[VL_LVS_ARY_IDX(i - 1, j - 1)] + ((this->data[i - 1] == rhs[j - 1]) ? 0 : costChange),
                    dist[VL_LVS_ARY_IDX(i, j - 1)] + costAdd, dist[VL_LVS_ARY_IDX(i - 1, j)] + costDelete);
        }
    }
...
bool String<T>::Load(const HINSTANCE hInst, const UINT id) {
    ...
    while ((charsRead = T::StringFromResource(hInst, id, buffer, bufLen)) == bufLen - 1) {
        delete[] buffer;
        bufLen *= 2;
 ...
 */
template<class T>
void String<T>::Prepend(const Char rhs) {
    Size len = this->Length();
    Char* str = new Char[len + 2];
 ...
 */
template<class T>
void String<T>::Remove(const Size begin, const Size cnt) {
    Size len = this->Length();
    Char* str = NULL;
    ...
    if (begin < len) {
        if ((cnt != INVALID_POS) && (begin + cnt <= len)) {
            ...
            ::memcpy(str + begin, this->data + begin + cnt, (len - begin - cnt + 1) * sizeof(Char));
 ...
 */
template<class T>
typename String<T>::Size String<T>::Replace(const Char oldChar, const Char newChar, const Size limit) {
    Size retval = 0;
    Size len = this->Length();
 ...
 */
template<class T>
typename String<T>::Size String<T>::Replace(const Char* oldStr, const Char* newStr, const Size limit) {
    ...
    while (((nextStart = this->Find(oldStr, nextStart)) != INVALID_POS) && ((limit < 0) || (retval < limit))) {
        retval++;
        nextStart += oldLen;
    }
 ...
 */
template<class T>
bool String<T>::StartsWith(const Char c, const bool isCaseSensitive) const {
    return isCaseSensitive ? (this->data[0] == c) : (T::ToLower(this->data[0]) == T::ToLower(c));
}
 ...
 */
template<class T>
bool String<T>::StartsWith(const Char* str, const bool isCaseSensitive) const {
    if (str != NULL) {
        const Char* s = str;
 ...
 */
template<class T>
String<T> String<T>::Substring(const Size begin) const {
    Size len = this->Length();
 ...
 */
template<class T>
String<T> String<T>::Substring(const Size begin, const Size length) const {
    Size len = this->Length();
 ...
 */
template<class T>
void String<T>::TrimBegin(const Char* chars) {
    const Char* c = NULL;
    Char* s = NULL;
    Size len = this->Length();
    Size i = 0;
 ...
 */
template<class T>
void String<T>::TrimEnd(const Char* chars) {
    const Char* c = NULL;
    Char* s = NULL;
    Size len = this->Length();
    Size i = 0;
 ...
 */
template<class T>
void String<T>::Truncate(const Size size) {
    Size len = this->Length();
    Char* str = NULL;
 ...
 */
template<class T>
bool String<T>::UnescapeCharacters(const Char ec, const Char* normChars, const Char* escpdChars) {
    Size ncLen = T::SafeStringLength(normChars);
 ...
 */
template<class T>
String<T>& String<T>::operator=(const String& rhs) {
    if (this != &rhs) {
        delete[] this->data;
 ...
 */
template<class T>
String<T>& String<T>::operator=(const Char* rhs) {
    if (this->data != rhs) {
        delete[] this->data;
...
String<T>& String<T>::operator=(const String<U>& rhs) {
    if (static_cast<void*>(this) != static_cast<const void*>(&rhs)) {
        ...
        U::Convert(this->data, newLen, static_cast<const typename U::Char*>(rhs));
    }
 ...
 */
template<class T>
String<T> String<T>::operator+(const Char rhs) const {
    Size len = this->Length();
 ...
 */
template<class T>
void String<T>::operator+=(const Char rhs) {
    Size len = this->Length();
    Char* str = new Char[len + 2];
...
typename String<T>::Char String<T>::operator[](const Size i) const {
    if ((i >= 0) && (i < this->Length())) {
        ...
        throw OutOfRangeException(i, 0, static_cast<int>(this->Length() - 1), __FILE__, __LINE__);
    }
}
