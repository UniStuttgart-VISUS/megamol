 ...
 */
template<class T>
void EncodeEntities(vislib::String<T>& inOutStr) {
    // TODO: Rewrite as soon as multi-replace is supported
    inOutStr.Replace(static_cast<typename T::Char>('&'), vislib::String<T>("&amp;"));
    inOutStr.Replace(static_cast<typename T::Char>('<'), vislib::String<T>("&lt;"));
    inOutStr.Replace(static_cast<typename T::Char>('>'), vislib::String<T>("&gt;"));
    inOutStr.Replace(static_cast<typename T::Char>('\"'), vislib::String<T>("&quot;"));
    inOutStr.Replace(static_cast<typename T::Char>('\''), vislib::String<T>("&apos;"));
 ...
 */
template<class T>
void DecodeEntities(vislib::String<T>& inOutStr) {
    // TODO: Rewrite as soon as multi-replace is supported
    ...
    inOutStr.Replace(vislib::String<T>("&apos;"), static_cast<typename T::Char>('\''));
    inOutStr.Replace(vislib::String<T>("&quot;"), static_cast<typename T::Char>('\"'));
    inOutStr.Replace(vislib::String<T>("&gt;"), static_cast<typename T::Char>('>'));
    inOutStr.Replace(vislib::String<T>("&lt;"), static_cast<typename T::Char>('<'));
    inOutStr.Replace(vislib::String<T>("&amp;"), static_cast<typename T::Char>('&'));
