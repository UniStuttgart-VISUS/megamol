...
public:
     ...
     */
    virtual void SetPosition(const math::Point<SceneSpaceType, 3>& position);
     ...
     * @param focalDistance The focal distance.
     */
    virtual void SetStereoParameters(SceneSpaceType stereoDisparity, StereoEye eye, SceneSpaceType focalDistance);
     ...
     * @param up The up vector of the camera in world coordinates.
     */
    virtual void SetView(const math::Point<SceneSpaceType, 3>& position, const math::Point<SceneSpaceType, 3>& lookAt,
     ...
     */
    virtual void SetVirtualViewSize(const math::Dimension<ImageSpaceType, 2>& viewSize);
