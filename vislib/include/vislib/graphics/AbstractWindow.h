...
public:
     ...
     *                         adjusted in size.
     */
    void Create(const vislib::StringA& title, int left, int top, int width, int height);
     ...
     *                         adjusted in size.
     */
    void Create(const vislib::StringW& title, int left, int top, int width, int height);
...
#else  /* _WIN32 */
        throw MissingImplementationException("AbstractWindow::Hide", __FILE__, __LINE__);
#endif /* _WIN32 */
    }
...
#else  /* _WIN32 */
        throw MissingImplementationException("AbstractWindow::Show", __FILE__, __LINE__);
#endif /* _WIN32 */
    }
...
protected:
     ...
     * @return
     */
    virtual LRESULT onMessage(bool& outHandled, UINT msg, WPARAM wParam, LPARAM lParam) throw();
#endif /* _WIN32 */
     ...
     */
    virtual void onWindowClassRegistering(WNDCLASSEXW& inOutWndClass) throw();
#endif /* _WIN32 */
     ...
     */
    virtual void onWindowClassRegistered(const vislib::StringW className) throw();
#endif /* _WIN32 */
