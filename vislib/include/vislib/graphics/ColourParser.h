...
public:
     ...
     */
    static inline ColourRGBAu8& FromString(
        const vislib::StringA& inStr, ColourRGBAu8& outCol, bool allowQuantization = true) {
     ...
     * @throw FormatException if 'inStr' cannot be parsed
     */
    static inline void FromString(const vislib::StringA& inStr, unsigned char& outR, unsigned char& outG,
     ...
     * @throw FormatException if 'inStr' cannot be parsed
     */
    static void FromString(const vislib::StringA& inStr, unsigned char& outR, unsigned char& outG, unsigned char& outB,
     ...
     * @throw FormatException if 'inStr' cannot be parsed
     */
    static inline void FromString(const vislib::StringA& inStr, float& outR, float& outG, float& outB) {
        float dummyA;
     ...
     * @throw FormatException if 'inStr' cannot be parsed
     */
    static void FromString(const vislib::StringA& inStr, float& outR, float& outG, float& outB, float& outA);
     ...
     */
    static inline vislib::StringA& ToString(
        vislib::StringA& outStr, const ColourRGBAu8& inCol, int repType = REPTYPE_BYTE | REPTYPE_NAMED | REPTYPE_HTML) {
        return ToString(outStr, inCol.R(), inCol.G(), inCol.B(), inCol.A(), repType);
    }
     ...
     *        of the allowed representation types
     */
    static inline vislib::StringA& ToString(vislib::StringA& outStr, unsigned char inR, unsigned char inG,
        unsigned char inB, int repType = REPTYPE_BYTE | REPTYPE_NAMED | REPTYPE_HTML) {
     ...
     *        of the allowed representation types
     */
    static vislib::StringA& ToString(vislib::StringA& outStr, unsigned char inR, unsigned char inG, unsigned char inB,
        unsigned char inA, int repType = REPTYPE_BYTE | REPTYPE_NAMED | REPTYPE_HTML);
     ...
     *        of the allowed representation types
     */
    static inline vislib::StringA& ToString(vislib::StringA& outStr, float inR, float inG, float inB,
        int repType = REPTYPE_BYTE | REPTYPE_NAMED | REPTYPE_HTML | REPTYPE_FLOAT) {
     ...
     *        of the allowed representation types
     */
    static vislib::StringA& ToString(vislib::StringA& outStr, float inR, float inG, float inB, float inA,
        int repType = REPTYPE_BYTE | REPTYPE_NAMED | REPTYPE_HTML | REPTYPE_FLOAT);
...
private:
     ...
     */
    static bool parseArray(const vislib::StringA& inStr, float& outR, float& outG, float& outB, float& outA);
