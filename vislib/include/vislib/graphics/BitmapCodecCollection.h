...
public:
     ...
     */
    bool LoadBitmapImage(BitmapImage& outImg, const vislib::StringA& filename);
     ...
     * @throw vislib::Exception or derived class on error
     */
    bool LoadBitmapImage(BitmapImage& outImg, const vislib::StringW& filename);
     ...
     * @throw vislib::Exception or derived class on error
     */
    inline bool LoadBitmapImage(BitmapImage& outImg, const char* filename) {
     ...
     * @throw vislib::Exception or derived class on error
     */
    inline bool LoadBitmapImage(BitmapImage& outImg, const wchar_t* filename) {
     ...
     * @throw vislib::Exception or derived class on error
     */
    bool LoadBitmapImage(BitmapImage& outImg, const void* mem, SIZE_T size);
     ...
     * @throw vislib::Exception or derived class on error
     */
    inline bool LoadBitmapImage(BitmapImage& outImg, const vislib::RawStorage& mem) {
...
private:
     ...
     */
    void selectCodecsByFilename(const vislib::StringA& filename, CodecArray& outCodecs) const;
     ...
     * @param outCodecs The codec array receiving the matching codecs
     */
    void selectCodecsByFilename(const vislib::StringW& filename, CodecArray& outCodecs) const;
     ...
     */
    void autodetecCodec(const void* mem, SIZE_T size, const CodecArray& codecs, CodecArray& outMatchingCodecs,
