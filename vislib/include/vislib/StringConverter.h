...
#ifndef A2W
#define A2W(str) static_cast<const WCHAR*>(vislib::StringConverter<vislib::CharTraitsA, vislib::CharTraitsW>(str))
#endif /* !A2W */
#ifndef W2A
#define W2A(str) static_cast<const CHAR*>(vislib::StringConverter<vislib::CharTraitsW, vislib::CharTraitsA>(str))
#endif /* !W2A */
 ...
 */
template<class S, class T, VL_INT32 B = 64>
...
private:
    ...
    inline StringConverter(const StringConverter& rhs) {
        throw UnsupportedOperationException("vislib::StringConverter::StringConverter", __FILE__, __LINE__);
    }
...
StringConverter<S, T, B>::StringConverter(const SrcChar* str) : buffer(NULL) {
 ...
 */
template<class S, class T, VL_INT32 B>
StringConverter<S, T, B>& StringConverter<S, T, B>::operator=(const StringConverter& rhs) {
    if (this != &rhs) {
        throw IllegalParamException("vislib::StringConverT::operator =", __FILE__, __LINE__);
    }
    return *this;
}
} // namespace vislib
