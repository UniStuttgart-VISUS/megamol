...
public:
     ...
     *                               IP address.
     */
    static IPEndPoint CreateIPv4(const char* hostNameOrAddress, const unsigned short port);
     ...
     *                               IP address.
     */
    static IPEndPoint CreateIPv6(const char* hostNameOrAddress, const unsigned short port);
     ...
     */
    IPEndPoint(const IPAddress& ipAddress = IPAddress::ANY, const unsigned short port = 0);
     ...
     * @param port      The port number of the end point.
     */
    IPEndPoint(const IPAgnosticAddress& ipAddress, const unsigned short port);
     ...
     *                              supported families.
     */
    IPEndPoint(const AddressFamily addressFamily, const unsigned short port);
