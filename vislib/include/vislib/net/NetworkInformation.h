...
public:
    ...
    public:
         ...
         */
        NoConfidenceException(const char* propName, const char* file, const int line);
         ...
         * @param line     The line the exception was thrown in.
         */
        NoConfidenceException(const wchar_t* propName, const char* file, const int line);
         ...
         * @return *this.
         */
        virtual NoConfidenceException& operator=(const NoConfidenceException& rhs);
...
private:
    ...
    public:
         ...
         *                               INVALID.
         */
        void GetConfidence(Confidence* outConfidence, const char* name) const;
        ...
        inline bool operator==(const AssessedMember& rhs) const {
            return ((this->confidence == rhs.confidence) && (this->value == rhs.value));
        }
...
public:
    ...
    public:
         ...
         */
        inline ULONG GetPrefixLength(Confidence* outConfidence = NULL) const {
            this->prefixLength.GetConfidence(outConfidence, "Prefix Length");
         ...
         *                               and 'outConfidence' is NULL.
         */
        inline PrefixOrigin GetPrefixOrigin(Confidence* outConfidence = NULL) const {
            this->prefixOrigin.GetConfidence(outConfidence, "Prefix Origin");
         ...
         *                               and 'outConfidence' is NULL.
         */
        inline SuffixOrigin GetSuffixOrigin(Confidence* outConfidence = NULL) const {
            this->suffixOrigin.GetConfidence(outConfidence, "Suffix Origin");
         ...
         * @return *this.
         */
        UnicastAddressInformation& operator=(const UnicastAddressInformation& rhs);
         ...
         *         false otherwise.
         */
        inline bool operator!=(const UnicastAddressInformation& rhs) const {
            return !(*this == rhs);
        }
    ...
    private:
         ...
         */
        UnicastAddressInformation(const IPEndPoint endPoint, const ULONG prefixLength,
            const Confidence prefixLengthConfidence, const PrefixOrigin prefixOrigin,
            const Confidence prefixOriginConfidence, const SuffixOrigin suffixOrigin,
    ...
    public:
         ...
         *                               and 'outConfidence' is NULL.
         */
        inline const AddressList& GetAnycastAddresses(Confidence* outConfidence = NULL) const {
            this->anycastAddresses.GetConfidence(outConfidence, "Anycast Addresses");
         ...
         *                               and 'outConfidence' is NULL.
         */
        inline const IPAddress& GetBroadcastAddress(Confidence* outConfidence = NULL) const {
            this->broadcastAddress.GetConfidence(outConfidence, "Broadcast Address");
         ...
         *                               and 'outConfidence' is NULL.
         */
        inline const StringW& GetDescription(Confidence* outConfidence = NULL) const {
            this->description.GetConfidence(outConfidence, "Description");
         ...
         *                               and 'outConfidence' is NULL.
         */
        inline const StringA& GetID(Confidence* outConfidence = NULL) const {
         ...
         *                               and 'outConfidence' is NULL.
         */
        inline const AddressList& GetMulticastAddresses(Confidence* outConfidence = NULL) const {
            this->multicastAddresses.GetConfidence(outConfidence, "Multicast Addresses");
         ...
         *                               and 'outConfidence' is NULL.
         */
        inline const StringW& GetName(Confidence* outConfidence = NULL) const {
         ...
         *                               and 'outConfidence' is NULL.
         */
        const Array<BYTE>& GetPhysicalAddress(Confidence* outConfidence = NULL) const;
         ...
         *                               and 'outConfidence' is NULL.
         */
        inline OperStatus GetStatus(Confidence* outConfidence = NULL) const {
         ...
         *                             addresses assigned.
         */
        const IPAgnosticAddress GetUnicastAddress(const IPAgnosticAddress::AddressFamily preferredFamily) const;
         ...
         *                               and 'outConfidence' is NULL.
         */
        inline const UnicastAddressList& GetUnicastAddresses(Confidence* outConfidence = NULL) const {
            this->unicastAddresses.GetConfidence(outConfidence, "Unicast Addresses");
     ...
     */
    typedef bool (*EnumerateAdaptersCallback)(const Adapter& adapter, void* userContext);
     ...
     */
    typedef bool (*SelectAdapterCallback)(const Adapter& adapter, void* userContext);
     ...
     *                               adapters could not be allocated.
     */
    static void EnumerateAdapters(EnumerateAdaptersCallback cb, void* userContext = NULL);
     ...
     *                             retrieving the data.
     */
    static SIZE_T GetAdaptersForPredicate(AdapterList& outAdapters, SelectAdapterCallback cb, void* userContext = NULL);
     ...
     *                             retrieving the data.
     */
    static SIZE_T GetAdaptersForType(AdapterList& outAdapters, const Adapter::Type type);
     ...
     *                             retrieving the data.
     */
    static SIZE_T GetAdaptersForUnicastAddress(AdapterList& outAdapters, const IPAddress& address);
     ...
     *                             retrieving the data.
     */
    static SIZE_T GetAdaptersForUnicastAddress(AdapterList& outAdapters, const IPAddress6& address);
     ...
     *                             retrieving the data.
     */
    static SIZE_T GetAdaptersForUnicastAddress(AdapterList& outAdapters, const IPAgnosticAddress& address);
     ...
     *                             retrieving the data.
     */
    static SIZE_T GetAdaptersForUnicastPrefix(
     ...
     *                       wildness. Note that this is not chefmäßig!
     *
     ...
     *                                available.
     */
    static float GuessAdapter(Adapter& outAdapter, const char* str, const bool invertWildness = false);
     ...
     *                                available.
     */
    static float GuessAdapter(Adapter& outAdapter, const wchar_t* str, const bool invertWildness = false);

    // TODO: documentation
    static float GuessLocalEndPoint(IPEndPoint& outEndPoint, const char* str,
        const IPAgnosticAddress::AddressFamily preferredFamily, const bool invertWildness = false);

    // TODO: documentation
    static float GuessLocalEndPoint(IPEndPoint& outEndPoint, const wchar_t* str,
        const IPAgnosticAddress::AddressFamily preferredFamily, const bool invertWildness = false);

    // TODO: documentation
    static float GuessLocalEndPoint(IPEndPoint& outEndPoint, const char* str, const bool invertWildness = false);

    // TODO: documentation
    static float GuessLocalEndPoint(IPEndPoint& outEndPoint, const wchar_t* str, const bool invertWildness = false);

    // TODO: documentation
    static float GuessRemoteEndPoint(IPEndPoint& outEndPoint, const char* str,
        const IPAgnosticAddress::AddressFamily preferredFamily, const bool invertWildness = false);

    // TODO: documentation
    static float GuessRemoteEndPoint(IPEndPoint& outEndPoint, const char* str, const bool invertWildness = false);

    // TODO: documentation
    static float GuessRemoteEndPoint(IPEndPoint& outEndPoint, const wchar_t* str,
        const IPAgnosticAddress::AddressFamily preferredFamily, const bool invertWildness = false);

    // TODO: documentation
    static float GuessRemoteEndPoint(IPEndPoint& outEndPoint, const wchar_t* str, const bool invertWildness = false);
    ...
    inline static ULONG NetmaskToPrefix(const IPAddress& netmask) {
        const BYTE* mask = reinterpret_cast<const BYTE*>(static_cast<const struct in_addr*>(netmask));
        return NetworkInformation::netmaskToPrefix(mask, sizeof(struct in_addr));
    }
    ...
    inline static ULONG NetmaskToPrefix(const IPAddress6& netmask) {
        const BYTE* mask = reinterpret_cast<const BYTE*>(static_cast<const struct in6_addr*>(netmask));
        return NetworkInformation::netmaskToPrefix(mask, sizeof(struct in6_addr));
    }
    ...
    inline static IPAddress PrefixToNetmask4(const ULONG prefix) {
        IPAddress retval;
        BYTE* mask = reinterpret_cast<BYTE*>(static_cast<struct in_addr*>(retval));
        NetworkInformation::prefixToNetmask(mask, sizeof(struct in_addr), prefix);
        return retval;
    }
     ...
     *                               stringised.
     */
    static const char* Stringise(const UnicastAddressInformation::PrefixOrigin po);
     ...
     *                               stringised.
     */
    static const char* Stringise(const UnicastAddressInformation::SuffixOrigin so);
...
private:
    ...
    // TODO: documentation
    static float assessAddressAsEndPoint(const UnicastAddressInformation& addrInfo, const GuessLocalEndPointCtx& ctx);
     ...
     */
    static float consolidateWildness(Array<float>& inOutWildness, SIZE_T& outIdxFirstBest);
     ...
     */
    template<class A>
    static int findAddress(const UnicastAddressList& list, const A& addr, const int startIdx = 0);
     ...
     */
    template<class A>
    static int findSamePrefix(
        const UnicastAddressList& list, const A& addr, const ULONG prefixLen, const int startIdx = 0);
     ...
     */
    static IPAddress guessBroadcastAddress(const IPAddress& address, const IPAddress& netmask);
     ...
     * @throws IllegalParamException If no valid mapping could be found.
     */
    static Adapter::OperStatus mapOperationStatus(const IF_OPER_STATUS status);
#endif /* _WIN32 */
     ...
     * @throws IllegalParamException If no valid mapping could be found.
     */
    static UnicastAddressInformation::PrefixOrigin mapPrefixOrigin(const IP_PREFIX_ORIGIN prefixOrigin);
     ...
     * @throws IllegalParamException If no valid mapping could be found.
     */
    static UnicastAddressInformation::SuffixOrigin mapSuffixOrigin(const IP_SUFFIX_ORIGIN suffixOrigin);
#endif /* _WIN32 */
     ...
     *                             valid range.
     */
    static void prefixToNetmask(BYTE* outNetmask, const SIZE_T len, const ULONG prefix);
     ...
     * @return true
     */
    static bool processAdapterForLocalEndpointGuess(const Adapter& adapter, void* context);
     ...
     */
    static bool selectAdapterByUnicastIP(const Adapter& adapter, void* addr);
     ...
     * @return true if the address has been found, false otherwise.
     */
    static bool selectAdapterByUnicastIPv4(const Adapter& adapter, void* addr);
     ...
     * @return true if the address has been found, false otherwise.
     */
    static bool selectAdapterByUnicastIPv6(const Adapter& adapter, void* addr);
     ...
     * @return true if the address has been found, false otherwise.
     */
    static bool selectAdapterByUnicastPrefix(const Adapter& adapter, void* addrInfo);
     ...
     */
    static float wildGuessAdapter(Adapter& outAdapter, const IPAgnosticAddress& address, const StringW& device,
     ...
     */
    static UINT32 wildGuessSplitInput(IPAgnosticAddress& outAddress, StringW& outDevice, ULONG& outPrefixLen,
        USHORT& outPort, const wchar_t* str, const IPAgnosticAddress::AddressFamily* prefFam = NULL);
 ...
 */
template<class T>
NetworkInformation::AssessedMember<T>::AssessedMember(const T& value, const Confidence confidence)
        : confidence(confidence)
        , value(value) {}
 ...
 */
template<class T>
void NetworkInformation::AssessedMember<T>::GetConfidence(Confidence* outConfidence, const char* name) const {
 ...
 */
template<class T>
NetworkInformation::AssessedMember<T>& NetworkInformation::AssessedMember<T>::operator=(const AssessedMember& rhs) {
 ...
 */
template<class A>
int NetworkInformation::findAddress(const UnicastAddressList& list, const A& addr, const int startIdx) {
    ASSERT(startIdx >= 0);
 ...
 */
template<class A>
int NetworkInformation::findSamePrefix(
    const UnicastAddressList& list, const A& addr, const ULONG prefixLen, const int startIdx) {
    ASSERT(startIdx >= 0);
