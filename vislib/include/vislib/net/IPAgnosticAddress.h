...
public:
     ...
     *                         could not be found.
     */
    static IPAgnosticAddress Create(const char* hostNameOrAddress, const AddressFamily inCaseOfDoubt = FAMILY_INET6);
     ...
     *                         could not be found.
     */
    static IPAgnosticAddress Create(const wchar_t* hostNameOrAddress, const AddressFamily inCaseOfDoubt = FAMILY_INET6);
     ...
     */
    IPAgnosticAddress(const BYTE b1, const BYTE b2, const BYTE b3, const BYTE b4);
     ...
     */
    IPAgnosticAddress(const BYTE b1, const BYTE b2, const BYTE b3, const BYTE b4, const BYTE b5, const BYTE b6,
