...
protected:
     ...
     */
    virtual bool forPeer(const PeerIdentifier& peerId, ForeachPeerFunc func, void* context) = 0;
     ...
     */
    virtual bool onMessageReceived(const Socket& src, const UINT msgId, const BYTE* body, const SIZE_T cntBody) = 0;
     ...
     */
    virtual void onMessageReceiverExiting(Socket& socket, PReceiveMessagesCtx rmc);
     ...
     */
    virtual SIZE_T sendMessage(const UINT32 msgId, const BYTE* data, const UINT32 cntData);
     ...
     */
    virtual bool sendMessage(const PeerIdentifier& peerId, const UINT32 msgId, const BYTE* data, const UINT32 cntData);
     ...
     *         not found or a communication error occurred.
     */
    virtual bool sendToPeer(const PeerIdentifier& peerId, const BYTE* data, const SIZE_T cntData);
