...
public:
     ...
     *                         could not be found.
     */
    static void GetHostAddress(IPAddress& outAddress, const char* hostNameOrAddress);
     ...
     *                         could not be found.
     */
    static void GetHostAddress(IPAddress& outAddress, const wchar_t* hostNameOrAddress);
     ...
     *                         could not be found.
     */
    static void GetHostAddress(IPAddress6& outAddress, const char* hostNameOrAddress);
     ...
     *                         could not be found.
     */
    static void GetHostAddress(IPAddress6& outAddress, const wchar_t* hostNameOrAddress);
     ...
     *                         could not be found.
     */
    static void GetHostAddress(IPAgnosticAddress& outAddress, const char* hostNameOrAddress,
        const IPAgnosticAddress::AddressFamily inCaseOfDoubt = IPAgnosticAddress::FAMILY_INET6);
     ...
     *                         could not be found.
     */
    static void GetHostAddress(IPAgnosticAddress& outAddress, const wchar_t* hostNameOrAddress,
        const IPAgnosticAddress::AddressFamily inCaseOfDoubt = IPAgnosticAddress::FAMILY_INET6);
     ...
     *                               IPv4 or IPv6.
     */
    static void GetHostEntry(IPHostEntryA& outEntry, const char* hostNameOrAddress);
     ...
     *                               IPv4 or IPv6.
     */
    static void GetHostEntry(IPHostEntryW& outEntry, const wchar_t* hostNameOrAddress);
     ...
     *                               IPv4 or IPv6.
     */
    static void GetHostEntry(IPHostEntryA& outEntry, const IPAgnosticAddress& address);
     ...
     *                               IPv4 or IPv6.
     */
    static void GetHostEntry(IPHostEntryW& outEntry, const IPAgnosticAddress& address);
     ...
     *                               IPv4 or IPv6.
     */
    static void GetHostEntry(IPHostEntryA& outEntry, const IPAddress& address);
     ...
     *                               IPv4 or IPv6.
     */
    static void GetHostEntry(IPHostEntryW& outEntry, const IPAddress& address);
     ...
     *                               IPv4 or IPv6.
     */
    static void GetHostEntry(IPHostEntryA& outEntry, const IPAddress6& address);
...
private:
     ...
     *                         could not be found.
     */
    static struct addrinfo* getAddrInfo(const char* hostNameOrAddress, const int addressFamily);
    ...
    static ADDRINFOW* getAddrInfo(const wchar_t* hostNameOrAddress, const int addressFamily);
#else  /* (defined(_WIN32) && defined(_WIN32_WINNT) && ... */
    static struct addrinfo* getAddrInfo(const wchar_t* hostNameOrAddress, const int addressFamily);
