...
public:
     ...
     */
    static Array<String<C>> Split(const String<C>& input, const String<C>& separator, bool removeEmpty = false);
     ...
     * @return An array of the separated substrings.
     */
    static Array<String<C>> Split(const String<C>& input, const typename C::Char* separator, bool removeEmpty = false);
     ...
     * @return An array of the separated substrings.
     */
    static Array<String<C>> Split(const typename C::Char* input, const String<C>& separator, bool removeEmpty = false);
     ...
     * @return An array of the separated substrings.
     */
    static Array<String<C>> Split(
        const typename C::Char* input, const typename C::Char* separator, bool removeEmpty = false);
    ...
    inline const String<C>& NextNonEmpty() {
        ...
        throw NoSuchElementException("End of Token Sequence", __FILE__, __LINE__);
    }
     ...
     * @param separator The new separator string. Must not be NULL.
     */
    void Set(const typename C::Char* input, const typename C::Char* separator);
 ...
 */
template<class C>
Array<String<C>> StringTokeniser<C>::Split(const String<C>& input, const String<C>& separator, bool removeEmpty) {
    Array<String<C>> retval;
    StringTokeniser<C>::split(input.PeekBuffer(), separator.PeekBuffer(), removeEmpty, retval);
    return retval;
}
 ...
 */
template<class C>
Array<String<C>> StringTokeniser<C>::Split(
    const String<C>& input, const typename C::Char* separator, bool removeEmpty) {
    Array<String<C>> retval;
    StringTokeniser<C>::split(input.PeekBuffer(), separator, removeEmpty, retval);
    return retval;
}
 ...
 */
template<class C>
Array<String<C>> StringTokeniser<C>::Split(const String<C>& input, const typename C::Char separator, bool removeEmpty) {
    typename C::Char sep[2] = {separator, 0};
    Array<String<C>> retval;
    StringTokeniser<C>::split(input.PeekBuffer(), sep, removeEmpty, retval);
    return retval;
}
...
template<class C>
Array<String<C>> StringTokeniser<C>::Split(
    const typename C::Char* input, const String<C>& separator, bool removeEmpty) {
    Array<String<C>> retval;
    StringTokeniser<C>::split(input, separator.PeekBuffer(), removeEmpty, retval);
    return retval;
}
...
template<class C>
Array<String<C>> StringTokeniser<C>::Split(
    const typename C::Char* input, const typename C::Char* separator, bool removeEmpty) {
    Array<String<C>> retval;
 ...
 */
template<class C>
StringTokeniser<C>::StringTokeniser(const String<C>& input, const String<C>& separator)
        : input(input)
        , separator(separator)
        , inputPos(0) {
    this->Reset();
 ...
 */
template<class C>
StringTokeniser<C>::StringTokeniser(const String<C>& input, const typename C::Char* separator)
        : input(input)
        , separator(separator)
        , inputPos(0) {
    this->Reset();
 ...
 */
template<class C>
StringTokeniser<C>::StringTokeniser(const typename C::Char* input, const String<C>& separator)
        : input(input)
        , separator(separator)
        , inputPos(0) {
    this->Reset();
 ...
 */
template<class C>
StringTokeniser<C>::StringTokeniser(const typename C::Char* input, const typename C::Char* separator)
        : input(input)
        , separator(separator)
        , inputPos(0) {
    this->Reset();
 ...
 */
template<class C>
void StringTokeniser<C>::Set(const String<C>& input) {
    this->input = input;
    this->Reset();
}
 ...
 */
template<class C>
void StringTokeniser<C>::Set(const typename C::Char* input) {
    this->input = input;
    this->Reset();
}
 ...
 */
template<class C>
void StringTokeniser<C>::Set(const String<C>& input, const String<C>& separator) {
    this->input = input;
 ...
 */
template<class C>
void StringTokeniser<C>::Set(const String<C>& input, const typename C::Char* separator) {
    this->input = input;
    this->separator = separator;
    this->Reset();
}
 ...
 */
template<class C>
void StringTokeniser<C>::Set(const typename C::Char* input, const String<C>& separator) {
    this->input = input;
    this->separator = separator;
    this->Reset();
}
 ...
 */
template<class C>
void StringTokeniser<C>::Set(const typename C::Char* input, const typename C::Char* separator) {
    this->input = input;
    this->separator = separator;
    this->Reset();
}
