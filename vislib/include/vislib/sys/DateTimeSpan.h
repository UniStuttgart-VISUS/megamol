...
public:
     ...
     */
    static inline DateTimeSpan OneMillisecond(const bool isPositive = true) {
        return DateTimeSpan(isPositive ? TICKS_PER_MILLISECOND : -TICKS_PER_MILLISECOND);
    }
    ...
    static inline DateTimeSpan OneMinute(const bool isPositive = true) {
        return DateTimeSpan(isPositive ? TICKS_PER_MINUTE : -TICKS_PER_MINUTE);
    }
    ...
    static inline DateTimeSpan OneSecond(const bool isPositive = true) {
        return DateTimeSpan(isPositive ? TICKS_PER_SECOND : -TICKS_PER_SECOND);
    }
     ...
     */
    explicit inline DateTimeSpan(const INT64 ticks = 0L) throw() : ticks(ticks) {}
     ...
     *                               overflow.
     */
    DateTimeSpan(const INT days, const INT hours, const INT minutes, const INT seconds, const INT milliseconds = 0,
        const INT ticks = 0);
     ...
     *                               overflow.
     */
    void Set(const INT days, const INT hours, const INT minutes, const INT seconds, const INT milliseconds = 0,
        const INT ticks = 0);
