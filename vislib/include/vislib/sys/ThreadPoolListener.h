...
public:
     ...
     *                 into the Runnable.
     */
    virtual void OnUserWorkItemAborted(ThreadPool& src, Runnable* runnable, void* userData) throw() = 0;
     ...
     */
    virtual void OnUserWorkItemAborted(ThreadPool& src, Runnable::Function runnable, void* userData) throw() = 0;
     ...
     */
    virtual void OnUserWorkItemCompleted(
        ThreadPool& src, Runnable* runnable, void* userData, const DWORD exitCode) throw() = 0;
     ...
     */
    virtual void OnUserWorkItemCompleted(
        ThreadPool& src, Runnable::Function runnable, void* userData, const DWORD exitCode) throw() = 0;
