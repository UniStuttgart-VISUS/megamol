...
public:
     ...
     * @return The modified path.
     */
    static StringW ChangeExtension(const wchar_t* path, const wchar_t* extension);
     ...
     */
    static StringA Concatenate(const StringA& lhs, const StringA& rhs, const bool canonicalise = false);
     ...
     * @return The concatenated path.
     */
    static StringW Concatenate(const StringW& lhs, const StringW& rhs, const bool canonicalise = false);
