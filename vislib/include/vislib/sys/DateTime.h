...
public:
     ...
     *                               overflows.
     */
    inline static INT64 TimeToTicks(
        const INT hours, const INT minutes, const INT seconds, const INT milliseconds = 0, const INT ticks = 0) {
        return DateTimeSpan::TimeToTicks(hours, minutes, seconds, milliseconds, ticks);
    }
     ...
     */
    DateTime(const INT year, const INT month, const INT day, const INT hours = 0, const INT minutes = 0,
        const INT seconds = 0, const INT milliseconds = 0);
     ...
     */
    inline void Get(INT& outYear, INT& outMonth, INT& outDay, INT& outHours, INT& outMinutes, INT& outSeconds,
     ...
     * @param outSeconds Receives the seconds.
     */
    inline void Get(INT& outYear, INT& outMonth, INT& outDay, INT& outHours, INT& outMinutes, INT& outSeconds) const {
        this->GetDate(outYear, outMonth, outDay);
     ...
     * @param outMilliseconds Receives the milliseconds.
     */
    void GetTime(INT& outHours, INT& outMinutes, INT& outSeconds, INT& outMilliseconds) const;
     ...
     * @param outSeconds Receives the seconds.
     */
    inline void GetTime(INT& outHours, INT& outMinutes, INT& outSeconds) const {
        INT tmp;
     ...
     * @throws TODO should implement overflow check.
     */
    void Set(const INT year, const INT month, const INT day, const INT hours, const INT minutes, const INT seconds,
     ...
     *                     to 0.
     */
    void SetTime(const INT hour, const INT minute, const INT second, const INT milliseconds = 0, const INT ticks = 0);
