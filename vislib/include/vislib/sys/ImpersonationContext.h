...
public:
     ...
     */
    void Impersonate(const char* username, const char* domain, const char* password);
     ...
     * @throws SystemException If the impersonation failed.
     */
    void Impersonate(const wchar_t* username, const wchar_t* domain, const wchar_t* password);
