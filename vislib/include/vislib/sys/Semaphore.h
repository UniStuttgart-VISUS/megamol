...
public:
     ...
     */
    Semaphore(const char* name, long initialCount = 1, long maxCount = 1, bool* outIsNew = NULL);
...
protected:
     ...
     */
    static void enforceParamAssertions(long& inOutInitialCount, long& inOutMaxCount);
