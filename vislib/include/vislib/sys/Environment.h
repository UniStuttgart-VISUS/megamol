...
public:
    ...
    private:
         ...
         */
#ifdef _WIN32
        static const wchar_t* find(const wchar_t* name, const wchar_t* data);
#else  /* _WIN32 */
        static const char* find(const char* name, const char** const data);
#endif /* _WIN32 */
     ...
     */
    static vislib::StringA GetVariable(const char* name, const bool isLenient = false);
     ...
     *                         e. g. because it is not set.
     */
    static vislib::StringW GetVariable(const wchar_t* name, const bool isLenient = false);
     ...
     *                         e. g. because it is not set.
     */
    inline static vislib::StringA GetVariable(const vislib::StringA& name, const bool isLenient = false) {
     ...
     *                         e. g. because it is not set.
     */
    inline static vislib::StringW GetVariable(const vislib::StringW& name, const bool isLenient = false) {
        return Environment::GetVariable(name.PeekBuffer(), isLenient);
    }
     ...
     * @throws SystemException If settings the environment variable failed.
     */
    inline static void SetVariable(const vislib::StringA& name, const vislib::StringA& value) {
     ...
     * @throws SystemException If settings the environment variable failed.
     */
    inline static void SetVariable(const vislib::StringW& name, const vislib::StringW& value) {
        Environment::SetVariable(name.PeekBuffer(), value.PeekBuffer());
    }
