...
public:
     ...
     */
    VISLIB_FORCEINLINE static VL_INT32 CompareExchange(
        volatile VL_INT32* address, const VL_INT32 exchange, const VL_INT32 comparand) {
#ifdef _WIN32
        ASSERT(sizeof(VL_INT32) == sizeof(LONG));
        return ::InterlockedCompareExchange(
            reinterpret_cast<volatile LONG*>(address), static_cast<LONG>(exchange), static_cast<LONG>(comparand));
#else  /* _WIN32 */
        VL_INT32 retval;
     ...
     *                                       operations.
     */
    VISLIB_FORCEINLINE static INT64 CompareExchange(
        volatile INT64* address, const INT64 exchange, const INT64 comparand) {
#ifdef _WIN32
        ASSERT(sizeof(INT64) == sizeof(LONGLONG));
#if (defined(_WIN32_WINNT) && (_WIN32_WINNT >= 0x0502))
        return ::InterlockedCompareExchange64(reinterpret_cast<volatile LONGLONG*>(address),
            static_cast<LONGLONG>(exchange), static_cast<LONGLONG>(comparand));
#else  /* (defined(_WIN32_WINNT) && (_WIN32_WINNT >= 0x0502)) */
        throw UnsupportedOperationException("Interlocked::CompareExchange", __FILE__, __LINE__);
...
#ifdef _WIN32
        ASSERT(sizeof(VL_INT32) == sizeof(LONG));
        return ::InterlockedDecrement(reinterpret_cast<volatile LONG*>(address));
#else  /* _WIN32 */
...
#ifdef _WIN32
#if (defined(_WIN32_WINNT) && (_WIN32_WINNT >= 0x0502))
        return ::InterlockedDecrement64(reinterpret_cast<volatile LONGLONG*>(address));
#else  /* (defined(_WIN32_WINNT) && (_WIN32_WINNT >= 0x0502)) */
        throw UnsupportedOperationException("Interlocked::Decrement", __FILE__, __LINE__);
#endif /* (defined(_WIN32_WINNT) && (_WIN32_WINNT >= 0x0502)) */
#else  /* _WIN32 */
        throw UnsupportedOperationException("Interlocked::Decrement", __FILE__, __LINE__);
#endif /* _WIN32 */
     ...
     */
    VISLIB_FORCEINLINE static VL_INT32 Exchange(volatile VL_INT32* address, const VL_INT32 value) {
#ifdef _WIN32
        ASSERT(sizeof(VL_INT32) == sizeof(LONG));
        return ::InterlockedExchange(reinterpret_cast<volatile LONG*>(address), static_cast<VL_INT32>(value));
#else  /* _WIN32 */
        VL_INT32 old;
        do {
            old = *address;
     ...
     *                                       operations.
     */
    VISLIB_FORCEINLINE static INT64 Exchange(volatile INT64* address, const INT64 value) {
#ifdef _WIN32
        ASSERT(sizeof(INT64) == sizeof(LONGLONG));
#if (defined(_WIN32_WINNT) && (_WIN32_WINNT >= 0x0502))
        return ::InterlockedExchange64(reinterpret_cast<volatile LONGLONG*>(address), static_cast<LONGLONG>(value));
#else  /* (defined(_WIN32_WINNT) && (_WIN32_WINNT >= 0x0502)) */
        throw UnsupportedOperationException("Interlocked::Exchange", __FILE__, __LINE__);
#endif /* (defined(_WIN32_WINNT) && (_WIN32_WINNT >= 0x0502)) */
#else  /* _WIN32 */
        INT64 old;
        do {
     ...
     * @return The old value of the variable designated by 'address'.
     */
    VISLIB_FORCEINLINE static void* Exchange(void** address, const void* value) {
#ifdef _WIN32
#pragma warning(disable : 4311)
#pragma warning(disable : 4312)
        return InterlockedExchangePointer(address, const_cast<void*>(value));
...
#pragma warning(default : 4311)
     ...
     ((__LP64__ != 0) || (_LP64 != 0) || (__x86_64__ != 0)))
        return reinterpret_cast<void*>(
            Interlocked::Exchange(reinterpret_cast<volatile INT64*>(address), reinterpret_cast<INT64>(value)));
#else  /* #if ((defined(__LP64__) || defined(_LP64) || ... */
        return reinterpret_cast<void*>(
            Interlocked::Exchange(reinterpret_cast<volatile VL_INT32*>(address), reinterpret_cast<VL_INT32>(value)));
     ...
     *         operation.
     */
    VISLIB_FORCEINLINE static VL_INT32 ExchangeAdd(volatile VL_INT32* address, const VL_INT32 value) {
#ifdef _WIN32
        ASSERT(sizeof(VL_INT32) == sizeof(LONG));
        return ::InterlockedExchangeAdd(reinterpret_cast<volatile LONG*>(address), static_cast<LONG>(value));
#else  /* _WIN32 */
        VL_INT32 retval;
     ...
     *                                       operations.
     */
    VISLIB_FORCEINLINE static INT64 ExchangeAdd(volatile INT64* address, const INT64 value) {
#ifdef _WIN32
        ASSERT(sizeof(INT64) == sizeof(LONGLONG));
#if (defined(_WIN32_WINNT) && (_WIN32_WINNT >= 0x0502))
        return ::InterlockedExchangeAdd64(reinterpret_cast<volatile LONGLONG*>(address), static_cast<LONGLONG>(value));
#else  /* (defined(_WIN32_WINNT) && (_WIN32_WINNT >= 0x0502)) */
        throw UnsupportedOperationException("Interlocked::ExchangeAdd", __FILE__, __LINE__);
#endif /* (defined(_WIN32_WINNT) && (_WIN32_WINNT >= 0x0502)) */
#else  /* _WIN32 */
        throw UnsupportedOperationException("Interlocked::ExchangeAdd", __FILE__, __LINE__);
#endif /* _WIN32 */
     ...
     *         operation.
     */
    VISLIB_FORCEINLINE static VL_INT32 ExchangeSub(volatile VL_INT32* address, const VL_INT32 value) {
#ifdef _WIN32
        ASSERT(sizeof(VL_INT32) == sizeof(LONG));
        return ::InterlockedExchangeAdd(reinterpret_cast<volatile LONG*>(address), static_cast<LONG>(-value));
#else  /* _WIN32 */
     ...
     *                                       operations.
     */
    VISLIB_FORCEINLINE static INT64 ExchangeSub(volatile INT64* address, const INT64 value) {
#ifdef _WIN32
        return Interlocked::ExchangeAdd(address, -value);
#else  /* _WIN32 */
        return Interlocked::ExchangeAdd(address, -value);
...
#ifdef _WIN32
        ASSERT(sizeof(VL_INT32) == sizeof(LONG));
        return ::InterlockedIncrement(reinterpret_cast<volatile LONG*>(address));
#else  /* _WIN32 */
        return (Interlocked::ExchangeAdd(address, 1) + 1);
#endif /* _WIN32 */
    }
...
#ifdef _WIN32
#if (defined(_WIN32_WINNT) && (_WIN32_WINNT >= 0x0502))
        return ::InterlockedIncrement64(reinterpret_cast<volatile LONGLONG*>(address));
#else  /* (defined(_WIN32_WINNT) && (_WIN32_WINNT >= 0x0502)) */
        throw UnsupportedOperationException("Interlocked::Increment", __FILE__, __LINE__);
#endif /* (defined(_WIN32_WINNT) && (_WIN32_WINNT >= 0x0502)) */
#else  /* _WIN32 */
        return (Interlocked::ExchangeAdd(address, 1) + 1);
#endif /* _WIN32 */
