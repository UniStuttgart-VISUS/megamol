...
public:
     ...
     */
    bool Load(const char* moduleName, bool dontResolveReferences = false, bool alternateSearchPath = false);
     ...
     *                               freed before this call to Load().
     */
    bool Load(const wchar_t* moduleName, bool dontResolveReferences = false, bool alternateSearchPath = false);
