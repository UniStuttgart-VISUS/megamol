...
public:
     ...
     *                            signaled.
     */
    Event(const bool isManualReset = false, const bool isInitiallySignaled = false);
     ...
     *                            (false).
     */
    Event(const char* name, const bool isManualReset = false, const bool isInitiallySignaled = false,
        bool* outIsNew = NULL);
     ...
     *                            (false).
     */
    Event(const wchar_t* name, const bool isManualReset = false, const bool isInitiallySignaled = false,
        bool* outIsNew = NULL);
