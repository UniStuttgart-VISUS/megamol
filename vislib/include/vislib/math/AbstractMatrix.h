...
class AbstractMatrix : public AbstractMatrixImpl<T, D, L, S, AbstractMatrix> {
...
public:
     ...
     */
    unsigned int FindEigenvalues(T* outEigenvalues, Vector<T, D>* outEigenvectors, unsigned int size) const;
    ...
    inline AbstractMatrix& operator=(const AbstractMatrix<Tp, Dp, Lp, Sp>& rhs) {
        Super::operator=(rhs);
        return *this;
    }
...
protected:
    ...
    typedef AbstractMatrixImpl<T, D, L, S, vislib::math::AbstractMatrix> Super;
...
private:
     ...
     */
    template<class S1>
    inline AbstractMatrix(const AbstractMatrixImpl<T, D, L, S1, vislib::math::AbstractMatrix>& rhs) : Super() {
        ::memcpy(this->components, rhs.PeekComponents(), Super::CNT_COMPONENTS * sizeof(T));
    }

    /* Allow instances created by the implementation class. */
    template<class Tf1, unsigned int Df1, MatrixLayout Lf1, class Sf1,
        template<class Tf2, unsigned int Df2, MatrixLayout Lf2, class Sf2> class Cf>
...
unsigned int AbstractMatrix<T, D, L, S>::FindEigenvalues(
    T* outEigenvalues, Vector<T, D>* outEigenvectors, unsigned int size) const {
    if (this->IsSymmetric()) {
        return this->findEigenvaluesSym(outEigenvalues, outEigenvectors, size);
    }
    if (outEigenvectors == NULL) {
        return this->CharacteristicPolynom().FindRoots(outEigenvalues, size);
    }

    // TODO: Implement something better

    throw vislib::UnsupportedOperationException("FindEigenvalues", __FILE__, __LINE__);
...
#define A(r, c) a[(r)*D + (c)]
     ...
     * for Gauß elimination.
     */
    for (unsigned int r = 0; r < D; r++) {
        for (unsigned int c = 0; c < D; c++) {
            A(r, c) = static_cast<double>(this->components[Super::indexOf(r, c)]);
        }
    }
...
class AbstractMatrix<T, 2, L, S> : public AbstractMatrixImpl<T, 2, L, S, AbstractMatrix> {
...
public:
    ...
    inline Polynom<T, 2> CharacteristicPolynom(void) const {
        ...
        rv[1] = -(this->components[Super::indexOf(0, 0)] + this->components[Super::indexOf(1, 1)]);
     ...
     * @return The number of results written to the output arrays.
     */
    unsigned int FindEigenvalues(T* outEigenvalues, Vector<T, 2>* outEigenvectors, unsigned int size) const;
...
protected:
    /** A typedef for the super class. */
    typedef AbstractMatrixImpl<T, 2, L, S, vislib::math::AbstractMatrix> Super;
     ...
     */
    template<class S1>
    inline AbstractMatrix(const AbstractMatrixImpl<T, 2, L, S1, vislib::math::AbstractMatrix>& rhs) : Super() {
        ::memcpy(this->components, rhs.PeekComponents(), Super::CNT_COMPONENTS * sizeof(T));
    }
...
unsigned int AbstractMatrix<T, 2, L, S>::FindEigenvalues(
    T* outEigenvalues, Vector<T, 2>* outEigenvectors, unsigned int size) const {
    ...
    if (evc == 0)
        return 0; // no eigenvalues
    if (evc == 1)
        ev[1] = ev[0];

    if (IsEqual(this->components[Super::indexof(1, 0)], static_cast<T>(0))) {
        if (IsEqual(this->components[Super::indexof(0, 1)], static_cast<T>(0))) {
 ...
 */
template<class T, MatrixLayout L, class S>
class AbstractMatrix<T, 3, L, S> : public AbstractMatrixImpl<T, 3, L, S, AbstractMatrix> {
...
public:
    ...
    inline Polynom<T, 3> CharacteristicPolynom(void) const {
        ...
        p[1] = -(Super::determinant2x2(this->components[Super::indexOf(1, 1)], this->components[Super::indexOf(2, 1)],
                     this->components[Super::indexOf(1, 2)], this->components[Super::indexOf(2, 2)]) +
                 Super::determinant2x2(this->components[Super::indexOf(0, 0)], this->components[Super::indexOf(2, 0)],
                     this->components[Super::indexOf(0, 2)], this->components[Super::indexOf(2, 2)]) +
                 Super::determinant2x2(this->components[Super::indexOf(0, 0)], this->components[Super::indexOf(1, 0)],
                     this->components[Super::indexOf(0, 1)], this->components[Super::indexOf(1, 1)]));
        p[2] = this->Trace();
        p[3] = static_cast<T>(-1);
        return p;
    ...
    inline T Determinant(void) const {
        return Super::determinant3x3(this->components[Super::indexOf(0, 0)], this->components[Super::indexOf(1, 0)],
            ...
            this->components[Super::indexOf(0, 2)], this->components[Super::indexOf(1, 2)],
     ...
     * @return The number of results written to the output arrays.
     */
    unsigned int FindEigenvalues(T* outEigenvalues, Vector<T, 3>* outEigenvectors, unsigned int size) const;
...
protected:
    /** A typedef for the super class. */
    typedef AbstractMatrixImpl<T, 3, L, S, vislib::math::AbstractMatrix> Super;
     ...
     */
    template<class S1>
    inline AbstractMatrix(const AbstractMatrixImpl<T, 3, L, S1, vislib::math::AbstractMatrix>& rhs) : Super() {
        ::memcpy(this->components, rhs.PeekComponents(), Super::CNT_COMPONENTS * sizeof(T));
    }
...
unsigned int AbstractMatrix<T, 3, L, S>::FindEigenvalues(
    T* outEigenvalues, Vector<T, 3>* outEigenvectors, unsigned int size) const {
    if (this->IsSymmetric()) {
        return this->findEigenvaluesSym(outEigenvalues, outEigenvectors, size);
    }
    if (outEigenvectors == NULL) {
...
bool AbstractMatrix<T, 3, L, S>::IsRotation(void) const {
    return IsEqual(Super::determinant3x3(this->components[Super::indexOf(0, 0)], this->components[Super::indexOf(1, 0)],
                       ...
                       this->components[Super::indexOf(2, 2)]),
               static_cast<T>(1)) &&
           IsEqual((this->components[Super::indexOf(0, 0)] * this->components[Super::indexOf(0, 0)]) +
                       (this->components[Super::indexOf(1, 0)] * this->components[Super::indexOf(1, 0)]) +
                       (this->components[Super::indexOf(2, 0)] * this->components[Super::indexOf(2, 0)]),
               static_cast<T>(1)) &&
           IsEqual((this->components[Super::indexOf(0, 0)] * this->components[Super::indexOf(0, 1)]) +
                       (this->components[Super::indexOf(1, 0)] * this->components[Super::indexOf(1, 1)]) +
                       (this->components[Super::indexOf(2, 0)] * this->components[Super::indexOf(2, 1)]),
               static_cast<T>(0)) &&
           IsEqual((this->components[Super::indexOf(0, 0)] * this->components[Super::indexOf(0, 2)]) +
                       (this->components[Super::indexOf(1, 0)] * this->components[Super::indexOf(1, 2)]) +
                       (this->components[Super::indexOf(2, 0)] * this->components[Super::indexOf(2, 2)]),
               static_cast<T>(0)) &&
           IsEqual((this->components[Super::indexOf(0, 1)] * this->components[Super::indexOf(0, 0)]) +
                       (this->components[Super::indexOf(1, 1)] * this->components[Super::indexOf(1, 0)]) +
                       (this->components[Super::indexOf(2, 1)] * this->components[Super::indexOf(2, 0)]),
               static_cast<T>(0)) &&
           IsEqual((this->components[Super::indexOf(0, 1)] * this->components[Super::indexOf(0, 1)]) +
                       (this->components[Super::indexOf(1, 1)] * this->components[Super::indexOf(1, 1)]) +
                       (this->components[Super::indexOf(2, 1)] * this->components[Super::indexOf(2, 1)]),
               static_cast<T>(1)) &&
           IsEqual((this->components[Super::indexOf(0, 1)] * this->components[Super::indexOf(0, 2)]) +
                       (this->components[Super::indexOf(1, 1)] * this->components[Super::indexOf(1, 2)]) +
                       (this->components[Super::indexOf(2, 1)] * this->components[Super::indexOf(2, 2)]),
               static_cast<T>(0)) &&
           IsEqual((this->components[Super::indexOf(0, 2)] * this->components[Super::indexOf(0, 0)]) +
                       (this->components[Super::indexOf(1, 2)] * this->components[Super::indexOf(1, 0)]) +
                       (this->components[Super::indexOf(2, 2)] * this->components[Super::indexOf(2, 0)]),
               static_cast<T>(0)) &&
           IsEqual((this->components[Super::indexOf(0, 2)] * this->components[Super::indexOf(0, 1)]) +
                       (this->components[Super::indexOf(1, 2)] * this->components[Super::indexOf(1, 1)]) +
                       (this->components[Super::indexOf(2, 2)] * this->components[Super::indexOf(2, 1)]),
               static_cast<T>(0)) &&
           IsEqual((this->components[Super::indexOf(0, 2)] * this->components[Super::indexOf(0, 2)]) +
                       (this->components[Super::indexOf(1, 2)] * this->components[Super::indexOf(1, 2)]) +
                       (this->components[Super::indexOf(2, 2)] * this->components[Super::indexOf(2, 2)]),
               static_cast<T>(1));
}
...
template<class T, MatrixLayout L, class S>
template<class Tp, class Sp>
AbstractMatrix<T, 3, L, S>& AbstractMatrix<T, 3, L, S>::operator=(const AbstractQuaternion<Tp, Sp>& rhs) {
    Quaternion<T> q(rhs);
    q.Normalise();

    this->components[Super::indexOf(0, 0)] = Sqr(q.W()) + Sqr(q.X()) - Sqr(q.Y()) - Sqr(q.Z());
    this->components[Super::indexOf(0, 1)] = static_cast<T>(2) * (q.X() * q.Y() - q.W() * q.Z());
    this->components[Super::indexOf(0, 2)] = static_cast<T>(2) * (q.W() * q.Y() + q.X() * q.Z());

    this->components[Super::indexOf(1, 0)] = static_cast<T>(2) * (q.W() * q.Z() + q.X() * q.Y());
    this->components[Super::indexOf(1, 1)] = Sqr(q.W()) - Sqr(q.X()) + Sqr(q.Y()) - Sqr(q.Z());
    this->components[Super::indexOf(1, 2)] = static_cast<T>(2) * (q.Y() * q.Z() - q.W() * q.X());

    this->components[Super::indexOf(2, 0)] = static_cast<T>(2) * (q.X() * q.Z() - q.W() * q.Y());
    this->components[Super::indexOf(2, 1)] = static_cast<T>(2) * (q.W() * q.X() + q.Y() * q.Z());
    this->components[Super::indexOf(2, 2)] = Sqr(q.W()) - Sqr(q.X()) - Sqr(q.Y()) + Sqr(q.Z());
...
AbstractMatrix<T, 3, L, S>::operator Quaternion<T>(void) const {
    ...
    try {
        q.SetFromRotationMatrix(this->components[Super::indexOf(0, 0)], this->components[Super::indexOf(0, 1)],
            this->components[Super::indexOf(0, 2)], this->components[Super::indexOf(1, 0)],
            this->components[Super::indexOf(1, 1)], this->components[Super::indexOf(1, 2)],
            this->components[Super::indexOf(2, 0)], this->components[Super::indexOf(2, 1)],
            this->components[Super::indexOf(2, 2)]);
    } catch (...) {
 ...
 */
template<class T, MatrixLayout L, class S>
class AbstractMatrix<T, 4, L, S> : public AbstractMatrixImpl<T, 4, L, S, AbstractMatrix> {
...
public:
    ...
    inline T Determinant(void) const {
        return Super::determinant4x4(this->components[Super::indexOf(0, 0)], this->components[Super::indexOf(1, 0)],
            ...
            this->components[Super::indexOf(0, 1)], this->components[Super::indexOf(1, 1)],
            this->components[Super::indexOf(2, 1)], this->components[Super::indexOf(3, 1)],
            this->components[Super::indexOf(0, 2)], this->components[Super::indexOf(1, 2)],
            this->components[Super::indexOf(2, 2)], this->components[Super::indexOf(3, 2)],
            this->components[Super::indexOf(0, 3)], this->components[Super::indexOf(1, 3)],
            this->components[Super::indexOf(2, 3)], this->components[Super::indexOf(3, 3)]);
    }
     ...
     * @return The number of results written to the output arrays.
     */
    unsigned int FindEigenvalues(T* outEigenvalues, Vector<T, 4>* outEigenvectors, unsigned int size) const;
...
protected:
    /** A typedef for the super class. */
    typedef AbstractMatrixImpl<T, 4, L, S, vislib::math::AbstractMatrix> Super;
     ...
     */
    template<class S1>
    inline AbstractMatrix(const AbstractMatrixImpl<T, 4, L, S1, vislib::math::AbstractMatrix>& rhs) : Super() {
        ::memcpy(this->components, rhs.PeekComponents(), Super::CNT_COMPONENTS * sizeof(T));
    }
...
unsigned int AbstractMatrix<T, 4, L, S>::FindEigenvalues(
    T* outEigenvalues, Vector<T, 4>* outEigenvectors, unsigned int size) const {
    if (this->IsSymmetric()) {
        return this->findEigenvaluesSym(outEigenvalues, outEigenvectors, size);
    }
    if (outEigenvectors == NULL) {
...
bool AbstractMatrix<T, 4, L, S>::IsRotation(void) const {
    return IsEqual(Super::determinant3x3(this->components[Super::indexOf(0, 0)], this->components[Super::indexOf(1, 0)],
           ...
           IsEqual((this->components[Super::indexOf(0, 2)] * this->components[Super::indexOf(0, 2)]) +
                       ...
                       (this->components[Super::indexOf(2, 2)] * this->components[Super::indexOf(2, 2)]),
               static_cast<T>(1)) &&
           IsEqual(this->components[Super::indexOf(3, 0)], static_cast<T>(0)) &&
           IsEqual(this->components[Super::indexOf(3, 1)], static_cast<T>(0)) &&
           IsEqual(this->components[Super::indexOf(3, 2)], static_cast<T>(0)) &&
           IsEqual(this->components[Super::indexOf(3, 3)], static_cast<T>(1)) &&
           IsEqual(this->components[Super::indexOf(2, 3)], static_cast<T>(0)) &&
           IsEqual(this->components[Super::indexOf(1, 3)], static_cast<T>(0)) &&
           IsEqual(this->components[Super::indexOf(0, 3)], static_cast<T>(0));
}
...
template<class T, MatrixLayout L, class S>
template<class Tp, class Sp>
AbstractMatrix<T, 4, L, S>& AbstractMatrix<T, 4, L, S>::operator=(const AbstractQuaternion<Tp, Sp>& rhs) {
    Quaternion<T> q(rhs);
    q.Normalise();
