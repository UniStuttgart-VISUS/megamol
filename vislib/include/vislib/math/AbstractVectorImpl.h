...
template<class T, unsigned int D, class S, template<class Tc, unsigned int Dc, class Sc> class C>
template<class Tp, class Sp>
bool AbstractVectorImpl<T, D, S, C>::IsParallel(const C<Tp, D, Sp>& rhs) const {
...
#undef max
#endif /* _MSC_VER */
    T retval = std::numeric_limits<T>::is_integer ? std::numeric_limits<T>::min() : -std::numeric_limits<T>::max();
#ifdef _MSC_VER
 ...
 */
template<class T, unsigned int D, class S, template<class Tc, unsigned int Dc, class Sc> class C>
AbstractVectorImpl<T, D, S, C>& AbstractVectorImpl<T, D, S, C>::operator=(const C<T, D, S>& rhs) {
...
template<class T, unsigned int D, class S, template<class Tc, unsigned int Dc, class Sc> class C>
template<class Tp, unsigned int Dp, class Sp>
AbstractVectorImpl<T, D, S, C>& AbstractVectorImpl<T, D, S, C>::operator=(const C<Tp, Dp, Sp>& rhs) {
...
template<class T, unsigned int D, class S, template<class Tc, unsigned int Dc, class Sc> class C>
template<class Tp, class Sp>
C<T, D, T[D]> AbstractVectorImpl<T, D, S, C>::operator+(const C<Tp, D, Sp>& rhs) const {
    C<T, D, T[D]> retval;
...
template<class T, unsigned int D, class S, template<class Tc, unsigned int Dc, class Sc> class C>
template<class Tp, class Sp>
AbstractVectorImpl<T, D, S, C>& AbstractVectorImpl<T, D, S, C>::operator+=(const C<Tp, D, Sp>& rhs) {
 ...
 */
template<class T, unsigned int D, class S, template<class Tc, unsigned int Dc, class Sc> class C>
C<T, D, T[D]> AbstractVectorImpl<T, D, S, C>::operator*(const T rhs) const {
    C<T, D, T[D]> retval;
 ...
 */
template<class T, unsigned int D, class S, template<class Tc, unsigned int Dc, class Sc> class C>
AbstractVectorImpl<T, D, S, C>& AbstractVectorImpl<T, D, S, C>::operator*=(const T rhs) {
