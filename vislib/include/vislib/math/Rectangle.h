 ...
 */
template<class T>
class Rectangle : public AbstractRectangle<T, T[4]> {
...
public:
     ...
     */
    inline Rectangle(const T& left, const T& bottom, const T& right, const T& top) {
    ...
    inline Rectangle(const AbstractPoint<Tp1, 2, Sp1>& origin, const AbstractDimension<Tp2, 2, Sp2>& size) {
 ...
 */
template<class T>
const Rectangle<T> Rectangle<T>::EMPTY(0, 0, 0, 0);
