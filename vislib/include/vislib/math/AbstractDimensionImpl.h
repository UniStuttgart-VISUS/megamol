...
void AbstractDimensionImpl<T, D, S, C>::Scale(const double factor) {
    for (unsigned int d = 0; d < D; d++) {
        this->dimension[d] = static_cast<T>(factor * static_cast<double>(this->dimension[d]));
    }
}
 ...
 */
template<class T, unsigned int D, class S, template<class Tc, unsigned int Dc, class Sc> class C>
AbstractDimensionImpl<T, D, S, C>& AbstractDimensionImpl<T, D, S, C>::operator=(const C<T, D, S>& rhs) {
...
template<class T, unsigned int D, class S, template<class Tc, unsigned int Dc, class Sc> class C>
template<class Tp, unsigned int Dp, class Sp>
AbstractDimensionImpl<T, D, S, C>& AbstractDimensionImpl<T, D, S, C>::operator=(const C<Tp, Dp, Sp>& rhs) {
 ...
 */
template<class T, unsigned int D, class S, template<class Tc, unsigned int Dc, class Sc> class C>
bool AbstractDimensionImpl<T, D, S, C>::operator==(const C<T, D, S>& rhs) const {
    for (unsigned int d = 0; d < D; d++) {
...
template<class T, unsigned int D, class S, template<class Tc, unsigned int Dc, class Sc> class C>
template<class Tp, unsigned int Dp, class Sp>
bool AbstractDimensionImpl<T, D, S, C>::operator==(const C<Tp, Dp, Sp>& rhs) const {
    if (D != Dp) {
        /* Cannot be equal. */
        return false;
    }
