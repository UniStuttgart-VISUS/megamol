...
public:
     ...
     */
    VLDEPRECATED
    Matrix4(const T& m11, const T& m12, const T& m13, const T& m14, const T& m21, const T& m22, const T& m23,
    ...
    VLDEPRECATED inline Matrix4(const AbstractMatrix<Tp, Dp, Lp, Sp>& rhs) : Super(rhs) {}
    ...
    VLDEPRECATED explicit inline Matrix4(const AbstractQuaternion<Tp, Sp>& rhs) {
 ...
 */
template<class T, MatrixLayout L>
Matrix4<T, L>::Matrix4(const T& m11, const T& m12, const T& m13, const T& m14, const T& m21, const T& m22, const T& m23,
    const T& m24, const T& m31, const T& m32, const T& m33, const T& m34, const T& m41, const T& m42, const T& m43,
    const T& m44)
        : Super() {
