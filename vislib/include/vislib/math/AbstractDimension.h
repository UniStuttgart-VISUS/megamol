...
class AbstractDimension : public AbstractDimensionImpl<T, D, S, AbstractDimension> {
...
public:
    ...
    inline AbstractDimension& operator=(const AbstractDimension<Tp, Dp, Sp>& rhs) {
        Super::operator=(rhs);
        return *this;
    }
...
protected:
    ...
    typedef AbstractDimensionImpl<T, D, S, vislib::math::AbstractDimension> Super;
...
class AbstractDimension<T, 2, S> : public AbstractDimensionImpl<T, 2, S, AbstractDimension> {
...
protected:
    /** Typedef of super class. */
    typedef AbstractDimensionImpl<T, 2, S, vislib::math::AbstractDimension> Super;
 ...
 */
template<class T, class S>
class AbstractDimension<T, 3, S> : public AbstractDimensionImpl<T, 3, S, AbstractDimension> {
...
protected:
    /** Typedef of super class. */
    typedef AbstractDimensionImpl<T, 3, S, vislib::math::AbstractDimension> Super;
