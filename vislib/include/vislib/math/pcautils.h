 ...
 */
template<class T, unsigned int D, MatrixLayout L, class S, class L2, class C, class T2>
inline void CalcCovarianceMatrix(AbstractMatrix<T, D, L, S>& outMatrix, const Array<T2, L2, C>& relCoords) {
    CalcCovarianceMatrix(outMatrix, relCoords.PeekElements(), relCoords.Count());
}
...
void CalcCovarianceMatrix(
    AbstractMatrix<T, D, L, S1>& outMatrix, const AbstractVector<T, D, S2>* relCoords, SIZE_T relCoordsCnt) {
