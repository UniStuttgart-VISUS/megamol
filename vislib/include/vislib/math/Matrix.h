...
public:
    ...
    inline Matrix(const T* components) : Super() {
        ...
        ::memcpy(this->components, components, Super::CNT_COMPONENTS * sizeof(T));
    }
    ...
    inline Matrix(const Matrix& rhs) : Super() {
        ::memcpy(this->components, rhs.component, Super::CNT_COMPONENTS * sizeof(T));
    }
...
public:
     ...
     */
    inline Matrix(const Matrix& rhs) : Super() {
        ::memcpy(this->components, rhs.components, Super::CNT_COMPONENTS * sizeof(T));
    }
     ...
     */
    inline Matrix(const T& m11, const T& m12, const T& m13, const T& m21, const T& m22, const T& m23, const T& m31,
    ...
    explicit inline Matrix(const AbstractQuaternion<Tp, Sp>& rhs) : Super() {
        *this = rhs;
    }
...
public:
     ...
     */
    Matrix(const T& m11, const T& m12, const T& m13, const T& m14, const T& m21, const T& m22, const T& m23,
        const T& m24, const T& m31, const T& m32, const T& m33, const T& m34, const T& m41, const T& m42, const T& m43,
        const T& m44)
            : Super() {
        this->components[Super::indexOf(0, 0)] = m11;
        this->components[Super::indexOf(0, 1)] = m12;
