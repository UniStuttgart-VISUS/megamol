...
public:
     ...
     */
    ForceDirected(Array<TI>& inputData, ResultType& out, unsigned int maximumIterations, float step, float attraction,
        float repulsion, float maximumEnergy, float damping)
            : inData(inputData)
            , outData(out) {
