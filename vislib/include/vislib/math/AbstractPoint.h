...
class AbstractPoint : public AbstractPointImpl<T, D, S, AbstractPoint> {
...
public:
    ...
    inline AbstractPoint& operator=(const AbstractPoint<Tp, Dp, Sp>& rhs) {
        Super::operator=(rhs);
        return *this;
    }
...
class AbstractPoint<T, 2, S> : public AbstractPointImpl<T, 2, S, AbstractPoint> {
 ...
 */
template<class T, class S>
class AbstractPoint<T, 3, S> : public AbstractPointImpl<T, 3, S, AbstractPoint> {
 ...
 */
template<class T, class S>
class AbstractPoint<T, 4, S> : public AbstractPointImpl<T, 4, S, AbstractPoint> {
