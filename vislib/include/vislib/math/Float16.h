...
public:
     ...
     *                owner of the memory.
     */
    static void FromFloat32(UINT16* outHalf, SIZE_T cnt, const float* flt);
     ...
     */
    static void ToFloat32(float* outFloat, const SIZE_T cnt, const UINT16* half);
     ...
     * @param value The initial value of the half float.
     */
    inline Float16(const double value) : value(Float16::FromFloat32(static_cast<float>(value))) {}
     ...
     * @param value The initial value of the half float.
     */
    inline Float16(const BYTE value) : value(Float16::FromFloat32(static_cast<float>(value))) {}
     ...
     * @param value The initial value of the half float.
     */
    inline Float16(const SHORT value) : value(Float16::FromFloat32(static_cast<float>(value))) {}
     ...
     * @param value The initial value of the half float.
     */
    inline Float16(const VL_INT32 value) : value(Float16::FromFloat32(static_cast<float>(value))) {}
     ...
     * @param value The initial value of the half float.
     */
    inline Float16(const INT64 value) : value(Float16::FromFloat32(static_cast<float>(value))) {}
