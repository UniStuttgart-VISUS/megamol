...
public:
    ...
    inline unsigned int FindRoots(T* outRoots, unsigned int size) const {
        ...
        case 0:
            return 0;
        case 1:
            return this->findRootsDeg1(this->coefficients[0], this->coefficients[1], outRoots, size);
        case 2:
            return this->findRootsDeg2(
                this->coefficients[0], this->coefficients[1], this->coefficients[2], outRoots, size);
        case 3:
            return this->findRootsDeg3(this->coefficients[0], this->coefficients[1], this->coefficients[2],
                this->coefficients[3], outRoots, size);
        case 4:
            return this->findRootsDeg4(this->coefficients[0], this->coefficients[1], this->coefficients[2],
    ...
    inline AbstractPolynom<T, D, S>& operator=(const AbstractPolynom<Tp, Dp, Sp>& rhs) {
        Super::operator=(rhs);
        return *this;
    }
...
public:
    ...
    inline unsigned int FindRoots(T* outRoots, unsigned int size) const {
        ...
        if (IsEqual(this->coefficients[1], static_cast<T>(0)))
            return 0;
        return findRootsDeg1(this->coefficients[0], this->coefficients[1], outRoots, size);
    }
     ...
     */
    template<class Tp, unsigned int Dp, class Sp>
    inline AbstractPolynom<T, 1, S>& operator=(const AbstractPolynom<Tp, Dp, Sp>& rhs) {
        Super::operator=(rhs);
        return *this;
    }
...
public:
    ...
    inline unsigned int FindRoots(T* outRoots, unsigned int size) const {
        ...
        return findRootsDeg2(this->coefficients[0], this->coefficients[1], this->coefficients[2], outRoots, size);
    }
     ...
     */
    template<class Tp, unsigned int Dp, class Sp>
    inline AbstractPolynom<T, 2, S>& operator=(const AbstractPolynom<Tp, Dp, Sp>& rhs) {
        Super::operator=(rhs);
        return *this;
    }
...
public:
    ...
    inline unsigned int FindRoots(T* outRoots, unsigned int size) const {
        ...
        return this->findRootsDeg3(
            this->coefficients[0], this->coefficients[1], this->coefficients[2], this->coefficients[3], outRoots, size);
    }
     ...
     * @return The number of valid roots in the out parameter.
     */
    inline unsigned int FindRoots(T& outRoot1, T& outRoot2, T& outRoot3) const {
        T r[3];
     ...
     */
    template<class Tp, unsigned int Dp, class Sp>
    inline AbstractPolynom<T, 3, S>& operator=(const AbstractPolynom<Tp, Dp, Sp>& rhs) {
        Super::operator=(rhs);
        return *this;
    }
...
public:
     ...
     * @return The number of valid roots in the out parameter.
     */
    inline unsigned int FindRoots(T& outRoot1, T& outRoot2, T& outRoot3, T& outRoot4) const {
        T r[4];
     ...
     */
    template<class Tp, unsigned int Dp, class Sp>
    inline AbstractPolynom<T, 4, S>& operator=(const AbstractPolynom<Tp, Dp, Sp>& rhs) {
        Super::operator=(rhs);
        return *this;
    }
