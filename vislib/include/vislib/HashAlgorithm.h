...
public:
     ...
     */
    bool ComputeHash(BYTE* outHash, SIZE_T& inOutSize, const BYTE* input, const SIZE_T cntInput);
     ...
     *         size of 'outHash' in the latter case.
     */
    bool ComputeHash(BYTE* outHash, SIZE_T& inOutSize, const char* input);
     ...
     *         size of 'outHash' in the latter case.
     */
    bool ComputeHash(BYTE* outHash, SIZE_T& inOutSize, const wchar_t* input);
     ...
     * @param cntInput The number of bytes in 'input'.
     */
    virtual void TransformBlock(const BYTE* input, const SIZE_T cntInput) = 0;
     ...
     * @param cntInput  The number of bytes in 'input'.
     */
    virtual bool TransformFinalBlock(BYTE* outHash, SIZE_T& inOutSize, const BYTE* input, const SIZE_T cntInput) = 0;
