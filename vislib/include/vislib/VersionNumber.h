...
public:
     ...
     */
    VersionNumber(VersionInt majorNumber = 0, VersionInt minorNumber = 0, VersionRev revisionNumber = 0);
     ...
     * @param revisionNumber The revision number.
     */
    inline void Set(VersionInt majorNumber, VersionInt minorNumber = 0, VersionRev revisionNumber = 0) {
    ...
    inline bool operator==(const VersionNumber& rhs) const {
        return (this->majorNumber == rhs.majorNumber) && (this->minorNumber == rhs.minorNumber) &&
        ...
        return ((this->majorNumber < rhs.majorNumber) ||
                ((this->majorNumber == rhs.majorNumber) &&
                    ((this->minorNumber < rhs.minorNumber) ||
                        ((this->minorNumber == rhs.minorNumber) && (this->revisionNumber < rhs.revisionNumber)))));
    }
