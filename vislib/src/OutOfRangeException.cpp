 ...
 */
vislib::OutOfRangeException::OutOfRangeException(
    const int val, const int minVal, const int maxVal, const char* file, const int line)
        : Exception(file, line) {
 ...
 * vislib::OutOfRangeException::OutOfRangeException
 */
vislib::OutOfRangeException::OutOfRangeException(const OutOfRangeException& rhs) : Exception(rhs) {}
 ...
 */
vislib::OutOfRangeException& vislib::OutOfRangeException::operator=(const OutOfRangeException& rhs) {
