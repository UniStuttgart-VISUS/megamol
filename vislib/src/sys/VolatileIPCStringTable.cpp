 ...
 */
vislib::sys::VolatileIPCStringTable::EntryImplementation::EntryImplementation(const char* name)
#ifdef _WIN32
        : name(A2W(name))
        , key(NULL) {
    // intentionally empty
 ...
 *     ::EntryImplementation::EntryImplementation
 */
vislib::sys::VolatileIPCStringTable::EntryImplementation::EntryImplementation(const wchar_t* name)
#ifdef _WIN32
        : name(name)
        , key(NULL) {
    // intentionally empty
 ...
 *     ::EntryImplementation::~EntryImplementation
 */
vislib::sys::VolatileIPCStringTable::EntryImplementation::~EntryImplementation(void) {
#ifdef _WIN32
    if (this->key != NULL) {
...
void vislib::sys::VolatileIPCStringTable::EntryImplementation::Create(void) {
    ...
    keyname.Append(this->name);
    DWORD disposition;
    LONG errorVal = RegCreateKeyExW(
        VIPCST_ROOT_KEY, keyname, 0, NULL, REG_OPTION_VOLATILE, KEY_ALL_ACCESS, NULL, &this->key, &disposition);
 ...
 */
void vislib::sys::VolatileIPCStringTable::EntryImplementation::SetValue(const char* value) {
#ifdef _WIN32
    // TODO: Implement
 ...
 * vislib::sys::VolatileIPCStringTable::EntryImplementation::SetValue
 */
void vislib::sys::VolatileIPCStringTable::EntryImplementation::SetValue(const wchar_t* value) {
#ifdef _WIN32
    // TODO: Implement
    throw MissingImplementationException("EntryImplementation::SetValue", __FILE__, __LINE__);
#else  /* _WIN32 */
 ...
 */
void vislib::sys::VolatileIPCStringTable::EntryImplementation::GetName(StringA& outName) const {
#ifdef _WIN32
 ...
 * vislib::sys::VolatileIPCStringTable::EntryImplementation::GetName
 */
void vislib::sys::VolatileIPCStringTable::EntryImplementation::GetName(StringW& outName) const {
#ifdef _WIN32
    outName = this->name;
#else  /* _WIN32 */
 ...
 */
vislib::sys::VolatileIPCStringTable::Entry::Entry(const vislib::sys::VolatileIPCStringTable::Entry& rhs)
        : impl(rhs.impl) {
    // intentionally empty
}
 ...
 */
void vislib::sys::VolatileIPCStringTable::Entry::SetValue(const char* value) {
 ...
 * vislib::sys::VolatileIPCStringTable::Entry::SetValue
 */
void vislib::sys::VolatileIPCStringTable::Entry::SetValue(const wchar_t* value) {
    ASSERT(this->impl.IsNull() == false);
    this->impl->SetValue(value);
}
 ...
 */
vislib::sys::VolatileIPCStringTable::Entry& vislib::sys::VolatileIPCStringTable::Entry::operator=(
 ...
 * vislib::sys::VolatileIPCStringTable::Entry::operator==
 */
bool vislib::sys::VolatileIPCStringTable::Entry::operator==(const vislib::sys::VolatileIPCStringTable::Entry& rhs) {
 ...
 */
vislib::StringA vislib::sys::VolatileIPCStringTable::GetValue(const char* name) {
    // TODO: Implement
 ...
 * vislib::sys::VolatileIPCStringTable::GetValue
 */
vislib::StringW vislib::sys::VolatileIPCStringTable::GetValue(const wchar_t* name) {
    // TODO: Implement
    throw MissingImplementationException("GetValue", __FILE__, __LINE__);
}
 ...
 */
vislib::sys::VolatileIPCStringTable::Entry vislib::sys::VolatileIPCStringTable::Create(
...
vislib::sys::VolatileIPCStringTable::VolatileIPCStringTable(void) {
    throw UnsupportedOperationException("VolatileIPCStringTable::Ctor", __FILE__, __LINE__);
}
