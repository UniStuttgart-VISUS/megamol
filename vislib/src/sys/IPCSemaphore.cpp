 ...
 */
vislib::sys::IPCSemaphore::IPCSemaphore(const char name, const long initialCount, const long maxCount) {
#ifdef _WIN32
...
vislib::sys::IPCSemaphore::IPCSemaphore(const IPCSemaphore& rhs) {
    throw UnsupportedOperationException("IPCSemaphore::IPCSemaphore", __FILE__, __LINE__);
}
 ...
 */
vislib::sys::IPCSemaphore& vislib::sys::IPCSemaphore::operator=(const IPCSemaphore& rhs) {
    if (this != &rhs) {
 ...
 */
void vislib::sys::IPCSemaphore::init(const char* name, const long initialCount, const long maxCount) {
