...
vislib::StringA vislib::sys::KeyCode::ToStringA() const {
    ...
    if (this->IsSpecial()) {
        ...
        case vislib::sys::KeyCode::KEY_ENTER:
            msg += "Enter";
            break;
        case vislib::sys::KeyCode::KEY_ESC:
            msg += "ESC";
            break;
        case vislib::sys::KeyCode::KEY_TAB:
            msg += "Tab";
            break;
        case vislib::sys::KeyCode::KEY_LEFT:
            msg += "Left";
            break;
        case vislib::sys::KeyCode::KEY_RIGHT:
            msg += "Right";
            break;
        case vislib::sys::KeyCode::KEY_UP:
            msg += "Up";
            break;
        case vislib::sys::KeyCode::KEY_DOWN:
            msg += "Down";
            break;
        case vislib::sys::KeyCode::KEY_PAGE_UP:
            msg += "Page Up";
            break;
        case vislib::sys::KeyCode::KEY_PAGE_DOWN:
            msg += "Page Down";
            break;
        case vislib::sys::KeyCode::KEY_HOME:
            msg += "Home";
            break;
        case vislib::sys::KeyCode::KEY_END:
            msg += "End";
            break;
        case vislib::sys::KeyCode::KEY_INSERT:
            msg += "Insert";
            break;
        case vislib::sys::KeyCode::KEY_DELETE:
            msg += "Delete";
            break;
        case vislib::sys::KeyCode::KEY_BACKSPACE:
            msg += "Backspace";
            break;
        case vislib::sys::KeyCode::KEY_F1:
            msg += "F1";
            break;
        case vislib::sys::KeyCode::KEY_F2:
            msg += "F2";
            break;
        case vislib::sys::KeyCode::KEY_F3:
            msg += "F3";
            break;
        case vislib::sys::KeyCode::KEY_F4:
            msg += "F4";
            break;
        case vislib::sys::KeyCode::KEY_F5:
            msg += "F5";
            break;
        case vislib::sys::KeyCode::KEY_F6:
            msg += "F6";
            break;
        case vislib::sys::KeyCode::KEY_F7:
            msg += "F7";
            break;
        case vislib::sys::KeyCode::KEY_F8:
            msg += "F8";
            break;
        case vislib::sys::KeyCode::KEY_F9:
            msg += "F9";
            break;
        case vislib::sys::KeyCode::KEY_F10:
            msg += "F10";
            break;
        case vislib::sys::KeyCode::KEY_F11:
            msg += "F11";
            break;
        case vislib::sys::KeyCode::KEY_F12:
            msg += "F12";
            break;
        default: {
            vislib::StringA ks;
 ...
 * vislib::sys::KeyCode::operator=
 */
vislib::sys::KeyCode& vislib::sys::KeyCode::operator=(const vislib::sys::KeyCode& rhs) {
    this->key = rhs.key;
    return *this;
}
...
void vislib::sys::KeyCode::normalise() {
    ...
    if (this->IsSpecial())
        return; // special keys are as they are
