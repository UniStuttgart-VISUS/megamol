 ...
 */
vislib::sys::SystemException::SystemException(const DWORD errorCode, const char* file, const int line)
 ...
 * vislib::sys::SystemException::SystemException
 */
vislib::sys::SystemException::SystemException(const SystemException& rhs) : Exception(rhs), sysMsg(rhs.sysMsg) {}
 ...
 */
vislib::sys::SystemException& vislib::sys::SystemException::operator=(const SystemException& rhs) {
    if (this != &rhs) {
