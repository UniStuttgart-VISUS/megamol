 ...
 */
vislib::net::IPAddress6 vislib::net::IPAddress6::Create(const char* hostNameOrAddress) {
    IPAddress6 retval;
 ...
 * vislib::net::IPAddress6::Create
 */
vislib::net::IPAddress6 vislib::net::IPAddress6::Create(const wchar_t* hostNameOrAddress) {
    IPAddress6 retval;
    DNS::GetHostAddress(retval, hostNameOrAddress);
    return retval;
}
 ...
 */
const vislib::net::IPAddress6& vislib::net::IPAddress6::LOCALHOST = vislib::net::IPAddress6::LOOPBACK;


/*
 * vislib::net::IPAddress6::LOOPBACK
 */
const vislib::net::IPAddress6 vislib::net::IPAddress6::LOOPBACK(::in6addr_loopback);


/*
 * vislib::net::IPAddress6::UNSPECIFIED
 */
const vislib::net::IPAddress6& vislib::net::IPAddress6::UNSPECIFIED = vislib::net::IPAddress6::ANY;
 ...
 * vislib::net::IPAddress6::IPAddress6
 */
vislib::net::IPAddress6::IPAddress6(const BYTE b1, const BYTE b2, const BYTE b3, const BYTE b4, const BYTE b5,
    const BYTE b6, const BYTE b7, const BYTE b8, const BYTE b9, const BYTE b10, const BYTE b11, const BYTE b12,
 ...
 */
vislib::net::IPAddress6 vislib::net::IPAddress6::GetPrefix(const ULONG prefixLength) const {
    IPAddress6 retval;
    int cntBytes = sizeof(retval.address.s6_addr);
    int cntPrefix = prefixLength > static_cast<ULONG>(8 * cntBytes) ? cntBytes : static_cast<int>(prefixLength);
    ...
    if (cntCopy.rem > 0) {
        retval.address.s6_addr[cntCopy.quot] = this->address.s6_addr[cntCopy.quot] << (8 - cntCopy.rem);
    }
...
vislib::StringA vislib::net::IPAddress6::ToStringA(void) const {
    ...
    if ((err = ::getnameinfo(reinterpret_cast<struct sockaddr*>(&addr), sizeof(struct sockaddr_in6), buffer,
 ...
 * vislib::net::IPAddress6::operator =
 */
vislib::net::IPAddress6& vislib::net::IPAddress6::operator=(const struct in6_addr& rhs) {
    if (&this->address != &rhs) {
 ...
 * vislib::net::IPAddress6::operator =
 */
vislib::net::IPAddress6& vislib::net::IPAddress6::operator=(const IPAddress& rhs) {
