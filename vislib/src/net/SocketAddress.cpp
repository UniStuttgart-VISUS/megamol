...
vislib::net::SocketAddress vislib::net::SocketAddress::Create(
    const AddressFamily addressFamily, const char* host, const unsigned short port) {
 ...
 */
vislib::net::SocketAddress vislib::net::SocketAddress::CreateInet(const char* host, const unsigned short port) {
 ...
 * vislib::net::SocketAddress::CreateInet
 */
vislib::net::SocketAddress vislib::net::SocketAddress::CreateInet(const unsigned short port) {
 ...
 */
vislib::net::SocketAddress::SocketAddress(
    const AddressFamily addressFamily, const IPAddress& ipAddress, const unsigned short port) {
 ...
 * vislib::net::SocketAddress::SocketAddress
 */
vislib::net::SocketAddress::SocketAddress(const AddressFamily addressFamily, const unsigned short port) {
    ASSERT(sizeof(this->genericAddress) == sizeof(this->inetAddress));
    ::memset(&this->genericAddress, 0, sizeof(this->genericAddress));
    this->inetAddress.sin_family = static_cast<unsigned short>(addressFamily);
    this->inetAddress.sin_port = htons(port);
...
vislib::net::SocketAddress::SocketAddress(const SocketAddress& rhs) {
    ASSERT(sizeof(this->genericAddress) == sizeof(this->inetAddress));
    ::memcpy(&this->genericAddress, &rhs.genericAddress, sizeof(this->genericAddress));
}
 ...
 * vislib::net::SocketAddress::SocketAddress
 */
vislib::net::SocketAddress::SocketAddress(const SocketAddress& address, const unsigned short newPort) {
    ASSERT(sizeof(this->genericAddress) == sizeof(this->inetAddress));
 ...
 */
vislib::net::SocketAddress& vislib::net::SocketAddress::operator=(const SocketAddress& rhs) {
    if (this != &rhs) {
        ::memcpy(&this->genericAddress, &rhs.genericAddress, sizeof(this->genericAddress));
    }
...
bool vislib::net::SocketAddress::operator==(const SocketAddress& rhs) const {
    return (::memcmp(&this->genericAddress, &rhs.genericAddress, sizeof(this->genericAddress)) == 0);
}
