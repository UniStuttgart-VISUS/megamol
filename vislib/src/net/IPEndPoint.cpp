 ...
 */
vislib::net::IPEndPoint vislib::net::IPEndPoint::CreateIPv4(const char* hostNameOrAddress, const unsigned short port) {
    IPAddress addr;
    try {
 ...
 */
vislib::net::IPEndPoint vislib::net::IPEndPoint::CreateIPv6(const char* hostNameOrAddress, const unsigned short port) {
    IPAddress6 addr;
    try {
        DNS::GetHostAddress(addr, hostNameOrAddress);
    } catch (SocketException e) {
 ...
 */
vislib::net::IPEndPoint::IPEndPoint(const IPAddress& ipAddress, const unsigned short port) {
 ...
 * vislib::net::IPEndPoint::IPEndPoint
 */
vislib::net::IPEndPoint::IPEndPoint(const IPAddress6& ipAddress, const unsigned short port) {
    ::ZeroMemory(&this->address, sizeof(this->address));
    this->SetIPAddress(ipAddress);
    this->SetPort(port); // IP address must have been set before!
    // TODO flow stuff etc!
 ...
 * vislib::net::IPEndPoint::IPEndPoint
 */
vislib::net::IPEndPoint::IPEndPoint(const IPAgnosticAddress& ipAddress, const unsigned short port) {
    ::ZeroMemory(&this->address, sizeof(this->address));
    this->SetIPAddress(ipAddress);
    this->SetPort(port); // IP address must have been set before!
}
 ...
 * vislib::net::IPEndPoint::IPEndPoint
 */
vislib::net::IPEndPoint::IPEndPoint(const AddressFamily addressFamily, const unsigned short port) {
    ::ZeroMemory(&this->address, sizeof(this->address));
 ...
 * vislib::net::IPEndPoint::IPEndPoint
 */
vislib::net::IPEndPoint::IPEndPoint(const IPEndPoint& address, const unsigned short newPort) {
    ::ZeroMemory(&this->address, sizeof(this->address));
    *this = address;
...
void vislib::net::IPEndPoint::SetIPAddress(const IPAddress& ipAddress) {
    ...
    ::memcpy(&(this->asV4().sin_addr), static_cast<const struct in_addr*>(ipAddress), sizeof(struct in_addr));
}
...
void vislib::net::IPEndPoint::SetIPAddress(const IPAddress6& ipAddress) {
    ...
    ::memcpy(&(this->asV6().sin6_addr), static_cast<const struct in6_addr*>(ipAddress), sizeof(struct in6_addr));
}
...
vislib::StringA vislib::net::IPEndPoint::ToStringA() const {
    ...
    switch (this->address.ss_family) {
    case AF_INET:
        retval.Format("%s:%u", this->GetIPAddress4().ToStringA().PeekBuffer(), this->GetPort());
        break;

    case AF_INET6:
        retval.Format("[%s]:%u", this->GetIPAddress6().ToStringA().PeekBuffer(), this->GetPort());
        break;
 ...
 */
vislib::net::IPEndPoint& vislib::net::IPEndPoint::operator=(const IPEndPoint& rhs) {
    if (this != &rhs) {
 ...
 * vislib::net::IPEndPoint::operator =
 */
vislib::net::IPEndPoint& vislib::net::IPEndPoint::operator=(const SocketAddress& rhs) {
 ...
 * vislib::net::IPEndPoint::operator =
 */
vislib::net::IPEndPoint& vislib::net::IPEndPoint::operator=(const struct sockaddr_in& rhs) {
 ...
 * vislib::net::IPEndPoint::operator =
 */
vislib::net::IPEndPoint& vislib::net::IPEndPoint::operator=(const struct sockaddr_in6& rhs) {
...
vislib::net::IPEndPoint::operator vislib::net::SocketAddress() const {
    ...
    case AF_INET6:
        return SocketAddress(SocketAddress::FAMILY_INET, this->GetIPAddress4(), this->GetPort());
