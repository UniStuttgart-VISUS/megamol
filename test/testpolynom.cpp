...
void TestPolynom(void) {
    ...
    AssertEqual("Root at -2", poly3(-2.0f), 0.0f);
    AssertEqual("Root at 4", poly3(4.0f), 0.0f);
    AssertEqual("Root at 5", poly3(5.0f), 0.0f);
    ...
    AssertEqual("Root at -1", poly3(-1.0f), 0.0f);
    AssertEqual("Root at 0", poly3(0.0f), 0.0f);
    AssertEqual("Root at 1", poly3(1.0f), 0.0f);
    ...
    AssertEqual("Root at -3", poly4(-3.0f), 0.0f);
    AssertEqual("Root at -1", poly4(-1.0f), 0.0f);
    AssertEqual("Root at 2", poly4(2.0f), 0.0f);
    AssertEqual("Root at 4", poly4(4.0f), 0.0f);
    ...
    AssertEqual("Root at -5", poly5(-5.0f), 0.0f);
    AssertEqual("Root at -3", poly5(-3.0f), 0.0f);
    AssertEqual("Root at -1", poly5(-1.0f), 0.0f);
    AssertEqual("Root at 2", poly5(2.0f), 0.0f);
    AssertEqual("Root at 4", poly5(4.0f), 0.0f);
