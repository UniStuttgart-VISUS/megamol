...
enum HotkeyIndex : size_t {
    ...
    HOTKEY_ANIMATIONEDITOR_PLAY_ANIMATION,
    HOTKEY_ANIMATIONEDITOR_STOP_ANIMATION,
    HOTKEY_ANIMATIONEDITOR_REVERSE_PLAY_ANIMATION,
    HOTKEY_ANIMATIONEDITOR_MOVE_TO_ANIMATION_START,
    HOTKEY_ANIMATIONEDITOR_MOVE_TO_ANIMATION_END
};
struct HotkeyData_t {
    std::string name;
