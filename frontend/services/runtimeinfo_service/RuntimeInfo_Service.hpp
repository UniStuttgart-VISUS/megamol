...
class RuntimeInfo_Service final : public AbstractFrontendService {
public:
...
private:
    ...
    megamol::core::utility::platform::RuntimeInfo ri_;

    megamol::frontend_resources::RuntimeInfo ri_resource_;
};
