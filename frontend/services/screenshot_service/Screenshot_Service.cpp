...
static bool write_png_to_file(megamol::frontend_resources::ImageData const& image, std::string const& filename) {
    ...
    if (runtime_config_ptr->screenshot_show_privacy_note) {
        ...
        megamol::core::utility::log::Log::DefaultLog.WriteWarn("%sScreenshot%sPRIVACY NOTE \n"
           ...
           "> In megamol_config.lua set mmSetCliOption(\"privacynote\", \"off\") to permanently turn off privacy notification for screenshots in MegaMol. \n"
