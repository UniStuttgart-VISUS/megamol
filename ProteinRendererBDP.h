...
namespace protein {
    ...
    protected:
        ...
        /**
         * Creates the frame buffer objects and textures needed for (adaptive) depth peeling.
         */
        ...
        /**
         * Create and equalizes the depth histogram generated by adaptive bucket depth peeling
         *
         * @param protein Pointer to the protein data interface.
         */
