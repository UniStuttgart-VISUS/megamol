/*
    ...
    WGL loader generated by glad 0.1.14a0 on Wed Aug  9 11:07:57 2017.
...
GLAPI int isWGLExtAvailable(const char *extensionName) {
...
GLAPI int areWGLExtsAvailable(const char *extensionsNames) {
