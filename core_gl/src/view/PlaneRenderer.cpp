...
namespace core_gl {
    namespace view {
        ...
        bool PlaneRenderer::Render(CallRender3DGL& call) {
            ...
            glUniformMatrix4fv(this->render_data->getUniformLocation("view_mx"), 1, false,
                glm::value_ptr(static_cast<glm::mat4>(view)));
            glUniformMatrix4fv(this->render_data->getUniformLocation("proj_mx"), 1, false,
        ...
        bool PlaneRenderer::GetExtents(CallRender3DGL& call) {
            ...
            call.AccessBoundingBoxes().SetClipBox(vislib::math::Cuboid<float>(old_bb.Left() - x_offset,
                old_bb.Bottom() - y_offset, old_bb.Back() - z_offset, old_bb.Left() + x_offset,
                old_bb.Bottom() + y_offset, old_bb.Back() + z_offset));
