...
#pragma warning (default: 4251)
    ...
    protected:
        ...
        virtual void CharacterData(unsigned int level, const XML_Char *text,
            int len, core::utility::xml::XmlReader::ParserState state);
        ...
        virtual bool StartTag(unsigned int num, unsigned int level,
            ...
            core::utility::xml::XmlReader::ParserState state,
            core::utility::xml::XmlReader::ParserState& outChildState,
        ...
        virtual bool EndTag(unsigned int num, unsigned int level,
            const XML_Char * name, core::utility::xml::XmlReader::ParserState state,
            core::utility::xml::XmlReader::ParserState& outPostEndTagState);
