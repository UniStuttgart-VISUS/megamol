 ...
 */
class BTFParser : public core::utility::xml::ConditionalParser {
public:
    /**
...
#pragma warning(default : 4251)
    ...
    public:
         ...
         */
        BTFNamespace(const vislib::StringA& name) : BTFElement(name), children() {
            // intentionally empty
        }
        ...
        virtual vislib::SmartPtr<BTFElement> FindChild(const vislib::StringA& name) const {
            vislib::ConstIterator<vislib::SingleLinkedList<vislib::SmartPtr<BTFElement>>::Iterator> i =
...
#pragma warning(default : 4251)
    ...
    public:
        ...
        enum SnippetType { EMPTY_SNIPPET, STRING_SNIPPET, VERSION_SNIPPET, FILE_SNIPPET };
         ...
         * @param name The name of the namespace
         */
        BTFSnippet(const vislib::StringA& name) : BTFElement(name), type(EMPTY_SNIPPET), content() {
            // intentionally empty
        }
    ...
    public:
         ...
         * @param name The name of the namespace
         */
        BTFShader(const vislib::StringA& name) : BTFNamespace(name), ids() {
            // intentionally empty
        }
         ...
         * @return The name id map of the shader.
         */
        inline const vislib::Map<vislib::StringA, unsigned int>& NameIDs(void) const {
            return this->ids;
        }
     ...
     */
    void SetRootElement(const vislib::SmartPtr<BTFElement>& root, const vislib::SmartPtr<BTFElement>& masterroot);
...
protected:
    ...
    virtual void CharacterData(
        unsigned int level, const XML_Char* text, int len, core::utility::xml::XmlReader::ParserState state);
     ...
     * @param state The current state of the reader.
     */
    virtual void Comment(unsigned int level, const XML_Char* text, core::utility::xml::XmlReader::ParserState state);
     ...
     */
    virtual bool CheckBaseTag(const core::utility::xml::XmlReader& reader);
    ...
    virtual bool StartTag(unsigned int num, unsigned int level, const XML_Char* name, const XML_Char** attrib,
        core::utility::xml::XmlReader::ParserState state, core::utility::xml::XmlReader::ParserState& outChildState,
        core::utility::xml::XmlReader::ParserState& outEndTagState,
        core::utility::xml::XmlReader::ParserState& outPostEndTagState);
     ...
     *         'false' if the tag was not handled.
     */
    virtual bool EndTag(unsigned int num, unsigned int level, const XML_Char* name,
        core::utility::xml::XmlReader::ParserState state,
        core::utility::xml::XmlReader::ParserState& outPostEndTagState);
