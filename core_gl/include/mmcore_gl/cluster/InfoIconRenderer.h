...
public:
    ...
    enum IconState { ICONSTATE_UNKNOWN, ICONSTATE_ERROR, ICONSTATE_OK, ICONSTATE_WAIT, ICONSTATE_WORK };
     ...
     */
    static void RenderErrorInfoIcon(unsigned char colR, unsigned char colG, unsigned char colB,
     ...
     * @param message The message to be displayed along with the icon
     */
    static void RenderInfoIcon(IconState icon, const vislib::TString& message = vislib::TString::EMPTY);
     ...
     * @param message The message to be displayed along with the icon
     */
    static void RenderInfoIcon(IconState icon, unsigned char colR, unsigned char colG, unsigned char colB,
        const vislib::TString& message = vislib::TString::EMPTY);
     ...
     * @param colB The blue colour component
     */
    static void RenderInfoIconBorder(unsigned char colR, unsigned char colG, unsigned char colB);
     ...
     * @param message The message to be displayed along with the icon
     */
    static void RenderOKInfoIcon(unsigned char colR, unsigned char colG, unsigned char colB,
        const vislib::TString& message = vislib::TString::EMPTY);
     ...
     * @param message The message to be displayed along with the icon
     */
    static void RenderUnknownStateInfoIcon(unsigned char colR, unsigned char colG, unsigned char colB,
        const vislib::TString& message = vislib::TString::EMPTY);
     ...
     * @param message The message to be displayed along with the icon
     */
    static void RenderWaitInfoIcon(unsigned char colR, unsigned char colG, unsigned char colB,
        const vislib::TString& message = vislib::TString::EMPTY);
     ...
     * @param message The message to be displayed along with the icon
     */
    static void RenderWorkingInfoIcon(unsigned char colR, unsigned char colG, unsigned char colB,
        const vislib::TString& message = vislib::TString::EMPTY);
