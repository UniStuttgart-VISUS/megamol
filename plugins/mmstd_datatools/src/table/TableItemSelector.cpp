...
megamol::stdplugin::datatools::table::TableItemSelector::~TableItemSelector() { this->Release(); }


bool megamol::stdplugin::datatools::table::TableItemSelector::create() { return true; }


void megamol::stdplugin::datatools::table::TableItemSelector::release() {}


bool megamol::stdplugin::datatools::table::TableItemSelector::getDataCallback(core::Call& c) {
...
bool megamol::stdplugin::datatools::table::TableItemSelector::getHashCallback(core::Call& c) {
    auto out_data = dynamic_cast<stdplugin::datatools::table::TableDataCall*>(&c);
    if (out_data == nullptr) return false;
