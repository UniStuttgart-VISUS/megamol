...
TableSelectionTx::TableSelectionTx()
    ...
    , useColumnAsIndexParam("useColumnAsIndexParam", "Use column as index instead of row id")
    , indexColumnParam("indexColumnParam", "Numeric index of column, which is used as row index")
