...
namespace datatools {
    ...
    public:
        ...
        static const char *ClassName(void) { return "ParticleFilterMapDataCall"; }
        static const char *Description(void) { return "Map data, i.e. an array of length of the filtered particles with the indices into the original unfiltered particles data"; }
        ...
        inline index_t* Data() const { return idx; }
        inline size_t Size() const { return idx_len; }
