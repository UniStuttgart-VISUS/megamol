...
public:
     ...
     * @param ballot_func The functor for execution balloting
     */
    AbstractVolumeManipulator(const char* outSlotName, const char* inSlotName, std::function<bool(bool)>&& ballot_func);
...
private:
    ...
    /** Functor for execution balloting. Primarily for guarding MPI functions. */
    std::function<bool(bool)> ballot_func;
};
