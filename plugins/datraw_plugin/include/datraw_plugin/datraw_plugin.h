 ...
 */
#ifndef DATRAW_PLUGIN_H_INCLUDED
#define DATRAW_PLUGIN_H_INCLUDED
...
#ifdef DATRAW_PLUGIN_EXPORTS
#define DATRAW_PLUGIN_API __declspec(dllexport)
#else
#define DATRAW_PLUGIN_API __declspec(dllimport)
#endif
#else /* _WIN32 */
#define DATRAW_PLUGIN_API
#endif /* _WIN32 */
 ...
 */
DATRAW_PLUGIN_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
DATRAW_PLUGIN_API void mmplgReleasePluginInstance(
...
#endif /* DATRAW_PLUGIN_H_INCLUDED */
