...
namespace megamol::ospray {
    ...
    public:
        ...
        void addSphereCollection(std::string const& identifier, std::vector<VertexAttribute> const& attribs, double global_radius_ = -1.0, std::array<float,4> global_color_ = {-1.0f,-1.0f,-1.0f,-1.0f});
    ...
    inline ParticleDataAccessCollection::Spheres const& ParticleDataAccessCollection::accessSphereCollection(std::string const& identifier) {
