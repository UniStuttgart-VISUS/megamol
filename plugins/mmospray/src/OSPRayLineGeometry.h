...
private:
    ...
    std::vector<std::vector<std::vector<mesh::MeshDataAccessCollection::VertexAttribute>>> _converted_attribs;
    mesh::MeshDataAccessCollection::IndexData _converted_indices;

    std::array<uint32_t, 1> _converted_index;
