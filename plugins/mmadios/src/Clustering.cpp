...
bool megamol::adios::Clustering::getDataCallback(core::Call& c) {
    ...
    if (data_hash_ != in_data->DataHash() || isDirty()) {
        ...
        auto points = datatools::clustering::ann_points(num_rows, num_columns, in_data_ptr);
        ...
        auto clusters = datatools::clustering::DBSCAN_scan_it(kdtree, sigma, minpts, num_clusters);
        ...
        auto ci = datatools::table::TableDataCall::ColumnInfo();
        ci.SetType(datatools::table::TableDataCall::ColumnType::CATEGORICAL);
