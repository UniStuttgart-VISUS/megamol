/*
 * RamachandranDataCall.h
 *
 * Author: Karsten Schatz
 * Copyright (C) 2017 by Universitaet Stuttgart (VISUS).
 * All rights reserved.
 */
#ifndef MM_PROTEIN_UNCERTAINTY_PLUGIN_RAMACHANDRANDATACALL_H_INCLUDED
#define MM_PROTEIN_UNCERTAINTY_PLUGIN_RAMACHANDRANDATACALL_H_INCLUDED
