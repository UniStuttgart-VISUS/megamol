...
#define PROTEIN_UNCERTAINTY_API __declspec(dllexport)
#else
#define PROTEIN_UNCERTAINTY_API __declspec(dllimport)
#endif
#else /* _WIN32 */
 ...
 */
PROTEIN_UNCERTAINTY_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
PROTEIN_UNCERTAINTY_API void mmplgReleasePluginInstance(
...
#endif /* PROTEIN_UNCERTAINTY_H_INCLUDED */
