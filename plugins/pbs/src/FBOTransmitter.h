...
/*
 * Module which transmitts FBO contents (color and depth) over a ZMQ socket.
 * It hooks into a view like the screenshoter.
 */
...
public:
     ...
     */
    static const char* ClassName(void) { return "FBOTransmitter"; }
...
//bool viewportsEqual(int const* a, int const* b);
//
