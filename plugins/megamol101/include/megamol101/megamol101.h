 ...
 */
#ifndef MEGAMOL101_H_INCLUDED
#define MEGAMOL101_H_INCLUDED
...
#ifdef MEGAMOL101_EXPORTS
#define MEGAMOL101_API __declspec(dllexport)
#else
#define MEGAMOL101_API __declspec(dllimport)
#endif
#else /* _WIN32 */
#define MEGAMOL101_API
#endif /* _WIN32 */
 ...
 * @return 200 -- (ver.: 2.00)
 */
MEGAMOL101_API int mmplgPluginAPIVersion(void);
 ...
 */
MEGAMOL101_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
MEGAMOL101_API void mmplgReleasePluginInstance(
