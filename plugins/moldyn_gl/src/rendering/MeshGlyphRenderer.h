...
#ifndef MOLDYN_MESHGLYPHRENDERER_H_INCLUDED
#define MOLDYN_MESHGLYPHRENDERER_H_INCLUDED
 ...
 */
class MeshGlyphRenderer : public megamol::core_gl::view::Renderer3DModuleGL {
public:
#ifdef PROFILING
    ...
    /** Ctor. */
    MeshGlyphRenderer(void);

    /** Dtor. */
    virtual ~MeshGlyphRenderer(void);
...
#endif /* MOLDYN_MESHGLYPHRENDERER_H_INCLUDED */
