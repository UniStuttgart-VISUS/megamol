...
#ifndef MEGAMOLCORE_MESHARROWRENDERER_H_INCLUDED
#define MEGAMOLCORE_MESHARROWRENDERER_H_INCLUDED
 ...
 */
class MeshArrowRenderer : public core_gl::view::Renderer3DModuleGL {
public:
#ifdef PROFILING
    ...
    /** Ctor. */
    MeshArrowRenderer(void);

    /** Dtor. */
    virtual ~MeshArrowRenderer(void);
...
#endif /* MEGAMOLCORE_MESHARROWRENDERER_H_INCLUDED */
