...
std::vector<worklet> create_worklets(megamol::moldyn_gl::rendering::SphereRasterizer::config_t config, glm::mat4 win_trans, glm::vec2& final_mins, glm::vec2& final_res, glm::vec2& subs) {
