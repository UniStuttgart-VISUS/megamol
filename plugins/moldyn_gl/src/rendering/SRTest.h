...
class ssbo_geo_rt : public rendering_task {
public:
...
class mesh_geo_rt : public rendering_task {
public:
...
class mesh_geo_altn_rt : public rendering_task {
public:
...
class mesh_geo_task_rt : public rendering_task {
public:
