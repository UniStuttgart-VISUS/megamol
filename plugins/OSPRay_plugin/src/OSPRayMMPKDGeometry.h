...
class OSPRayMMPKDGeometry : public AbstractOSPRayStructure {
...
public:
    ...
    */
    static const char *Description(void) {
        return "Creator for OSPRay MMPKD geometries.";
    }
    ...
    */
    ...
    /** Dtor. */
    virtual ~OSPRayMMPKDGeometry(void);

    /** Ctor. */
    OSPRayMMPKDGeometry(void);
