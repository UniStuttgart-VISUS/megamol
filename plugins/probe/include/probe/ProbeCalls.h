...
class CallProbes : public core::GenericVersionedCall<std::shared_ptr<ProbeCol>, core::Spatial3DMetaData> {
public:
    inline CallProbes() : GenericVersionedCall<std::shared_ptr<ProbeCol>, core::Spatial3DMetaData>() {}
    ~CallProbes() = default;
