/*
 * CUDAVolumeRaycaster_kernel.cuh
 * Copyright (C) 2009-2018 by MegaMol Team
 * Alle Rechte vorbehalten.
 */
#ifndef MMMOLMAPPLG_CUDAVOLUMERAYCASTER_KERNEL_CUH_INCLUDED
#define MMMOLMAPPLG_CUDAVOLUMERAYCASTER_KERNEL_CUH_INCLUDED
...
namespace volume_cuda {
    class CUDAVolumeRaycaster_kernel {
    public:

        /** 
         * Constructor
         */
        CUDAVolumeRaycaster_kernel(void);

        /**
         * Destructor
         */
        virtual ~CUDAVolumeRaycaster_kernel(void);
