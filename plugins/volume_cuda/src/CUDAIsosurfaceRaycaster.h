#ifndef VOLUME_CUDA_CUDAISOSURFACERAYCASTER_H_INCLUDED
#define VOLUME_CUDA_CUDAISOSURFACERAYCASTER_H_INCLUDED
...
namespace volume_cuda {
	...
	class CUDAIsosurfaceRaycaster : public megamol::core::view::Renderer3DModule {
	public:
		...
		static const char *ClassName(void) {
			return "CUDAIsosurfaceRaycaster";
		}
        ...
        static const char *Description(void) {
            return "Offers raycasting of volume isosurfaces";
        }
		...
		/** Ctor */
        CUDAIsosurfaceRaycaster(void);

		/** Dtor */
		virtual ~CUDAIsosurfaceRaycaster(void);
...
#endif // !VOLUME_CUDA_CUDAISOSURFACERAYCASTER_H_INCLUDED