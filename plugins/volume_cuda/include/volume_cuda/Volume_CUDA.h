 ...
 */
#ifndef VOLUME_CUDA_H_INCLUDED
#define VOLUME_CUDA_H_INCLUDED
...
#ifdef VOLUME_CUDA_EXPORTS
#define VOLUME_CUDA_API __declspec(dllexport)
#else
#define VOLUME_CUDA_API __declspec(dllimport)
#endif
#else /* _WIN32 */
#define VOLUME_CUDA_API
#endif /* _WIN32 */
 ...
 * @return 200 -- (ver.: 2.00)
 */
VOLUME_CUDA_API int mmplgPluginAPIVersion(void);
 ...
 */
VOLUME_CUDA_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
VOLUME_CUDA_API void mmplgReleasePluginInstance(
