...
#ifdef pmem_EXPORTS
#define pmem_API __declspec(dllexport)
#else
#define pmem_API __declspec(dllimport)
#endif
#else /* _WIN32 */
#define pmem_API
#endif /* _WIN32 */
 ...
 */
pmem_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
pmem_API void mmplgReleasePluginInstance(
