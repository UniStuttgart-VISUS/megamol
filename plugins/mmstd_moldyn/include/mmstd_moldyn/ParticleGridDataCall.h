...
#ifndef MMSTD_MOLDYN_PARTICLEGRIDDATACALL_H_INCLUDED
#define MMSTD_MOLDYN_PARTICLEGRIDDATACALL_H_INCLUDED
...
namespace moldyn {
     ...
     */
    class MMSTD_MOLDYN_API ParticleGridDataCall : public core::AbstractGetData3DCall {
    public:
...
#endif /* MMSTD_MOLDYN_PARTICLEGRIDDATACALL_H_INCLUDED */
