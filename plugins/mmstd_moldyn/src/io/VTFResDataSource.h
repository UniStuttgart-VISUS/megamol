...
namespace io {
     ...
     */
	class VTFResDataSource : public core::view::AnimDataModule {
    public:
    ...
    protected:
         ...
         */
        virtual void loadFrame(core::view::AnimDataModule::Frame *frame,
            unsigned int idx);
    ...
    private:
		...
		vislib::Array<vislib::StringA> frameFiles;
