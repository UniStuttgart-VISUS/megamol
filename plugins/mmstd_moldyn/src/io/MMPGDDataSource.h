...
#ifndef MMSTD_MOLDYN_MMPGDDATASOURCE_H_INCLUDED
#define MMSTD_MOLDYN_MMPGDDATASOURCE_H_INCLUDED
 ...
 */
class MMPGDDataSource : public core::view::AnimDataModule {
public:
...
#endif /* MMSTD_MOLDYN_MMPGDDATASOURCE_H_INCLUDED */
