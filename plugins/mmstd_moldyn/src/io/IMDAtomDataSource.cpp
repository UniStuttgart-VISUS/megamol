 ...
 */
IMDAtomDataSource::IMDAtomDataSource(void) : core::Module(),
...
bool IMDAtomDataSource::getDataCallback(core::Call& caller) {
    ...
    core::moldyn::DirectionalParticleDataCall *dpdc = dynamic_cast<core::moldyn::DirectionalParticleDataCall*>(&caller);
 ...
 */
bool IMDAtomDataSource::readHeader(vislib::sys::File& file,
        IMDAtomDataSource::HeaderData& header) {
    using vislib::sys::Log;
 ...
 */
template<typename T>
bool IMDAtomDataSource::readData(vislib::sys::File& file,
        const IMDAtomDataSource::HeaderData& header,
