...
bool VIMDataSource::filenameChanged(core::param::ParamSlot& slot) {
    ...
    if (!this->file->Open(this->filename.Param<core::param::FilePathParam>()->Value().c_str(),
        ...
        megamol::core::utility::log::Log::DefaultLog.WriteMsg(megamol::core::utility::log::Log::LEVEL_ERROR,
            "Unable to open VIM-File \"%s\": %s", this->filename.Param<core::param::FilePathParam>()->Value().c_str(),
    ...
    if (!this->readHeader(this->filename.Param<core::param::FilePathParam>()->Value().c_str())) {
        megamol::core::utility::log::Log::DefaultLog.WriteMsg(megamol::core::utility::log::Log::LEVEL_ERROR,
            "Unable to read VIM-Header from file \"%s\". Wrong format?", this->filename.Param<core::param::FilePathParam>()->Value().c_str());
