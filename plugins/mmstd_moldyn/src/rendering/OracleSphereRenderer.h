...
#ifndef MMSTD_MOLDYN_ORACLESPHERERENDERER_H_INCLUDED
#define MMSTD_MOLDYN_ORACLESPHERERENDERER_H_INCLUDED
 ...
 */
class OracleSphereRenderer : public core::view::Renderer3DModule {
public:
...
#endif /* MMSTD_MOLDYN_ORACLESPHERERENDERER_H_INCLUDED */
