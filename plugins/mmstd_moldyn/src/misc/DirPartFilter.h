 ...
 * a scalar volume.
 */
class DirPartFilter : public core::Module {
public:
  /**
   ...
   */
  static const char *ClassName(void) { return "DirPartFilter"; }
  ...
  static const char *Description(void) {
    return "Module to filter partices based on the scalar value at their "
           "position";
  }
