...
/**
 * Module to filter calls with multiple particle lists (currently directional
 * and spherical) by list index
 */
...
public:
   ...
   */
  static const char *ClassName(void) { return "ParticleListFilter"; }
  ...
  static const char *Description(void) {
    return "Module to filter calls with multiple particle lists (currently "
           "directional and spherical) by particle type";
  }
