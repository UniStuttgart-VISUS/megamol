...
void Demo_ColorMatrix()
{
    if (ImGuiTexInspect::BeginInspectorPanel(
            "##ColorMatrix", testTex.texture, testTex.size, ImGuiTexInspect::InspectorFlags_FlipY))
    {
        // Draw some text showing color value of each texel (you must be zoomed in to see this)
        ImGuiTexInspect::DrawAnnotations(ImGuiTexInspect::ValueText(ImGuiTexInspect::ValueText::BytesDec));
    }
...
{
    if (ImGuiTexInspect::BeginInspectorPanel(
            "##AlphaModeDemo", testTex.texture, testTex.size, ImGuiTexInspect::InspectorFlags_FlipY))
    {
...
void Demo_WrapAndFilter()
{
    ...
    if (ImGuiTexInspect::BeginInspectorPanel(
            "##WrapAndFilter", testTex.texture, testTex.size, ImGuiTexInspect::InspectorFlags_FlipY))
    {
    }
    ImGuiTexInspect::InspectorFlags flags = 0;
...
void Demo_TextureAnnotations()
{
    ...
    if (ImGuiTexInspect::BeginInspectorPanel(
            "##TextureAnnotations", testTex.texture, testTex.size, ImGuiTexInspect::InspectorFlags_FlipY))
    {
