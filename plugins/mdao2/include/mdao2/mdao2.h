 ...
 */
#ifndef MDAO2_H_INCLUDED
#define MDAO2_H_INCLUDED
...
#ifdef MDAO2_EXPORTS
#define MDAO2_API __declspec(dllexport)
#else
#define MDAO2_API __declspec(dllimport)
#endif
#else /* _WIN32 */
#define MDAO2_API
#endif /* _WIN32 */
 ...
 */
MDAO2_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
MDAO2_API void mmplgReleasePluginInstance(
