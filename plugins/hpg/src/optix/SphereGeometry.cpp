...
megamol::hpg::optix::SphereGeometry::SphereGeometry()
...
bool megamol::hpg::optix::SphereGeometry::create() {
    return true;
}


void megamol::hpg::optix::SphereGeometry::release() {
    if (_geo_buffer != 0) {
...
bool megamol::hpg::optix::SphereGeometry::assertData(core::moldyn::MultiParticleDataCall& call, CallContext& ctx) {
...
bool megamol::hpg::optix::SphereGeometry::get_data_cb(core::Call& c) {
...
bool megamol::hpg::optix::SphereGeometry::get_extents_cb(core::Call& c) {
    auto out_geo = dynamic_cast<CallGeometry*>(&c);
    if (out_geo == nullptr)
        return false;
    auto in_data = _in_data_slot.CallAs<core::moldyn::MultiParticleDataCall>();
