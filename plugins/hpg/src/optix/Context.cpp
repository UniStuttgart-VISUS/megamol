...
megamol::hpg::optix::Context::Context() : _out_ctx_slot("outCtx", "") {
...
megamol::hpg::optix::Context::~Context() {
    this->Release();
}


bool megamol::hpg::optix::Context::create() {
    /////////////////////////////////////
    // cuda
    /////////////////////////////////////
...
void megamol::hpg::optix::Context::release() {
...
bool megamol::hpg::optix::Context::get_ctx_cb(core::Call& c) {
