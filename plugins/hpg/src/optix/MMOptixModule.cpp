...
megamol::hpg::optix::MMOptixModule::MMOptixModule() {}
...
megamol::hpg::optix::MMOptixModule& megamol::hpg::optix::MMOptixModule::operator=(MMOptixModule&& rhs) noexcept {
...
void megamol::hpg::optix::MMOptixModule::ComputeBounds(
