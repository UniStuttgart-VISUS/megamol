...
megamol::archvis_gl::CreateFEMModel::CreateFEMModel()
    ...
    this->m_deformation_floatTable_slot.SetCompatibleCall<megamol::datatools::table::TableDataCallDescription>();
...
bool megamol::archvis_gl::CreateFEMModel::getDataCallback(core::Call& caller) {
    ...
    auto dynData_ft = this->m_deformation_floatTable_slot.CallAs<megamol::datatools::table::TableDataCall>();
    ...
    if (element_ft->GetColumnsCount() == 9) {
        ...
        for (int elem_idx = 0; elem_idx < element_ft->GetRowsCount(); ++elem_idx) {
            ...
            elements.push_back({static_cast<size_t>(elem_accesssor[curr_idx + 1]),
                static_cast<size_t>(elem_accesssor[curr_idx + 2]), static_cast<size_t>(elem_accesssor[curr_idx + 3]),
                static_cast<size_t>(elem_accesssor[curr_idx + 4]), static_cast<size_t>(elem_accesssor[curr_idx + 5]),
                static_cast<size_t>(elem_accesssor[curr_idx + 6]), static_cast<size_t>(elem_accesssor[curr_idx + 7]),
