...
#ifndef MEGAMOL_CINEMATICCAMERA_SCENE3DRENDERER_H_INCLUDED
#define MEGAMOL_CINEMATICCAMERA_SCENE3DRENDERER_H_INCLUDED
#pragma once
...
namespace megamol {
	namespace cinematiccamera {
		...
		*/
		class Scene3DRenderer : public core::view::Renderer3DModule {
		public:
			...
			*/
			...
			/** Ctor. */
			Scene3DRenderer(void);

			/** Dtor. */
			virtual ~Scene3DRenderer(void);
		...
		private:
			...
			*/
            ...
            /** caller slot for keyframe keeper*/
...
#endif /* MEGAMOL_CINEMATICCAMERA_SCENE3DRENDERER_H_INCLUDED */
