...
#ifndef MEGAMOL_CINEMATICCAMERA_PREVIEWVIEW_H_INCLUDED
#define MEGAMOL_CINEMATICCAMERA_PREVIEWVIEW_H_INCLUDED
...
namespace megamol {
	namespace cinematiccamera {
		...
		class PreviewView : public core::view::View3D {
...
#endif /* MEGAMOL_CINEMATICCAMERA_PREVIEWVIEW_H_INCLUDED */