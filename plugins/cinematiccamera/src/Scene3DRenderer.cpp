...
/*
* cinematiccamera::Scene3DRenderer::Scene3DRenderer
*/
cinematiccamera::Scene3DRenderer::Scene3DRenderer(void) 
	: core::view::Renderer3DModule(),
		...
		getCinematicCameraSlot("keyframes", "Connects to the cinematic camera"),
		rendererCallerSlot("renderMolecule", "Connects the volume rendering with a molecule renderer"),
		currentZClipPos(-20) {
...
/*
* cinematiccamera::Scene3DRenderer::create
*/
bool cinematiccamera::Scene3DRenderer::create(void) {
	// intentionally empty
	return true;
}
...
/*
* cinematiccamera::Scene3DRenderer::GetCapabilities
*/
bool cinematiccamera::Scene3DRenderer::GetCapabilities(core::Call& call) {
	core::view::CallRender3D *cr = dynamic_cast<core::view::CallRender3D*>(&call);
	if (cr == NULL) return false;

	cr->SetCapabilities(core::view::CallRender3D::CAP_RENDER
...
/*
* cinematiccamera::Scene3DRenderer::GetExtents
*/
bool cinematiccamera::Scene3DRenderer::GetExtents(core::Call& call) {
...
/*
* cinematiccamera::Scene3DRenderer::release
*/
void cinematiccamera::Scene3DRenderer::release(void) {

}


/*
* cinematiccamera::Scene3DRenderer::Render
*/
bool cinematiccamera::Scene3DRenderer::Render(core::Call& call) {
	core::view::CallRender3D *cr3d = dynamic_cast<core::view::CallRender3D*>(&call);
	...
	if (keyframeCall != NULL) {
		vislib::Array<Keyframe> keyframes = keyframeCall->getKeyframes();
    }

	// TODO
	// - call render with keyframe data - interpolate in renderer
...
*/
void cinematiccamera::Scene3DRenderer::RenderLines(const MolecularDataCall *mol,
	const float *atomPos) {
...
*/
void cinematiccamera::Scene3DRenderer::RenderStick(const MolecularDataCall *mol,
	const float *atomPos) {
...
#pragma omp parallel for private( idx0, idx1, firstAtomPos, secondAtomPos, quatC, tmpVec, ortho, dir, position, angle)
	...
	if (this->toggleGeomShaderParam.Param<param::BoolParam>()->Value()
		...
		// Vertex attributes
		GLint vertexPos = glGetAttribLocationARB(this->sphereShaderGeom,
			"vertex");
		GLint vertexColor = glGetAttribLocationARB(this->sphereShaderGeom,
			"color");
...
*/
void cinematiccamera::Scene3DRenderer::RenderBallAndStick(const MolecularDataCall *mol,
	const float *atomPos) {
	// ----- prepare stick raycasting -----
	this->vertSpheres.SetCount(mol->AtomCount() * 4);
	this->vertCylinders.SetCount(mol->ConnectionCount() * 4);
...
* Render the molecular data in ball-and-stick mode.
*/
void cinematiccamera::Scene3DRenderer::RenderStickClipPlane(MolecularDataCall *mol,
	const float *atomPos) {
...
*/
void cinematiccamera::Scene3DRenderer::RenderSpacefilling(const MolecularDataCall *mol,
	const float *atomPos) {
...
* Render the molecular data in spacefilling mode.
*/
void cinematiccamera::Scene3DRenderer::RenderSpacefillingClipPlane(
...
*/
void cinematiccamera::Scene3DRenderer::RenderSAS(const MolecularDataCall *mol,
	const float *atomPos) {
	// ----- prepare stick raycasting -----
	this->vertSpheres.SetCount(mol->AtomCount() * 4);
...
*/
void cinematiccamera::Scene3DRenderer::RenderLinesFilter(const MolecularDataCall *mol,
	const float *atomPos) {
...
* Render the molecular data in stick mode.
*/
void cinematiccamera::Scene3DRenderer::RenderStickFilter(const MolecularDataCall *mol,
	const float *atomPos) {
...
* Render the molecular data in stick mode.
*/
void cinematiccamera::Scene3DRenderer::RenderSpacefillingFilter(
...
* update parameters
*/
void cinematiccamera::Scene3DRenderer::UpdateParameters(const MolecularDataCall *mol,
