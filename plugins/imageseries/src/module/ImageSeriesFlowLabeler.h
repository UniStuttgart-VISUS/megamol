#ifndef IMAGESERIES_SRC_MODULE_IMAGESERIESFLOWLABELER_HPP_
#define IMAGESERIES_SRC_MODULE_IMAGESERIESFLOWLABELER_HPP_
...
private:
    ...
    core::param::ParamSlot timeThresholdParam;
    core::param::ParamSlot minTimestampParam;
