 ...
 * CallTriMeshData::Material::Material
 */
CallTriMeshDataGL::Material::Material(const CallTriMeshDataGL::Material& src) { *this = src; }
 ...
 */
void CallTriMeshDataGL::Material::Dye(float r, float g, float b) {
    this->Ka[0] *= r;
    this->Ka[1] *= g;
    this->Ka[2] *= b;
    this->Kd[0] *= r;
 ...
 */
void CallTriMeshDataGL::Material::SetMapFileName(const vislib::TString& filename) {
 ...
 */
void CallTriMeshDataGL::Material::SetBumpMapFileName(const vislib::TString& filename) {
 ...
 */
CallTriMeshDataGL::Material& CallTriMeshDataGL::Material::operator=(const CallTriMeshDataGL::Material& rhs) {
    this->Ns = rhs.Ns;
    this->Ni = rhs.Ni;
    this->d = rhs.d;
    this->Tr = rhs.Tr;
 ...
 * CallTriMeshData::Material::operator==
 */
bool CallTriMeshDataGL::Material::operator==(const CallTriMeshDataGL::Material& rhs) const {
 ...
 */
unsigned int CallTriMeshDataGL::Material::loadTexture(vislib::TString& filename) {
 ...
 * CallTriMeshData::Mesh::Mesh
 */
CallTriMeshDataGL::Mesh::Mesh(const CallTriMeshDataGL::Mesh& src) { *this = src; }
 ...
 */
CallTriMeshDataGL::Mesh& CallTriMeshDataGL::Mesh::operator=(const CallTriMeshDataGL::Mesh& rhs) {
 ...
 * CallTriMeshData::Mesh::operator==
 */
bool CallTriMeshDataGL::Mesh::operator==(const CallTriMeshDataGL::Mesh& rhs) const {
