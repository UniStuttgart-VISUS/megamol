...
namespace adios {
    ...
    protected:
        ...
        getAs() {
            ...
            std::transform(dataVec.begin(), dataVec.end(), new_vec.begin(),
                [](const value_type& val) { return std::to_string(val); });
            return new_vec;
        }
    ...
    class StringContainer : public abstractContainer, public containerInterface<std::string> {
        ...
        std::vector<T> get_from_str() {
            ...
            std::transform(old_vec.begin(), old_vec.end(), new_vec.begin(),
                [](std::string const& str) { return str_conv<T>(str); });
            return new_vec;
        }
