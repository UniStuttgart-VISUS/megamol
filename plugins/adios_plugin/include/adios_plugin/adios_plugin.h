 ...
 */
#ifndef ADIOS_PLUGIN_H_INCLUDED
#define ADIOS_PLUGIN_H_INCLUDED
...
#ifdef ADIOS_PLUGIN_EXPORTS
#define ADIOS_PLUGIN_API __declspec(dllexport)
#else
#define ADIOS_PLUGIN_API __declspec(dllimport)
#endif
#else /* _WIN32 */
#define ADIOS_PLUGIN_API
#endif /* _WIN32 */
 ...
 */
ADIOS_PLUGIN_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
ADIOS_PLUGIN_API void mmplgReleasePluginInstance(
