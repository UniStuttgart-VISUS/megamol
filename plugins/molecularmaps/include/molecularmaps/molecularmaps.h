 ...
 */
#ifndef MOLECULARMAPS_H_INCLUDED
#define MOLECULARMAPS_H_INCLUDED
...
#ifdef MOLECULARMAPS_EXPORTS
#define MOLECULARMAPS_API __declspec(dllexport)
#else
#define MOLECULARMAPS_API __declspec(dllimport)
#endif
#else /* _WIN32 */
#define MOLECULARMAPS_API
#endif /* _WIN32 */
 ...
 */
MOLECULARMAPS_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
MOLECULARMAPS_API void mmplgReleasePluginInstance(
...
#endif /* MOLECULARMAPS_H_INCLUDED */
