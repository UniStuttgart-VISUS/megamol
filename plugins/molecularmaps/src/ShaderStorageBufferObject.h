...
public:
     ...
     */
    template <typename T> bool init(T* p_data_ptr, GLuint p_data_size, GLenum p_usage, GLuint p_binding);
     ...
     */
    template <typename T> void GetData(T* data_ptr, GLuint p_data_size);
     ...
     * @param p_usage The usage flag of the SSBO
     */
    template <typename T> void SetData(T* p_data_ptr, GLuint p_data_size, GLenum p_usage);
