...
public:
     ...
     * @return Pointer to the vector containing the resulting brightness values per vertex three times in a row. If the
     * method was not successful, it returns a nullptr.
     */
