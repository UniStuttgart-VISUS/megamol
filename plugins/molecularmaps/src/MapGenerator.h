...
public:
     ...
     */
    static const char* ClassName(void) { return "MapGenerator"; }
     ...
     */
    static const char* Description(void) { return "Generates a molecular map out of an incoming triangle mesh"; }
...
private:
     ...
     */
    bool capColouring(megamol::geocalls::CallTriMeshData* p_cap_data_call, megamol::core::view::CallRender3D* p_cr3d,
