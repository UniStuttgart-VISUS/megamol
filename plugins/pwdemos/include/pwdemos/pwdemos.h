 ...
 */
#ifndef PWDEMOS_H_INCLUDED
#define PWDEMOS_H_INCLUDED
...
#ifdef PWDEMOS_EXPORTS
#define PWDEMOS_API __declspec(dllexport)
#else
#define PWDEMOS_API __declspec(dllimport)
#endif
#else /* _WIN32 */
#define PWDEMOS_API
#endif /* _WIN32 */
 ...
 */
PWDEMOS_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
PWDEMOS_API void mmplgReleasePluginInstance(
