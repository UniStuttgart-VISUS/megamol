...
namespace demos {
    ...
    public:
        ...
        public:
            ...
            /** Ctor */
            Cell(void) : bbox(-1.0f, -1.0f, -1.0f, 1.0f, 1.0f, 1.0f), cbox(-1.0f, -1.0f, -1.0f, 1.0f, 1.0f, 1.0f), cnt(0), lists(NULL) {
                // intentionally empty
            }
             ...
             */
            inline void Set(const vislib::math::Cuboid<float>& bbox, const vislib::math::Cuboid<float>& cbox, unsigned int cnt, List* lists) {
                this->bbox = bbox;
                this->cbox = cbox;
                this->cnt = cnt;
                this->lists = lists;
