...
public:
    ...
    static const unsigned int CallForGetSelectedKeyframeAtTime =
        1; // Set animation time of selected keyframe by previously calling SetSelectedKeyframeTime() -> Keyframekeeper returns modified selected keyframe immediately to call.
    static const unsigned int CallForGetInterpolCamPositions = 2; // Call SetInterpolationSteps() before.
    static const unsigned int CallForSetSelectedKeyframe =
        3; // Call SetSelectedKeyframe() befrore. Replaces currently selected keyframe.
    static const unsigned int CallForSetSimulationData =
        4; // Call SetBboxCenter(), SetTotalSimTime() and SetFps() before;
    static const unsigned int CallForSetCameraForKeyframe =
        5; // Call SetCameraState() before. Replaces camera of currently selected keyframe
    static const unsigned int CallForSetDragKeyframe =
        6; // Set animation time of selected keyframe by previously calling SetSelectedKeyframeTime() -> KeyframeKeeper takes selected keyframe as dragged keyframe.
    static const unsigned int CallForSetDropKeyframe =
        7; // Set animation and simulation time of selected keyframe by previously calling SetDropTimes() -> KeyframeKeeper moves keyframe with to drop times.
    ...
    static const char* FunctionName(unsigned int idx) {
        switch (idx) {
        case CallForGetUpdatedKeyframeData:
            return "CallForGetUpdatedKeyframeData";
        case CallForGetInterpolCamPositions:
            return "CallForGetInterpolCamPositions";
        case CallForGetSelectedKeyframeAtTime:
            return "CallForGetSelectedKeyframeAtTime";
        case CallForSetSelectedKeyframe:
            return "CallForSetSelectedKeyframe";
        case CallForSetSimulationData:
            return "CallForSetSimulationData";
        case CallForSetCameraForKeyframe:
            return "CallForSetCameraForKeyframe";
        case CallForSetDragKeyframe:
            return "CallForSetDragKeyframe";
        case CallForSetDropKeyframe:
            return "CallForSetDropKeyframe";
        case CallForSetCtrlPoints:
            return "CallForSetCtrlPoints";
        default:
            return "";
        }
    }
