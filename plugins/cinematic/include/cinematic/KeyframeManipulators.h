...
public:
    ...
    bool UpdateRendering(const std::shared_ptr<std::vector<Keyframe>> keyframes, Keyframe selected_keyframe,
        glm::vec3 first_ctrl_pos, glm::vec3 last_ctrl_pos, core::view::Camera const& camera, glm::vec2 viewport_dim,
        glm::mat4 mvp);
