...
private:
	...
	*/
    static Mat4x4 computeElementTransform(std::tuple<int,int> node_indices,
	...
	static Vec3 computeElementCenter(std::tuple<int, int> node_indices,
		std::vector<Vec3> const& node_positions,
		std::vector<Vec3> const& node_displacements);
    ...
    struct ElementConcept
    {
        ...
        virtual Mat4x4 computeTransform(
            std::vector<Vec3> const& node_positions,
            std::vector<Vec3> const& node_displacements) const = 0;
    ...
    struct ElementModel : ElementConcept
    {
        ...
        Mat4x4 computeTransform(
            std::vector<Vec3> const& node_positions,
            std::vector<Vec3> const& node_displacements) const
		{
