...
{    
    ...
    vec4 offset1 = vec4(normalize(cross(vec3(e01),vec3(e21))),0.0f);
    ...
    colour = vec3(1.0f);
    EmitVertex();
    gl_Position = gl_in[1].gl_Position + e12 * 0.05f + offset2;
    colour = vec3(1.0f);
    EmitVertex();
    gl_Position = gl_in[0].gl_Position + e02 * 0.05f + offset2;
    colour = vec3(1.0f);
    EmitVertex();
    EndPrimitive();
    ...
    colour = vec3(1.0f);
    EmitVertex();
    gl_Position = gl_in[2].gl_Position + e20 * 0.05f + offset0;
    colour = vec3(1.0f);
    EmitVertex();
    gl_Position = gl_in[1].gl_Position + e10 * 0.05f + offset0;
    colour = vec3(1.0f);
    EmitVertex();
    EndPrimitive();
    ...
    colour = vec3(1.0f);
    EmitVertex();
    gl_Position = gl_in[0].gl_Position + e01 * 0.05f + offset1;
    colour = vec3(1.0f);
    EmitVertex();
    gl_Position = gl_in[2].gl_Position + e21 * 0.05f + offset1;
    colour = vec3(1.0f);
    EmitVertex();
    EndPrimitive();
}