...
namespace mesh_gl {
    ...
    bool STLDataSource::get_extent_callback(core::Call& caller) {
        ...
        call.set_bounding_box(vislib::math::Cuboid<float>(datatools_gl::io::STLDataSource::min_x,
            datatools_gl::io::STLDataSource::min_y, datatools_gl::io::STLDataSource::min_z,
            datatools_gl::io::STLDataSource::max_x, datatools_gl::io::STLDataSource::max_y,
            datatools_gl::io::STLDataSource::max_z));
