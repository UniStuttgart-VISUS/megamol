...
/*
 * ext::ExtBezierMeshRenderer::ExtBezierMeshRenderer
 */
ext::ExtBezierMeshRenderer::ExtBezierMeshRenderer(void) : Renderer3DModule(),
    ...
    this->getDataSlot.SetCompatibleCall<ext::ExtBezierDataCallDescription>();
    this->MakeSlotAvailable(&this->getDataSlot);

    this->curveSectionsSlot << new core::param::IntParam(25, 1);
    this->MakeSlotAvailable(&this->curveSectionsSlot);

    this->profileSectionsSlot << new core::param::IntParam(8, 3);
 ...
 * ext::ExtBezierMeshRenderer::~ExtBezierMeshRenderer
 */
ext::ExtBezierMeshRenderer::~ExtBezierMeshRenderer(void) {
    this->Release();
}


/*
 * ext::ExtBezierMeshRenderer::create
 */
bool ext::ExtBezierMeshRenderer::create(void) {
...
/*
 * ext::ExtBezierMeshRenderer::GetCapabilities
 */
bool ext::ExtBezierMeshRenderer::GetCapabilities(megamol::core::Call& call) {
...
/*
 * ext::ExtBezierMeshRenderer::GetExtents
 */
bool ext::ExtBezierMeshRenderer::GetExtents(megamol::core::Call& call) {
    core::view::CallRender3D *cr = dynamic_cast<core::view::CallRender3D*>(&call);
    if (cr == NULL) return false;

    ExtBezierDataCall *ebdc = this->getDataSlot.CallAs<ext::ExtBezierDataCall>();
    if ((ebdc != NULL) && ((*ebdc)(1))) {
...
/*
 * ext::ExtBezierMeshRenderer::release
 */
void ext::ExtBezierMeshRenderer::release(void) {
...
/*
 * ext::ExtBezierMeshRenderer::Render
 */
bool ext::ExtBezierMeshRenderer::Render(megamol::core::Call& call) {
    typedef ext::ExtBezierDataCall::Point Pt;
    ...
    if ((this->objsHash != ebdc->DataHash())
        ...
        unsigned int profileSegs = this->profileSectionsSlot.Param<core::param::IntParam>()->Value();
        if (profileSegs < 3) profileSegs = 3;
        unsigned int lengthSegs = this->curveSectionsSlot.Param<core::param::IntParam>()->Value();
...
/*
 * ext::ExtBezierMeshRenderer::calcBase
 */
void ext::ExtBezierMeshRenderer::calcBase(const vislib::math::BezierCurve<
...
/*
 * ext::ExtBezierMeshRenderer::drawCurves
 */
void ext::ExtBezierMeshRenderer::drawCurves(
        const vislib::math::BezierCurve<ext::ExtBezierDataCall::Point, 3> *curves,
...
/*
 * ext::ExtBezierMeshRenderer::drawEllipCurves
 */
void ext::ExtBezierMeshRenderer::drawEllipCurves(
        const vislib::math::BezierCurve<ext::ExtBezierDataCall::Point, 3> *curves,
...
/*
 * ext::ExtBezierMeshRenderer::drawRectCurves
 */
void ext::ExtBezierMeshRenderer::drawRectCurves(
        const vislib::math::BezierCurve<ext::ExtBezierDataCall::Point, 3> *curves,
