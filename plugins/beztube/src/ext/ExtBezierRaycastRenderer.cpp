...
/*
 * ext::ExtBezierRaycastRenderer::ExtBezierRaycastRenderer
 */
ext::ExtBezierRaycastRenderer::ExtBezierRaycastRenderer(void) : AbstractBezierRenderer(),
        pbEllShader() {
 ...
 * ext::ExtBezierRaycastRenderer::~ExtBezierRaycastRenderer
 */
ext::ExtBezierRaycastRenderer::~ExtBezierRaycastRenderer(void) {
    this->Release();
}


/*
 * ext::ExtBezierRaycastRenderer::create
 */
bool ext::ExtBezierRaycastRenderer::create(void) {
...
/*
 * ext::ExtBezierRaycastRenderer::release
 */
void ext::ExtBezierRaycastRenderer::release(void) {
...
/*
 * ext::ExtBezierRaycastRenderer::render
 */
bool ext::ExtBezierRaycastRenderer::render(megamol::core::view::CallRender3D& call) {
