...
#ifndef MEGAMOL_BEZTUBE_BEZIERCPUMESHRENDERER_H_INCLUDED
#define MEGAMOL_BEZTUBE_BEZIERCPUMESHRENDERER_H_INCLUDED
...
#endif /* MEGAMOL_BEZTUBE_BEZIERCPUMESHRENDERER_H_INCLUDED */
