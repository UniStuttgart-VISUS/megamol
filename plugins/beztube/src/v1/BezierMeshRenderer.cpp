...
/*
 * v1::BezierMeshRenderer::BezierMeshRenderer
 */
v1::BezierMeshRenderer::BezierMeshRenderer(void) : Renderer3DModule(),
 ...
 * v1::BezierMeshRenderer::~BezierMeshRenderer
 */
v1::BezierMeshRenderer::~BezierMeshRenderer(void) {
    this->Release();
}


/*
 * v1::BezierMeshRenderer::create
 */
bool v1::BezierMeshRenderer::create(void) {
...
/*
 * v1::BezierMeshRenderer::GetCapabilities
 */
bool v1::BezierMeshRenderer::GetCapabilities(core::Call& call) {
...
/*
 * v1::BezierMeshRenderer::GetExtents
 */
bool v1::BezierMeshRenderer::GetExtents(core::Call& call) {
    core::view::CallRender3D *cr = dynamic_cast<core::view::CallRender3D*>(&call);
    if (cr == NULL) return false;
...
/*
 * v1::BezierMeshRenderer::release
 */
void v1::BezierMeshRenderer::release(void) {
...
/*
 * v1::BezierMeshRenderer::Render
 */
bool v1::BezierMeshRenderer::Render(core::Call& call) {
    typedef v1::BezierDataCall::BezierPoint Pt;
    ...
    if ((this->objsHash != bdc->DataHash())
        ...
        int curveSegs = this->curveSectionsSlot.Param<core::param::IntParam>()->Value();
        float curveStep = 1.0f / static_cast<float>(curveSegs);
        int profileSegs = this->profileSectionsSlot.Param<core::param::IntParam>()->Value();
        unsigned int profileCnt = profileSegs + 1;
        int capType = this->capTypeSlot.Param<core::param::EnumParam>()->Value();
