...
namespace v1 {
     ...
     * for the curve.
     */
    class BezierDataCall : public core::AbstractGetData3DCall {
    public:
    ...
    typedef core::factories::CallAutoDescription<BezierDataCall> BezierDataCallDescription;
