 ...
 */
#ifndef BEZTUBE_H_INCLUDED
#define BEZTUBE_H_INCLUDED
...
#ifdef BEZTUBE_EXPORTS
#define BEZTUBE_API __declspec(dllexport)
#else
#define BEZTUBE_API __declspec(dllimport)
#endif
#else /* _WIN32 */
#define BEZTUBE_API
#endif /* _WIN32 */
 ...
 */
BEZTUBE_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
BEZTUBE_API void mmplgReleasePluginInstance(
