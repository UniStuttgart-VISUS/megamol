 ...
 * PlyWriter::release
 */
void PlyWriter::release(void) {
}

/*
 * PlyWriter::run
 */
bool PlyWriter::run(void) {
...
/*
 * PlyWriter::getCapabilities
 */
bool PlyWriter::getCapabilities(DataWriterCtrlCall& call) {
