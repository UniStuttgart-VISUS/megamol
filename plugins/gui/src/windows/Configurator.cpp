...
void megamol::gui::Configurator::PopUps() {
    ...
    if (this->file_browser.PopUp_Load("Load Project", project_filename, this->open_popup_load, {"lua"}, megamol::core::param::FilePathParam::Flag_File_RestrictedExtensions)) {
