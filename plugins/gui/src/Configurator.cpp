...
bool megamol::gui::Configurator::Draw(
    ...
    if (core_instance == nullptr) return false;
...
bool megamol::gui::Configurator::OnKey(
    megamol::core::view::Key key, megamol::core::view::KeyAction action, megamol::core::view::Modifiers mods) {
    return false;
}

bool megamol::gui::Configurator::OnChar(unsigned int codePoint) { return false; }

bool megamol::gui::Configurator::OnMouseButton(megamol::core::view::MouseButton button,
    megamol::core::view::MouseButtonAction action, megamol::core::view::Modifiers mods) {
    return false;
}

bool megamol::gui::Configurator::OnMouseMove(double x, double y) { return false; }

bool megamol::gui::Configurator::OnMouseScroll(double dx, double dy) { return false; }

void megamol::gui::Configurator::showModuleList(bool* opened) {}
