        ...
        case (WidgetScope::LOCAL): {
            if (this->IsGUIVisible() || this->gui_extended) {
                ...
                if (this->gui_extended) {
                    ...
                    // Lua
                    Parameter::LuaButton("param_lua_button", (*this), this->full_name, module_fullname);
...
bool megamol::gui::Parameter::OptionButton(const std::string& id, const std::string& label, bool dirty) {
...
bool megamol::gui::Parameter::KnobButton(
...
bool megamol::gui::Parameter::ParameterExtendedModeButton(const std::string& id, bool& inout_extended_mode) {
    ...
    megamol::gui::Parameter::OptionButton("param_mode_button", "Mode");
...
bool megamol::gui::Parameter::LuaButton(const std::string& id, const megamol::gui::Parameter& param,
...
bool megamol::gui::Parameter::widget_knob(
    ...
    if (scope == megamol::gui::Parameter::WidgetScope::LOCAL) {
        ...
        if (Parameter::KnobButton("param_knob", knob_size, value, minval, maxval)) {
            retval = true;
        }
