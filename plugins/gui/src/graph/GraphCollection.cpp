...
bool megamol::gui::GraphCollection::save_graph_dialog(ImGuiID graph_uid, bool& open_dialog) {
    ...
    if (this->gui_file_browser.PopUp_Save("Save Project", project_filename, open_dialog, {"lua"}, megamol::core::param::FilePathParam::Flag_File_RestrictedExtensions, save_gui_state)) {
