 ...
 * 3] Add new case in ParameterPresentation::present_parameter()
 * 4] Add new function widget_...() implementing the new widget to ParameterPresentation and call in case defined in 3]
 */
