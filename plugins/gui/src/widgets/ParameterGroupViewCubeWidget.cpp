...
bool megamol::gui::PickableCube::Draw(unsigned int picking_id, int& inout_selected_face_id,
    ...
    if (this->shader == nullptr) {
        ...
        std::string fragment_src =
            ...
            "                             const in int FACE_FRONT_ID, const in int FACE_BACK_ID, \n"
            "                             const in int FACE_RIGHT_ID, const in int FACE_LEFT_ID, \n"
            "                             const in int FACE_TOP_ID, const in int FACE_BOTTOM_ID, \n"
