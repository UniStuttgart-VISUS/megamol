...
bool megamol::gui::PickableCube::Draw(unsigned int picking_id, int& inout_selected_face_id, int& inout_selected_orientation_id, int& out_hovered_face_id,
    ...
    if (this->shader == nullptr) {
        ...
        std::string fragment_src =
            ...
            "    \n"
            "    if (((id == FACE_FRONT)   && (hovered_id == FACE_FRONT_ID))  || \n"
            ...
            "    } else if (((id == FACE_FRONT)   && (selected_id == FACE_FRONT_ID))  || \n"
            ...
            "    \n"
            "    // Color \n"
            "    if (hovered_alpha > 0.0) out_color = mix(out_color, vec4(highlight_color, 1.0), hovered_alpha); \n"
            "    else if (selected_alpha > 0.0) out_color = mix(out_color, vec4(original_color, 1.0), selected_alpha); \n"
