...
namespace gui {
    ...
    public:
         ...
         */
        bool PopUp_Save(const std::string& label, const std::string& extension, bool& inout_open_popup,
            std::string& inout_filename, vislib::math::Ternary& inout_save_gui_state) {
            return this->popup(
                DIALOGMODE_SAVE, label, extension, inout_open_popup, inout_filename, false, "", inout_save_gui_state);
        }
        bool PopUp_Load(const std::string& label, const std::string& extension, bool& inout_open_popup,
            std::string& inout_filename) {
            auto tmp = vislib::math::Ternary(vislib::math::Ternary::TRI_UNKNOWN);
            return this->popup(DIALOGMODE_LOAD, label, extension, inout_open_popup, inout_filename, false, "", tmp);
        }
        bool PopUp_Select(const std::string& label, const std::string& extension, bool& inout_open_popup,
            std::string& inout_filename, bool force_absolute, const std::string& project_path) {
            auto tmp = vislib::math::Ternary(vislib::math::Ternary::TRI_UNKNOWN);
            return this->popup(DIALOGMODE_SELECT, label, extension, inout_open_popup, inout_filename, force_absolute,
                project_path, tmp);
        }
         ...
         *
         * @param extension        The filterd file extension. Leave emtpy to allow all file extensions.
         ...
         * @return True on success, false otherwise.
         */
        bool Button_Select(const std::string& extension, std::string& inout_filename, bool force_absolute,
    ...
    private:
        ...
        bool popup(DialogMode mode, const std::string& label, const std::string& extension, bool& inout_open_popup,
        ...
        void validate_file(const std::string& file_str, const std::string& extension, DialogMode mode);
