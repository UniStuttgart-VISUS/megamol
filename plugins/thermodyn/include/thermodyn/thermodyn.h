 ...
 */
#ifndef thermodyn_H_INCLUDED
#define thermodyn_H_INCLUDED
...
#ifdef thermodyn_EXPORTS
#define thermodyn_API __declspec(dllexport)
#else
#define thermodyn_API __declspec(dllimport)
#endif
#else /* _WIN32 */
#define thermodyn_API
#endif /* _WIN32 */
 ...
 * @return 200 -- (ver.: 2.00)
 */
thermodyn_API int mmplgPluginAPIVersion(void);
 ...
 */
thermodyn_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
thermodyn_API void mmplgReleasePluginInstance(
