...
class PrepareSurfaceEvents : public core::Module {
public:
    ...
    PrepareSurfaceEvents();

    virtual ~PrepareSurfaceEvents();
...
private:
    ...
    bool assert_data(core::moldyn::MultiParticleDataCall& in_parts, mesh::CallMesh& in_mesh,
    ...
    core::CalleeSlot parts_out_slot_;
