...
class BoxRenderer : public core::view::Renderer3DModule {
public:
    /**
...
private:
    static std::pair<std::vector<float>, std::vector<float>> prepareData(std::vector<BoxDataCall::box_entry_t> const& data) {
