 ...
 */
megamol::stdplugin::volume::BuckyBall::BuckyBall(void) : getDataSlot("getData", "Gets the data"), volRes(64), vol(NULL) {
 ...
 */
bool megamol::stdplugin::volume::BuckyBall::getDataCallback(megamol::core::Call& caller) {
 ...
 */
bool megamol::stdplugin::volume::BuckyBall::getExtentCallback(megamol::core::Call& caller) {
    core::CallVolumeData *cvd = dynamic_cast<core::CallVolumeData*>(&caller);
    if (cvd == NULL) return false;
