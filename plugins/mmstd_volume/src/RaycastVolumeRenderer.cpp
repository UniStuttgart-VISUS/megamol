...
bool RaycastVolumeRenderer::Render(megamol::core::view::CallRender3D_2& cr) {
    ...
    glUniformMatrix4fv(
        compute_shdr->get_uniform_location("view_mx"), 1, GL_FALSE, glm::value_ptr(static_cast<glm::mat4>(view)));
    glUniformMatrix4fv(
        compute_shdr->get_uniform_location("proj_mx"), 1, GL_FALSE, glm::value_ptr(static_cast<glm::mat4>(proj)));
    ...
    if (this->paramOverride.Param<core::param::BoolParam>()->Value()) {
        ...
        glUniform2fv(compute_shdr->get_uniform_location("valRange"), 1, overrideRange.data());
    ...
    glUniform3fv(compute_shdr->get_uniform_location("light"), 1, light.data());
    ...
    glUniform3fv(compute_shdr->get_uniform_location("light_col"), 1,
