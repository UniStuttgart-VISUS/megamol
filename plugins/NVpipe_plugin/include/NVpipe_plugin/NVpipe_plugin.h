 ...
 */
#ifndef NVPIPE_PLUGIN_H_INCLUDED
#define NVPIPE_PLUGIN_H_INCLUDED
...
#ifdef NVPIPE_PLUGIN_EXPORTS
#define NVPIPE_PLUGIN_API __declspec(dllexport)
#else
#define NVPIPE_PLUGIN_API __declspec(dllimport)
#endif
#else /* _WIN32 */
#define NVPIPE_PLUGIN_API
#endif /* _WIN32 */
 ...
 */
NVPIPE_PLUGIN_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
NVPIPE_PLUGIN_API void mmplgReleasePluginInstance(
...
#endif /* NVPIPE_PLUGIN_H_INCLUDED */
