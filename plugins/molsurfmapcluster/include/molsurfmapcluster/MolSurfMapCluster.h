 ...
 */
#ifndef MOLSURFMAPCLUSTER_H_INCLUDED
#define MOLSURFMAPCLUSTER_H_INCLUDED
...
#ifdef MOLSURFMAPCLUSTER_EXPORTS
#define MOLSURFMAPCLUSTER_API __declspec(dllexport)
#else
#define MOLSURFMAPCLUSTER_API __declspec(dllimport)
#endif
#else /* _WIN32 */
#define MOLSURFMAPCLUSTER_API
#endif /* _WIN32 */
 ...
 * @return 200 -- (ver.: 2.00)
 */
MOLSURFMAPCLUSTER_API int mmplgPluginAPIVersion(void);
 ...
 */
MOLSURFMAPCLUSTER_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
MOLSURFMAPCLUSTER_API void mmplgReleasePluginInstance(
...
#endif /* MOLSURFMAPCLUSTER_H_INCLUDED */
