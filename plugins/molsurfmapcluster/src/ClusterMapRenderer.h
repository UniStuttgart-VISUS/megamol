...
class ClusterMapRenderer : public core::view::Renderer2DModule {
public:
    /**
     ...
     */
    static const char* ClassName(void) { return "ClusterMapRenderer"; }
     ...
     */
    static const char* Description(void) { return "Render the Map of a given Clustering"; }
