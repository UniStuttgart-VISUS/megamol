 ...
 */
#ifndef GEOMETRY_CALLS_H_INCLUDED
#define GEOMETRY_CALLS_H_INCLUDED
...
#ifdef GEOMETRY_CALLS_EXPORTS
#define GEOMETRY_CALLS_API __declspec(dllexport)
#else
#define GEOMETRY_CALLS_API __declspec(dllimport)
#endif
#else /* _WIN32 */
#define GEOMETRY_CALLS_API
#endif /* _WIN32 */
 ...
 */
GEOMETRY_CALLS_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
GEOMETRY_CALLS_API void mmplgReleasePluginInstance(
...
#endif /* GEOMETRY_CALLS_H_INCLUDED */
