...
const char ViewSlicing::cubeEdges[12] = {VS_FACE_FRONT + VS_FACE_BOTTOM, VS_FACE_FRONT + VS_FACE_TOP,
    ...
    VS_FACE_FRONT + VS_FACE_RIGHT, VS_FACE_BACK + VS_FACE_LEFT, VS_FACE_BACK + VS_FACE_RIGHT,
    VS_FACE_LEFT + VS_FACE_BOTTOM, VS_FACE_RIGHT + VS_FACE_BOTTOM, VS_FACE_LEFT + VS_FACE_TOP,
    VS_FACE_RIGHT + VS_FACE_TOP};
