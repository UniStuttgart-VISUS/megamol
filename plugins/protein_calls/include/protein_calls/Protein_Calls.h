 ...
 */
#ifndef PROTEIN_CALLS_H_INCLUDED
#define PROTEIN_CALLS_H_INCLUDED
...
#define PROTEIN_CALLS_API __declspec(dllexport)
#else
#define PROTEIN_CALLS_API __declspec(dllimport)
#endif
#else /* _WIN32 */
 ...
 */
PROTEIN_CALLS_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
PROTEIN_CALLS_API void mmplgReleasePluginInstance(
