...
class OSPRayMeshGLGeometry : public AbstractOSPRayStructure {
...
public:
    ...
    /** Dtor. */
    virtual ~OSPRayMeshGLGeometry(void);

    /** Ctor. */
    OSPRayMeshGLGeometry(void);
