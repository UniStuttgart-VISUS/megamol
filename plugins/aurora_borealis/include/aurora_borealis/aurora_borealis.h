 ...
 */
#ifndef AURORA_BOREALIS_H_INCLUDED
#define AURORA_BOREALIS_H_INCLUDED
...
#ifdef AURORA_BOREALIS_EXPORTS
#define AURORA_BOREALIS_API __declspec(dllexport)
#else
#define AURORA_BOREALIS_API __declspec(dllimport)
#endif
#else /* _WIN32 */
#define AURORA_BOREALIS_API
#endif /* _WIN32 */
 ...
 */
AURORA_BOREALIS_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
AURORA_BOREALIS_API void mmplgReleasePluginInstance(
...
#endif /* AURORA_BOREALIS_H_INCLUDED */
