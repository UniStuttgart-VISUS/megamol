...
namespace megamol {
	namespace core {
		namespace misc {
			...
			*/
			class SimulationDataSource : public view::AnimDataModule {
			public:
				...
				*/
				static const char *Description(void) {
					return "Creates data from simulation";
				}
				...
				*/
				...
				/** Ctor. */
				SimulationDataSource(void);

				/** Dtor. */
				virtual ~SimulationDataSource(void);
			...
			private:
				...
				*/
				...
				public:
					...
					*/
					Frame(SimulationDataSource& owner) : view::AnimDataModule::Frame(owner), data(NULL) {
						// intentionally empty
					}
