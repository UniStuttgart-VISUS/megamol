...
AbstractTriMeshDataSource::AbstractTriMeshDataSource(void) : core::Module(),
    ...
    this->getDataSlot.SetCallback(megamol::geocalls_gl::CallTriMeshDataGL::ClassName(), "GetData", &AbstractTriMeshDataSource::getDataCallback);
    this->getDataSlot.SetCallback(megamol::geocalls_gl::CallTriMeshDataGL::ClassName(), "GetExtent", &AbstractTriMeshDataSource::getExtentCallback);
