...
namespace volumetrics {
    ...
    public:
        ...
        bool testFullEnclosing(int enclosingIdx, int enclosedIdx, vislib::Array<vislib::Array<trisoup::volumetrics::Surface*> >& globaIdSurfaces);
    ...
    private:
         ...
         */
        bool doBordersTouch(trisoup::volumetrics::BorderVoxelArray &border1, trisoup::volumetrics::BorderVoxelArray &border2);
         ...
         */
        void appendBox(vislib::RawStorage &data, vislib::math::Cuboid<trisoup::volumetrics::VoxelizerFloat> &b, SIZE_T &offset);
        ...
        bool isSurfaceJoinableWithSubvolume(trisoup::volumetrics::SubJobData *surfJob, int surfIdx, trisoup::volumetrics::SubJobData *volume);
