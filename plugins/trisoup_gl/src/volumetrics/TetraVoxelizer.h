...
namespace volumetrics {
    ...
    public:
        ...
        trisoup::volumetrics::VoxelizerFloat GetOffset(trisoup::volumetrics::VoxelizerFloat fValue1, trisoup::volumetrics::VoxelizerFloat fValue2, trisoup::volumetrics::VoxelizerFloat fValueDesired);

        void growSurfaceFromTriangle(trisoup::volumetrics::FatVoxel *theVolume, unsigned int x, unsigned int y, unsigned int z,
                             unsigned seedTriIndex, trisoup::volumetrics::Surface &surf);

        /**
         * also does compute fullFaces
         */
        trisoup::volumetrics::VoxelizerFloat growVolume(trisoup::volumetrics::FatVoxel *theVolume, trisoup::volumetrics::Surface& surf,
    ...
    private:
        ...
        void ProcessTriangle(vislib::math::ShallowShallowTriangle<trisoup::volumetrics::VoxelizerFloat, 3> &sstI,
            trisoup::volumetrics::FatVoxel &f, unsigned triIdx, trisoup::volumetrics::Surface &surf,
