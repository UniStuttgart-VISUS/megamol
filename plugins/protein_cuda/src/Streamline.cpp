...
void Streamline::IntegrateRK4(
    Vec3f start, VecField3f& v, unsigned int maxLength, float step, float eps, Direction dir) {
    ...
    if (this->vertexArr.Count() > 0) {
        ...
        this->startPos.Set(this->vertexArr[0], this->vertexArr[1], this->vertexArr[2]);

        //printf("Bla4\n");
        this->endPos.Set(this->vertexArr[this->vertexArr.Count() - 3], this->vertexArr[this->vertexArr.Count() - 2],
