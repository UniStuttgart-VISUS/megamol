 ...
 *      $Revision: 1.6 $        $Date: 2020/02/26 19:26:47 $
 *
 ***************************************************************************/
/**
 * \file CUDASort.h
 * \brief High-level CUDA sorting functions (wrapping CUB, Thrust, etc).
 */
...
template<typename KeyT, typename ValT>
int dev_radix_sort_by_key(KeyT* keys_d, ValT* vals_d, long nitems, KeyT* keyswork_d, ValT* valswork_d, void* sortwork_d,
    long tsz, KeyT min_key, KeyT max_key);
