...
#ifndef MMPROTEINCUDAPLUGIN_QUICKSURFRENDERER_H_INCLUDED
#define MMPROTEINCUDAPLUGIN_QUICKSURFRENDERER_H_INCLUDED
...
class QuickSurfRenderer : public megamol::core_gl::view::Renderer3DModuleGL {
public:
    /**
    ...
    /** Ctor. */
    QuickSurfRenderer(void);

    /** Dtor. */
    virtual ~QuickSurfRenderer(void);
...
protected:
     ...
     * @return
     */
    int calcSurf(megamol::protein_calls::MolecularDataCall* mol, float* posInter, int quality, float radscale,
        float gridspacing, float isoval, bool useCol, bool sortTriangles = false);
...
#endif // MMPROTEINCUDAPLUGIN_QUICKSURFRENDERER_H_INCLUDED
