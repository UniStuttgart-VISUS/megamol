...
bool ParticleWorker::create(void) {
    ...
    if (!this->GetCoreInstance()->ShaderSourceFactory().MakeShaderSource(
            "::particleWorkerCompute::work_on_clusters", compSrc)) {
    ...
    {
        Log::DefaultLog.WriteMsg( Log::LEVEL_ERROR, "%s: Unable to load compute shader source for grid shader",
    ...
    e.GetMsgA() ); return false;
    }
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    if( !this->GetCoreInstance()->ShaderSourceFactory().MakeShaderSource( "::particleWorkerCompute::griddify", compSrc )
    )
    {
        Log::DefaultLog.WriteMsg( Log::LEVEL_ERROR, "%s: Unable to load compute shader source for griddify shader",
    this->ClassName() ); return false;
    }
    try
    {
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    if( !this->GetCoreInstance()->ShaderSourceFactory().MakeShaderSource( "::particleWorkerCompute::initParticlelist",
    compSrc ) )
    {
        Log::DefaultLog.WriteMsg( Log::LEVEL_ERROR, "%s: Unable to load compute shader source for initParticlelist
    shader", this->ClassName() ); return false;
    }
    try
    {
    ...
    this->ClassName(), e.GetMsgA() ); return false;
    }
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    if( !this->GetCoreInstance()->ShaderSourceFactory().MakeShaderSource( "::particleWorkerCompute::makeParticleList",
    compSrc ) )
    {
        Log::DefaultLog.WriteMsg( Log::LEVEL_ERROR, "%s: Unable to load compute shader source for makeParticleList
    shader", this->ClassName() ); return false;
    }
    try
    {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    if( !this->GetCoreInstance()->ShaderSourceFactory().MakeShaderSource(
    "::particleWorkerCompute::compactToClusterList", compSrc ) )
    {
        Log::DefaultLog.WriteMsg( Log::LEVEL_ERROR, "%s: Unable to load compute shader source for compactToClusterList
    shader", this->ClassName() ); return false;
    }
    try
    {
    ...
    {
        Log::DefaultLog.WriteMsg( Log::LEVEL_ERROR, "%s: Unable to load compute shader source for prefixSum shader",
    this->ClassName() ); return false;
    }
    compSrc.Insert(1,
    this->GetCoreInstance()->ShaderSourceFactory().MakeShaderSnippet("::particleWorkerCompute::prefix_type_float")); try
    {
