...
// RAUS!   this->protDataCallerSlot.SetCompatibleCall<CallProteinDataDescription>();
// RAUS!   this->protDataCallerSlot.SetCompatibleCall<CallVolumeDataDescription>();
 ...
 *
bool protein::SolventVolumeRenderer::RenderProteinData( view::CallRender3D *call, CallProteinData *protein) {
 ...
 *
bool protein::SolventVolumeRenderer::RenderVolumeData( view::CallRender3D *call, CallVolumeData *volume) {
    // try to call
    if( !(*volume)() ) return false;
...
/*
 * protein::SolventVolumeRenderer::ProcessFrameRequest
 *
bool protein::SolventVolumeRenderer::ProcessFrameRequest ( Call& call )
{
    // get pointer to CallProteinData
 ...
 *
void protein::SolventVolumeRenderer::UpdateVolumeTexture( const CallProteinData *protein) {
 ...
 *
void protein::SolventVolumeRenderer::UpdateVolumeTexture( const CallVolumeData *volume) {
    // generate volume, if necessary
    if( !glIsTexture( this->volumeTex) ) {
        glGenTextures( 1, &this->volumeTex);
    }
 ...
 */
#if 0
void protein::SolventVolumeRenderer::RenderVolume( const CallVolumeData *volume) {
 ...
 * write the parameters of the ray to the textures
 *
void protein::SolventVolumeRenderer::RayParamTextures( const CallVolumeData *volume) {
