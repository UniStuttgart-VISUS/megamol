...
#ifndef MEGAMOL_MOLSURFACERENDERERCONTOURBUILDUP_CUDA_H_INCLUDED
#define MEGAMOL_MOLSURFACERENDERERCONTOURBUILDUP_CUDA_H_INCLUDED
#if (_MSC_VER > 1000)
#pragma once
#endif /* (_MSC_VER > 1000) */
...
namespace protein {
	 ...
	 */
	class ProteinRendererCBCUDA : public megamol::core::view::Renderer3DModule
	{
	public:
		...
		/** ctor */
		ProteinRendererCBCUDA(void);
		
		/** dtor */
		virtual ~ProteinRendererCBCUDA(void);
