...
/*
 * moldyn::SphereDataUnifier::SphereDataUnifier
 */
moldyn::SphereDataUnifier::SphereDataUnifier(void) : Module(),
 ...
 * moldyn::SphereDataUnifier::~SphereDataUnifier
 */
moldyn::SphereDataUnifier::~SphereDataUnifier(void) {
    this->Release();
}


/*
 * moldyn::SphereDataUnifier::create
 */
bool moldyn::SphereDataUnifier::create(void) {
    return true;
}


/*
 * moldyn::SphereDataUnifier::release
 */
void moldyn::SphereDataUnifier::release(void) {
    // intentionally empty
}


/*
 * moldyn::SphereDataUnifier::getDataCallback
 */
bool moldyn::SphereDataUnifier::getDataCallback(Call& caller) {
...
/*
 * moldyn::SphereDataUnifier::getExtentCallback
 */
bool moldyn::SphereDataUnifier::getExtentCallback(Call& caller) {
    MultiParticleDataCall *inCall = dynamic_cast<MultiParticleDataCall*>(&caller);
    if (inCall == NULL) return false;
...
/*
 * moldyn::SphereDataUnifier::accumExt
 */
void moldyn::SphereDataUnifier::accumExt(bool& first, float x, float y, float z, float r) {
