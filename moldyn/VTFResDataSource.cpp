...
/*
 * moldyn::VTFResDataSource::Frame::Frame
 */

moldyn::VTFResDataSource::Frame::Frame(view::AnimDataModule& owner)
...
/*
 * moldyn::VTFResDataSource::Frame::Clear
 */
void moldyn::VTFResDataSource::Frame::Clear(void) {
...
/*
 * moldyn::VTFResDataSource::Frame::LoadFrame
 */
bool moldyn::VTFResDataSource::Frame::LoadFrame(vislib::sys::File *file, unsigned int idx, vislib::Array<SimpleType> &types) {
...
/*
 * moldyn::VTFResDataSource::Frame::PartPoss
 */
const float *moldyn::VTFResDataSource::Frame::PartPoss(unsigned int type) const {
    ASSERT(type < this->typeCnt);
    return this->pos[type].As<float>();
}

/*
 * moldyn::VTFResDataSource::Frame::PartCols
 */
const float *moldyn::VTFResDataSource::Frame::PartCols(unsigned int type) const {
    ASSERT(type < this->typeCnt);
    return this->col[type].As<float>();
}

/*
 * moldyn::VTFResDataSource::Frame::UpdatePartColor
 */
void moldyn::VTFResDataSource::Frame::UpdatePartColor(unsigned int type, unsigned int idx, vislib::math::Vector<float,4> color)
{
...
/*
 * moldyn::VTFResDataSource::Frame::SizeOf
 */
SIZE_T moldyn::VTFResDataSource::Frame::SizeOf(void) const {
    SIZE_T size = 0;
    for (unsigned int i = 0; i < this->typeCnt; i++) {
...
/*
 * moldyn::VTFResDataSource::Frame::MakeInterpolationFrame
 */
const moldyn::VTFResDataSource::Frame *
moldyn::VTFResDataSource::Frame::MakeInterpolationFrame(float alpha,
        const moldyn::VTFResDataSource::Frame &a,
        const moldyn::VTFResDataSource::Frame &b) {
...
/*
 * moldyn::VTFResDataSource::Frame::parseParticleLine
 */
void moldyn::VTFResDataSource::Frame::parseParticleLine(vislib::StringA &line,
...
/*
 * moldyn::VTFResDataSource::Frame::SetTypeCount
 */
void moldyn::VTFResDataSource::Frame::SetTypeCount(unsigned int cnt) {
	this->Clear();
	this->typeCnt = cnt;
...
void moldyn::VTFResDataSource::Frame::initParticleGrid(unsigned int N1, unsigned int N2, unsigned int N3)
{
...
vislib::Array<int> &moldyn::VTFResDataSource::Frame::particleGridCell(unsigned int N1, unsigned int N2, unsigned int N3)
{
 ...
 * moldyn::VTFResDataSource::~VTFResDataSource
 */
moldyn::VTFResDataSource::~VTFResDataSource(void) {
    this->Release(); // implicitly calls 'release'
}


/*
 * moldyn::VTFResDataSource::constructFrame
 */
view::AnimDataModule::Frame*
moldyn::VTFResDataSource::constructFrame(void) const {
    Frame *f = new Frame(*const_cast<moldyn::VTFResDataSource*>(this));
    f->SetTypeCount((unsigned int)this->types.Count());
    return f;
}

/*
 * moldyn::VTFResDataSource::create
 */
bool moldyn::VTFResDataSource::create(void) {
    return true;
}


/*
 * moldyn::VTFResDataSource::loadFrame
 */
void moldyn::VTFResDataSource::loadFrame(view::AnimDataModule::Frame *frame, unsigned int idx) {
...
void moldyn::VTFResDataSource::preprocessFrame(Frame &frame)
{
	unsigned int N = 20;
...
/*
 * moldyn::VTFResDataSource::release
 */
void moldyn::VTFResDataSource::release(void) {
...
/*
 * moldyn::VTFResDataSource::filenameChanged
 */
bool moldyn::VTFResDataSource::filenameChanged(param::ParamSlot& slot) {
...
/*
 * moldyn::VTFResDataSource::readHeader
 *
bool moldyn::VTFResDataSource::parseHeaderAndFrameIndices(const vislib::TString& filename) {
...
/*
 * moldyn::VTFResDataSource::getDataCallback
 */
bool moldyn::VTFResDataSource::getDataCallback(Call& caller) {
...
/*
 * moldyn::VTFResDataSource::getExtentCallback
 */
bool moldyn::VTFResDataSource::getExtentCallback(Call& caller) {
    MultiParticleDataCall *c2 = dynamic_cast<MultiParticleDataCall*>(&caller);
    float border = 0.0f;
