 ...
 */
moldyn::SimpleSphereRenderer::SimpleSphereRenderer(void) : Renderer3DModule(),
...
/*
 * moldyn::SimpleSphereRenderer::GetCapabilities
 */
bool moldyn::SimpleSphereRenderer::GetCapabilities(Call& call) {
...
/*
 * moldyn::SimpleSphereRenderer::GetExtents
 */
bool moldyn::SimpleSphereRenderer::GetExtents(Call& call) {
    view::CallRender3D *cr = dynamic_cast<view::CallRender3D*>(&call);
    if (cr == NULL) return false;
