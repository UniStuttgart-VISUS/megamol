/*
 * CallProteinMovementData.h
 *
 * Copyright (C) 2009 by Universitaet Stuttgart (VIS). 
 * Alle Rechte vorbehalten.
 */

#ifndef MEGAMOLCORE_CALLPROTEINMOVEMENTDATA_H_INCLUDED
#define MEGAMOLCORE_CALLPROTEINMOVEMENTDATA_H_INCLUDED
...
namespace protein {
    ...
    class CallProteinMovementData : public megamol::core::Call {
    public:
        ...
        static const char *ClassName(void) {
            return "CallProteinMovementData";
        }
        ...
        static const char *Description(void) {
            return "Call to get protein movement data";
        }
        ...
        public:
             ...
             */
            CallProteinMovementData::AminoAcid& AccessAminoAcid(
                unsigned int idx);
             ...
             */
            CallProteinMovementData::SecStructure& AccessSecondaryStructure(
                unsigned int idx);
             ...
             */
            inline const CallProteinMovementData::AminoAcid * AminoAcid(void) 
                    const {
            ...
            void SetAminoAcid(unsigned int cnt,
                const CallProteinMovementData::AminoAcid* aminoAcids);
            ...
            void SetSecondaryStructure(unsigned int cnt,
                const CallProteinMovementData::SecStructure* structs);
        ...
        private:
             ...
             */
            CallProteinMovementData::AminoAcid *aminoAcid;
             ...
             */
            CallProteinMovementData::SecStructure *secStruct;
        ...
        /** Ctor. */
        CallProteinMovementData(void);

        /** Dtor. */
        virtual ~CallProteinMovementData(void);
        ...
        /**
         * Allocates space for the moved atom positions for the protein atoms.
         * The number of protein atoms must first be set using
         * 'SetProteinAtomCount'.
         */
        void AllocateProteinAtomMovementPositions(void);
        ...
        /**
         * Returns a pointer to the moved positions of the protein atoms. Points
         * to 'ProteinAtomCount' times 3 floats holding the data layouted
         * xyzxyz... The pointer points to the internal memory structure. The
         * caller must not free or alter the memory returned.
         *
         * @return A pointer to the moved positions of the protein atoms.
         */
        inline const float * ProteinAtomMovementPositions(void) const {
            return this->protAtomMovementPos;
        }
        ...
        /**
         * Sets the moved position for one atom of the protein. You mut not call
         * this method if the interface is not owner of the position memory.
         *
         * @param idx The index of the atom to be set.
         * @param x   The x component of the atoms position.
         * @param y   The y component of the atoms position.
         * @param z   The z component of the atoms position.
         */
        void SetProteinAtomMovementPosition(unsigned int idx, float x, float y,
            float z);
        ...
        /**
         * Sets a pointer to an array of floats to be used through this
         * interface of the positions of the moved protein atoms. The memory
         * pointed to will remain owned by the caller and the caller must
         * ensure it remains valid as long as it is* used through this
         * interface. The array must be of sufficient size compare to the
         * number of atoms which should be set earlier using
         * 'SetProteinAtomCount'. The float array must be layouted 'xyzxyz...'
         *
         * @param pos Pointer to an array of float to be used as protein atom
         *            positions.
         */
        void SetProteinAtomMovementPositionPointer(float *pos);
        ...
        /**
         * Sets the maximum movement distance of the data set.
         *
         * @param dist The distance.
         */
        inline void SetMaxMovementDistance( float dist) {
            this->maxMovementDist = dist;
        }

        /**
         * Get the maximum movement distance of the data set.
         *
         * @return The distance.
         */
        inline float GetMaxMovementDistance(void) const {
            return this->maxMovementDist;
        }
    ...
    private:
        ...
        /**
         * Pointer to the movement information of the atoms of the proteins.
         * Must point to '3 * protAtomCnt' floats layouted x,y,z,x,y,z, ...
         */
        float *protAtomMovementPos;
        ...
        /**
         * Flag whether or not the interface owns the memory of the moved
         * position array of the protein.
         */
        bool protMovedPosMemory;
    ...
    typedef megamol::core::CallAutoDescription<CallProteinMovementData> CallProteinMovementDataDescription;


} /* end namespace protein */
} /* end namespace megamol */

#endif /* MEGAMOLCORE_CALLPROTEINMOVEMENTDATA_H_INCLUDED */
