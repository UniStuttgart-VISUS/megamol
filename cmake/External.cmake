...
#
# Builds and includes an external file, as generated by install(EXPORT ...)
# and to be used by find_package(...).
#
# include_external_config(<config> DEPENDS <external_project>)
function(include_external_config CONFIG)
  cmake_parse_arguments(args "" "DEPENDS" "" ${ARGN})
 
   if(NOT args_DEPENDS)
     message(FATAL_ERROR "Missing external project for ${CONFIG} to depend on")
   endif()
  _argument_default(DEPENDS "")
 
  ExternalProject_Get_Property(${DEPENDS} INSTALL_DIR)
  set(CONFIG_PATH  "${INSTALL_DIR}/${CONFIG}")
  set(TARGET_RERUN "${DEPENDS}_rerun")
  
  if(EXISTS ${CONFIG_PATH})
    # Include the configuration file build by the re-run target.
    add_custom_target(${TARGET_RERUN})
    include(${CONFIG_PATH})
  else()
    # Add a re-run target for building the configuration.
    add_custom_target(${TARGET_RERUN} ${CMAKE_COMMAND} ${CMAKE_SOURCE_DIR} DEPENDS ${DEPENDS})
  endif()
endfunction(include_external_config)
