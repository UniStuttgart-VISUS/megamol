...
function(fetch_external NAME TARGET ACTIVATED_OPTIONS DEACTIVATED_OPTIONS HIDDEN_OPTIONS)
  ...
  # Store and then clear compile flags
  set(MM_CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS})
  set(MM_CMAKE_CXX_FLAGS_DEBUG ${CMAKE_CXX_FLAGS_DEBUG})
  set(MM_CMAKE_CXX_FLAGS_RELEASE ${CMAKE_CXX_FLAGS_RELEASE})
  set(MM_CMAKE_CXX_FLAGS_RELWITHDEBINFO ${CMAKE_CXX_FLAGS_RELWITHDEBINFO})
  set(MM_CMAKE_CXX_FLAGS_MINSIZEREL ${CMAKE_CXX_FLAGS_MINSIZEREL})
  ...
  set(MM_CMAKE_C_FLAGS ${CMAKE_C_FLAGS})
  set(MM_CMAKE_C_FLAGS_DEBUG ${CMAKE_C_FLAGS_DEBUG})
  set(MM_CMAKE_C_FLAGS_RELEASE ${CMAKE_C_FLAGS_RELEASE})
  set(MM_CMAKE_C_FLAGS_RELWITHDEBINFO ${CMAKE_C_FLAGS_RELWITHDEBINFO})
  set(MM_CMAKE_C_FLAGS_MINSIZEREL ${CMAKE_C_FLAGS_MINSIZEREL})
  ...
  # Restore compile flags
  set(CMAKE_CXX_FLAGS ${MM_CMAKE_CXX_FLAGS})
  set(CMAKE_CXX_FLAGS_DEBUG ${MM_CMAKE_CXX_FLAGS_DEBUG})
  set(CMAKE_CXX_FLAGS_RELEASE ${MM_CMAKE_CXX_FLAGS_RELEASE})
  set(CMAKE_CXX_FLAGS_RELWITHDEBINFO ${MM_CMAKE_CXX_FLAGS_RELWITHDEBINFO})
  set(CMAKE_CXX_FLAGS_MINSIZEREL ${MM_CMAKE_CXX_FLAGS_MINSIZEREL})

  set(CMAKE_C_FLAGS ${MM_CMAKE_C_FLAGS})
  set(CMAKE_C_FLAGS_DEBUG ${MM_CMAKE_C_FLAGS_DEBUG})
  set(CMAKE_C_FLAGS_RELEASE ${MM_CMAKE_C_FLAGS_RELEASE})
  set(CMAKE_C_FLAGS_RELWITHDEBINFO ${MM_CMAKE_C_FLAGS_RELWITHDEBINFO})
  set(CMAKE_C_FLAGS_MINSIZEREL ${MM_CMAKE_C_FLAGS_MINSIZEREL})
