...
function(add_external_library TARGET LINKAGE)
  ...
  external_get_property(${DEPENDS} INSTALL_DIR)
  ...
  if(MULTICONFIG)
    ...
    set(INSTALL_DIR_RELWITHDEBINFO ${INSTALL_DIR}/RelWithDebInfo)
  else()
    set(INSTALL_DIR_DEBUG ${INSTALL_DIR})
    set(INSTALL_DIR_RELEASE ${INSTALL_DIR})
    set(INSTALL_DIR_RELWITHDEBINFO ${INSTALL_DIR})
  endif()
