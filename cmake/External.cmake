...
function(_cmake_args_propagate VARIABLE)
  set(ARGS "CMAKE_GENERATOR;${CMAKE_GENERATOR};-DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}")
...
function(fetch_external NAME TARGET ACTIVATED_OPTIONS DEACTIVATED_OPTIONS HIDDEN_OPTIONS)
  ...
  message(STATUS "Requesting external '${NAME}' with '${OPTIONS}' ...")
  ...
  add_subdirectory(${${lcName}_ext_SOURCE_DIR} ${${lcName}_ext_BINARY_DIR})
  unset(ADDING_EXTERNAL)

  if(TARGET ${TARGET})
    message(STATUS "  ... successfully spawned")
