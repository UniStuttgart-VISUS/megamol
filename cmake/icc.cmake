...
if(UNIX)
    ...
    set(INTEL_OPTIMIZATION_FLAGS "/Ob2 /O3 /Oi /Qparallel /GA")
    ...
    set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "${COMMON_CXX_FLAGS} /MD /DNDEBUG /D_NDEBUG ${INTEL_OPTIMIZATION_FLAGS} /Zi /Qopt-report:1 /Qguide:1" CACHE STRING "" FORCE)
