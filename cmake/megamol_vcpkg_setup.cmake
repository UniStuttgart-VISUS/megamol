...
# List of all features in MegaMol vcpkg.json
file(READ "${CMAKE_CURRENT_SOURCE_DIR}/vcpkg.json" vcpkg_json)
string(JSON features_json GET "${vcpkg_json}" "features")
string(JSON length LENGTH "${features_json}")
math(EXPR length "${length} - 1")
set(MEGAMOL_VCPKG_FEATURES "")
foreach (idx RANGE 0 ${length})
  string(JSON member MEMBER "${features_json}" ${idx})
  list(APPEND MEGAMOL_VCPKG_FEATURES "${member}")
endforeach ()
