 ...
 */
vislib_gl::graphics::gl::OpenGLException::OpenGLException(const GLenum errorCode, 
 ...
 * vislib_gl::graphics::gl::OpenGLException::OpenGLException
 */
vislib_gl::graphics::gl::OpenGLException::OpenGLException(const char *file, 
        const int line)
 ...
 */
vislib_gl::graphics::gl::OpenGLException& 
vislib_gl::graphics::gl::OpenGLException::operator =(const OpenGLException& rhs) {
