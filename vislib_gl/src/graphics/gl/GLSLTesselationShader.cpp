 ...
 */
const char * 
vislib_gl::graphics::gl::GLSLTesselationShader::RequiredExtensions(void) {
 ...
 */
const char *
vislib_gl::graphics::gl::GLSLTesselationShader::GPU5_EXTENSION_DIRECTIVE =
 ...
 * vislib_gl::graphics::gl::GLSLTesselationShader::Compile
 */
bool vislib_gl::graphics::gl::GLSLTesselationShader::Compile(
 ...
 */
bool vislib_gl::graphics::gl::GLSLTesselationShader::CompileFromFile(
 ...
 */
void vislib_gl::graphics::gl::GLSLTesselationShader::SetProgramParameter(GLenum name,
        GLint value) {
