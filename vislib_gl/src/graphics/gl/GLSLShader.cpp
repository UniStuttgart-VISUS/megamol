 ...
 */
const char *vislib_gl::graphics::gl::GLSLShader::FTRANSFORM_VERTEX_SHADER_SRC =
    "void main() { "
 ...
 */
GLenum vislib_gl::graphics::gl::GLSLShader::BindAttribute(GLint index, 
        const char *name) {
    USES_GL_VERIFY;
 ...
 */
bool vislib_gl::graphics::gl::GLSLShader::Compile(const char *vertexShaderSrc, 
 ...
 */
bool vislib_gl::graphics::gl::GLSLShader::Create(const char *vertexShaderSrc, 
                                              const char *fragmentShaderSrc) {
 ...
 */
bool vislib_gl::graphics::gl::GLSLShader::CreateFromFile(
        const char *vertexShaderFile, const char *fragmentShaderFile) {
 ...
 */
GLenum vislib_gl::graphics::gl::GLSLShader::SetParameter(const GLint name,
        const float v1) {
    USES_GL_VERIFY;
    ASSERT(GLSLShader::IsValidHandle(this->hProgObj));
 ...
 */
GLenum vislib_gl::graphics::gl::GLSLShader::SetParameterArray1(const GLint name,
 ...
 */
GLenum vislib_gl::graphics::gl::GLSLShader::SetParameterArray2(const GLint name,
        const GLsizei count, const float *value) {
    USES_GL_VERIFY;
    ASSERT(GLSLShader::IsValidHandle(this->hProgObj));
 ...
 */
GLenum vislib_gl::graphics::gl::GLSLShader::SetParameterArray3(const GLint name,
        const GLsizei count, const float *value) {
    USES_GL_VERIFY;
    ASSERT(GLSLShader::IsValidHandle(this->hProgObj));
 ...
 */
GLenum vislib_gl::graphics::gl::GLSLShader::SetParameterArray4(const GLint name,
        const GLsizei count, const float *value) {
    USES_GL_VERIFY;
    ASSERT(GLSLShader::IsValidHandle(this->hProgObj));
 ...
 */
GLhandleARB vislib_gl::graphics::gl::GLSLShader::compileNewShader(GLenum type, 
 ...
 */
vislib::StringA vislib_gl::graphics::gl::GLSLShader::getProgramInfoLog(
    GLhandleARB hProg) {
    USES_GL_VERIFY;
    GLint len = 0;
    GLint written = 0;
 ...
 */
vislib::StringA vislib_gl::graphics::gl::GLSLShader::getShaderInfoLog(
        GLhandleARB hShader) {
    USES_GL_VERIFY;
    GLint len = 0;
    GLint written = 0;
