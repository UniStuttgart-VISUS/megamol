...
vislib_gl::graphics::gl::FramebufferObject::~FramebufferObject(void) {
    try {
        ...
        VLTRACE(vislib::Trace::LEVEL_VL_WARN, "\"%s\" at line %d in \"%s\" when "
 ...
 */
GLenum vislib_gl::graphics::gl::FramebufferObject::BindColourTexture(
        const UINT which) {
    USES_GL_VERIFY;
    ...
    if (which < this->cntColourAttachments) {
        ...
        throw vislib::OutOfRangeException(which, 0, this->cntColourAttachments, 
            __FILE__, __LINE__);
    }
 ...
 */
bool vislib_gl::graphics::gl::FramebufferObject::Create(const UINT width, 
 ...
 */
GLenum vislib_gl::graphics::gl::FramebufferObject::Enable(
    ...
    try {
        ...
        VLTRACE(vislib::Trace::LEVEL_VL_ERROR, "Could not save OpenGL state before "
            "enabling FBO (\"%s\").\n", e.GetMsgA());
    ...
    if (this->cntColourAttachments < 1) {
        ...
        throw vislib::OutOfRangeException(colourAttachment, 0, 
 ...
 */
GLenum vislib_gl::graphics::gl::FramebufferObject::EnableMultiple(
 ...
 */
GLuint vislib_gl::graphics::gl::FramebufferObject::GetColourTextureID(
...
vislib_gl::graphics::gl::FramebufferObject::FramebufferObject(
    ...
    throw vislib::UnsupportedOperationException("FramebufferObject::FramebufferObject", 
        __FILE__, __LINE__);
}
 ...
 */
void vislib_gl::graphics::gl::FramebufferObject::createRenderbuffer(
 ...
 */
void vislib_gl::graphics::gl::FramebufferObject::createTexture(GLuint& outID,
...
bool vislib_gl::graphics::gl::FramebufferObject::isComplete(void) const {
    ...
    switch (status) {
        ...
        default:
            VLTRACE(vislib::Trace::LEVEL_ERROR, "The framebuffer object is not complete "
                "(%u).\n", status);
            return false;
            /* Unreachable. */
    }
 ...
 */
GLenum vislib_gl::graphics::gl::FramebufferObject::readTexture(void *outData, 
 ...
 */
vislib_gl::graphics::gl::FramebufferObject& 
vislib_gl::graphics::gl::FramebufferObject::operator =(
        const FramebufferObject& rhs) {
    if (this != &rhs) {
