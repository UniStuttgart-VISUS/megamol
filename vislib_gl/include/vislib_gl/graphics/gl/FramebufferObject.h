...
public:
     ...
     */
    bool Create(const UINT width, const UINT height, const UINT cntColourAttachments, const ColourAttachParams* cap,
     ...
     *                         the format of one of the buffers is invalid.
     */
    inline bool Create(const UINT width, const UINT height, const GLenum colourInternalFormat = GL_RGBA8,
        const GLenum colourFormat = GL_RGBA, const GLenum colourType = GL_UNSIGNED_BYTE,
        const AttachmentState depthAttach = ATTACHMENT_RENDERBUFFER, const GLenum depthFormat = GL_DEPTH_COMPONENT24,
        const AttachmentState stencilAttach = ATTACHMENT_DISABLED, const GLenum stencilFormat = GL_STENCIL_INDEX) {
     ...
     */
    inline GLenum DrawColourTexture(const UINT colourAttachment = 0, const GLint minFilter = GL_LINEAR,
        const GLint magFilter = GL_LINEAR, const double depth = 0.5) const {
        return this->drawTexture(this->GetColourTextureID(colourAttachment), minFilter, magFilter, depth);
    }
     ...
     */
    inline GLenum DrawDepthTexture(
        const GLint minFilter = GL_LINEAR, const GLint magFilter = GL_LINEAR, const double depth = 0.5) const {
        return this->drawTexture(this->GetDepthTextureID(), minFilter, magFilter, depth);
    }
     ...
     */
    GLenum EnableMultipleV(UINT cntColourAttachments, const UINT* colourAttachments);
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    inline GLenum GetColourTexture(void* outData, const UINT colourAttachment = 0, const GLenum format = GL_RGBA,
        const GLenum type = GL_UNSIGNED_BYTE) {
        return this->readTexture(outData, this->GetColourTextureID(colourAttachment), format, type);
    }
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    inline GLenum GetDepthTexture(void* outData, const GLenum format = GL_RGBA, const GLenum type = GL_UNSIGNED_BYTE) {
        return this->readTexture(outData, this->GetDepthTextureID(), format, type);
    }
...
private:
     ...
     * @throws OpenGLException In case of an error
     */
    void createTexture(GLuint& outID, const GLenum internalFormat, const GLenum format, const GLenum type) const;
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    GLenum drawTexture(const GLuint id, const GLint minFilter, const GLint magFilter, const double depth) const;
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    GLenum readTexture(void* outData, const GLuint id, const GLenum format, const GLenum type);
