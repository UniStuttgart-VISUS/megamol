...
public:
     ...
     */
    class CompileException : public vislib::Exception {
    ...
    public:
         ...
         * @param line The line the exception was thrown in.
         */
        CompileException(const char* msg, const char* file, const int line);
         ...
         * @param line The line the exception was thrown in.
         */
        CompileException(const wchar_t* msg, const char* file, const int line);
         ...
         * @param line The line the exception was thrown in.
         */
        CompileException(const char* msg, CompileAction action, const char* file, const int line);
         ...
         * @param line The line the exception was thrown in.
         */
        CompileException(const wchar_t* msg, CompileAction action, const char* file, const int line);
