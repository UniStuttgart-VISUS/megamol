...
public:
     ...
     */
    virtual GLenum SetParameter(
        const GLuint name, const double v1, const double v2 = 0.0, const double v3 = 0.0, const double v4 = 0.0);
     ...
     */
    virtual GLenum SetParameter(
        const GLuint name, const float v1, const float v2 = 0.0f, const float v3 = 0.0f, const float v4 = 0.0f);
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    inline GLenum SetParameter(const GLuint name, const int v1, const int v2 = 0, const int v3 = 0, const int v4 = 0) {
        return this->SetParameter(
            name, static_cast<double>(v1), static_cast<double>(v2), static_cast<double>(v3), static_cast<double>(v4));
    }
