 ...
 * the font
 */
class OutlineFont : public vislib::graphics::AbstractFont {
public:
     ...
     * @param flipY The vertical flip flag
     */
    OutlineFont(const OutlineFontInfo& ofi, RenderType render, bool flipY);
     ...
     * @param render The render type to be used
     */
    OutlineFont(const OutlineFontInfo& ofi, float size, RenderType render);
     ...
     * @param flipY The vertical flip flag
     */
    OutlineFont(const OutlineFontInfo& ofi, float size, RenderType render, bool flipY);
...
private:
     ...
     */
    VISLIB_FORCEINLINE int* buildGlyphRun(const char* txt, float maxWidth) const;
     ...
     * @return The resulting glyph run
     */
    VISLIB_FORCEINLINE int* buildGlyphRun(const wchar_t* txt, float maxWidth) const;
     ...
     */
    void drawFilled(int* run, float x, float y, float z, float size, bool flipY, Alignment align) const;
     ...
     * @param align The alignment
     */
    void drawOutline(int* run, float x, float y, float z, float size, bool flipY, Alignment align) const;
