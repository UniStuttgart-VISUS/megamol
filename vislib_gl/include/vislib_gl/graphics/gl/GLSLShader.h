...
public:
     ...
     *                         fails.
     */
    virtual bool Compile(const char* vertexShaderSrc, const char* fragmentShaderSrc);
     ...
     *                         fails.
     */
    virtual bool Compile(const char** vertexShaderSrc, const SIZE_T cntVertexShaderSrc, const char** fragmentShaderSrc,
        const SIZE_T cntFragmentShaderSrc, bool insertLineDirective = true);
     ...
     *                         file failed.
     */
    virtual bool CompileFromFile(const char* vertexShaderFile, const char* fragmentShaderFile);
     ...
     *                         file failed.
     */
    virtual bool CompileFromFile(const char** vertexShaderFiles, const SIZE_T cntVertexShaderFiles,
        const char** fragmentShaderFiles, const SIZE_T cntFragmentShaderFiles, bool insertLineDirective = true);
     ...
     *                         fails.
     */
    virtual bool Create(const char* vertexShaderSrc, const char* fragmentShaderSrc);
     ...
     *                         fails.
     */
    virtual bool Create(const char** vertexShaderSrc, const SIZE_T cntVertexShaderSrc, const char** fragmentShaderSrc,
        const SIZE_T cntFragmentShaderSrc, bool insertLineDirective = true);
     ...
     *                         file failed.
     */
    virtual bool CreateFromFile(const char* vertexShaderFile, const char* fragmentShaderFile);
     ...
     *                         file failed.
     */
    virtual bool CreateFromFile(const char** vertexShaderFiles, const SIZE_T cntVertexShaderFiles,
        const char** fragmentShaderFiles, const SIZE_T cntFragmentShaderFiles, bool insertLineDirective = true);
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameter(const char* name, const float v1, const float v2) {
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameter(const char* name, const float v1, const float v2, const float v3) {
        return this->SetParameter(this->ParameterLocation(name), v1, v2, v3);
    }
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameter(const char* name, const float v1, const float v2, const float v3, const float v4) {
        return this->SetParameter(this->ParameterLocation(name), v1, v2, v3, v4);
    }
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameter(const char* name, const int v1, const int v2) {
        return this->SetParameter(this->ParameterLocation(name), v1, v2);
    }
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameter(const char* name, const int v1, const int v2, const int v3) {
        return this->SetParameter(this->ParameterLocation(name), v1, v2, v3);
    }
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameter(const char* name, const int v1, const int v2, const int v3, const int v4) {
        return this->SetParameter(this->ParameterLocation(name), v1, v2, v3, v4);
    }
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameter(const GLint name, const float v1, const float v2);
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameter(const GLint name, const float v1, const float v2, const float v3);
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameter(const GLint name, const float v1, const float v2, const float v3, const float v4);
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameter(const GLint name, const int v1, const int v2);
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameter(const GLint name, const int v1, const int v2, const int v3);
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameter(const GLint name, const int v1, const int v2, const int v3, const int v4);
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameterArray1(const char* name, const GLsizei count, const float* value) {
        return this->SetParameterArray1(this->ParameterLocation(name), count, value);
    }
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameterArray2(const char* name, const GLsizei count, const float* value) {
        return this->SetParameterArray2(this->ParameterLocation(name), count, value);
    }
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameterArray3(const char* name, const GLsizei count, const float* value) {
        return this->SetParameterArray3(this->ParameterLocation(name), count, value);
    }
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameterArray4(const char* name, const GLsizei count, const float* value) {
        return this->SetParameterArray4(this->ParameterLocation(name), count, value);
    }
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameterArray1(const char* name, const GLsizei count, const int* value) {
        return this->SetParameterArray1(this->ParameterLocation(name), count, value);
    }
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameterArray2(const char* name, const GLsizei count, const int* value) {
        return this->SetParameterArray2(this->ParameterLocation(name), count, value);
    }
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameterArray3(const char* name, const GLsizei count, const int* value) {
        return this->SetParameterArray3(this->ParameterLocation(name), count, value);
    }
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameterArray4(const char* name, const GLsizei count, const int* value) {
        return this->SetParameterArray4(this->ParameterLocation(name), count, value);
    }
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameterArray1(const GLint name, const GLsizei count, const float* value);
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameterArray2(const GLint name, const GLsizei count, const float* value);
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameterArray3(const GLint name, const GLsizei count, const float* value);
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameterArray4(const GLint name, const GLsizei count, const float* value);
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameterArray1(const GLint name, const GLsizei count, const int* value);
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameterArray2(const GLint name, const GLsizei count, const int* value);
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameterArray3(const GLint name, const GLsizei count, const int* value);
     ...
     * @return GL_NO_ERROR in case of success, an error code otherwise.
     */
    virtual GLenum SetParameterArray4(const GLint name, const GLsizei count, const int* value);
...
protected:
     ...
     */
    GLhandleARB compileNewShader(GLenum type, const char** src, GLsizei cnt, bool insertLineDirective);
     ...
     *                         program.
     */
    static vislib::StringA getProgramInfoLog(GLhandleARB hProg);
     ...
     *                         valid shader object.
     */
    static vislib::StringA getShaderInfoLog(GLhandleARB hShader);
