...
public:
    ...
    virtual bool Compile(
        const char** computeShaderSrc, const SIZE_T cntComputeShaderSrc, bool insertLineDirective = true);
    ...
    virtual bool CompileFromFile(
        const char** computeShaderFiles, const SIZE_T cntComputeShaderFiles, bool insertLineDirective = true);
