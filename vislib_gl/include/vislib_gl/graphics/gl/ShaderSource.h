...
public:
     ...
     */
    const vislib::SmartPtr<Snippet>& Append(const vislib::SmartPtr<Snippet>& code);
     ...
     * @throw IllegalParamException if code is <NULL>.
     */
    const vislib::SmartPtr<Snippet>& Append(const vislib::StringA& name, const vislib::SmartPtr<Snippet>& code);
     ...
     *                            [0, this->Count()[.
     */
    const vislib::SmartPtr<Snippet>& Insert(const SIZE_T idx, const vislib::SmartPtr<Snippet>& code);
     ...
     *                            [0, this->Count()[.
     */
    const vislib::SmartPtr<Snippet>& Insert(
        const SIZE_T idx, const vislib::StringA& name, const vislib::SmartPtr<Snippet>& code);
     ...
     * @throw IllegalParamException if code is <NULL>.
     */
    const vislib::SmartPtr<Snippet>& Prepend(const vislib::SmartPtr<Snippet>& code);
     ...
     * @throw IllegalParamException if code is <NULL>.
     */
    const vislib::SmartPtr<Snippet>& Prepend(const vislib::StringA& name, const vislib::SmartPtr<Snippet>& code);
     ...
     */
    vislib::SmartPtr<Snippet> Replace(SIZE_T idx, const vislib::SmartPtr<Snippet>& code);
     ...
     * @throw IllegalParamException if code is <NULL>.
     */
    const vislib::SmartPtr<Snippet>& Set(const vislib::SmartPtr<Snippet>& code);
