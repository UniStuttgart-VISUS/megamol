 ...
 */
const char *megamol::core::view::Call6DofInteraction::FunctionName(
        unsigned int idx) {
...
bool megamol::core::view::Call6DofInteraction::IsValid(void) const {
	bool retval = ((this->orientation.X() != 0)
 ...
 */
void megamol::core::view::Call6DofInteraction::SetButtonState(
		const int button, const bool isDown) {
