...
public:
     ...
     */
    virtual const vislib::graphics::SceneSpaceCuboid& BoundingBox(void) const = 0;
     ...
     */
    inline const vislib::graphics::SceneSpaceVector3D& OffsetVector(void) const {
     ...
     */
    inline void SetOffsetVector(const vislib::graphics::SceneSpaceVector3D& off) {
        this->offsetVec = off;
    }
