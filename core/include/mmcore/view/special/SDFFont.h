...
#ifndef MEGAMOL_OUTLINEGLYPHINFO_STRUCT
#define MEGAMOL_OUTLINEGLYPHINFO_STRUCT

    typedef struct _sdfglyphinfo_t {
...
#endif /* MEGAMOL_OUTLINEGLYPHINFO_STRUCT */

#ifndef MEGAMOL_OUTLINEFONTINFO_STRUCT
#define MEGAMOL_OUTLINEFONTINFO_STRUCT

    /**
     * Utility structure storing the data of font glyph outlines
     */
    typedef struct _sdffontinfo_t {
        ...
        const SDFGlyphInfo *glyph; /* The glyph data, sorted acending
                                          according to 'utf8char' */
        const short *glyphIndex; /* The glyph search index */
    } SDFFontInfo;

#endif /* MEGAMOL_OUTLINEFONTINFO_STRUCT */
    ...
    public:
         ...
         */
        SDFFont(const SDFFontInfo& ofi, RenderType render);
         ...
         */
        SDFFont(const SDFFontInfo& ofi, float size);
         ...
         */
        SDFFont(const SDFFontInfo& ofi, bool flipY);
         ...
         * @param flipY The vertical flip flag
         */
        SDFFont(const SDFFontInfo& ofi, float size, bool flipY);
