 ...
 */
class MEGAMOLCORE_API AbstractViewGL : public Module, public megamol::frontend_resources::AbstractInputScope {
...
public:
    ...
    public:
         ...
         */
        virtual void BeforeRender(AbstractViewGL* view) {
            // intentionally empty
        }
         ...
         * @param view The calling view
         */
        virtual void AfterRender(AbstractViewGL* view) {
            // intentionally empty
        }
    };
