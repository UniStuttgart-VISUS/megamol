...
public:
     ...
     */
    void Register(description_ptr_type objDesc, bool allowReplacement = false);
 ...
 */
template <class T> ObjectDescriptionManager<T>::ObjectDescriptionManager(void) : descriptions() {
    // intentionally empty
}
 ...
 * ObjectDescriptionManager::~ObjectDescriptionManager
 */
template <class T> ObjectDescriptionManager<T>::~ObjectDescriptionManager(void) { this->descriptions.clear(); }
 ...
 */
template <class T>
typename ObjectDescriptionManager<T>::description_iterator_type ObjectDescriptionManager<T>::begin(void) {
 ...
 */
template <class T>
typename ObjectDescriptionManager<T>::description_iterator_type ObjectDescriptionManager<T>::end(void) {
 ...
 */
template <class T>
typename ObjectDescriptionManager<T>::description_const_iterator_type ObjectDescriptionManager<T>::begin(void) const {
    return this->descriptions.begin();
}
 ...
 */
template <class T>
typename ObjectDescriptionManager<T>::description_const_iterator_type ObjectDescriptionManager<T>::end(void) const {
    return this->descriptions.end();
}
 ...
 * ObjectDescriptionManager<T>::Register
 */
template <class T> void ObjectDescriptionManager<T>::Register(description_ptr_type objDesc, bool allowReplacement) {
 ...
 */
template <class T> void ObjectDescriptionManager<T>::Unregister(const char* classname) {
    vislib::StringA nameA(classname);
 ...
 */
template <class T> unsigned int ObjectDescriptionManager<T>::Count(void) const {
 ...
 */
template <class T> void ObjectDescriptionManager<T>::Shutdown(void) { this->descriptions.clear(); }
