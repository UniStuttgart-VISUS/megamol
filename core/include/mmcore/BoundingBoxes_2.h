...
public:
     ...
     */
    inline void SetBoundingBox(const float& left, const float& bottom, const float& back, const float& right,
     ...
     * @param top    The y-coordinate of the right/top/front point.
     */
    inline void SetBoundingBox(const float& left, const float& bottom, const float& right, const float& top) {
     ...
     * @param front  The z-coordinate of the right/top/front point.
     */
    inline void SetClipBox(const float& left, const float& bottom, const float& back, const float& right,
        const float& top, const float& front) {
     ...
     * @param front  The z-coordinate of the right/top/front point.
     */
    inline void SetClipBox(const float& left, const float& bottom, const float& right, const float& top) {
