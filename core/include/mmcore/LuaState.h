...
private:
    ...
    bool getView(const std::string routine, const char* viewName, core::ViewInstance** out);

    // TODO: possibly not needed
    bool getJob(const std::string routine, const char* jobName, core::JobInstance** out);
