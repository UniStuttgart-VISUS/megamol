...
public:
    ...
    inline void DrawString(
        const float col[4], float x, float y, const char* txt, Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, this->size, this->flipY, txt, align);
    }
     ...
     */
    inline void DrawString(
        const float col[4], float x, float y, const vislib::StringA& txt, Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, this->size, this->flipY, txt.PeekBuffer(), align);
    }
     ...
     */
    inline void DrawString(const float col[4], float x, float y, float w, float h, const char* txt,
        Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, w, h, this->size, this->flipY, txt, align);
    }
     ...
     * @param align The alignment of the text inside the area.
     */
    inline void DrawString(const float col[4], float x, float y, float w, float h, const vislib::StringA& txt,
        Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, w, h, this->size, this->flipY, txt.PeekBuffer(), align);
    }
     ...
     * @param align The alignment of the text.
     */
    inline void DrawString(const float col[4], float x, float y, float size, const vislib::StringA& txt,
        Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, size, this->flipY, txt.PeekBuffer(), align);
    }
     ...
     */
    inline void DrawString(
        const float col[4], float x, float y, float size, const char* txt, Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, size, this->flipY, txt, align);
    }
     ...
     * @param align The alignment of the text inside the area.
     */
    inline void DrawString(const float col[4], float x, float y, float w, float h, float size,
        const vislib::StringA& txt, Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, w, h, size, this->flipY, txt.PeekBuffer(), align);
    }
     ...
     * @param align The alignment of the text inside the area.
     */
    inline void DrawString(const float col[4], float x, float y, float w, float h, float size, const char* txt,
        Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, w, h, size, this->flipY, txt, align);
    }
     ...
     */
    inline void DrawString(
        const float col[4], float x, float y, bool flipY, const char* txt, Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, this->size, flipY, txt, align);
    }
     ...
     * @param align The alignment of the text.
     */
    inline void DrawString(const float col[4], float x, float y, bool flipY, const vislib::StringA& txt,
        Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, this->size, flipY, txt.PeekBuffer(), align);
    }
     ...
     * @param align The alignment of the text inside the area.
     */
    inline void DrawString(const float col[4], float x, float y, float w, float h, bool flipY, const char* txt,
        Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, w, h, this->size, flipY, txt, align);
    }
     ...
     * @param align The alignment of the text inside the area.
     */
    inline void DrawString(const float col[4], float x, float y, float w, float h, bool flipY,
        const vislib::StringA& txt, Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, w, h, this->size, flipY, txt, align);
    }
     ...
     * @param align The alignment of the text.
     */
    inline void DrawString(const float col[4], float x, float y, float size, bool flipY, const vislib::StringA& txt,
        Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, size, flipY, txt.PeekBuffer(), align);
    }
     ...
     * @param align The alignment of the text.
     */
    virtual void DrawString(const float col[4], float x, float y, float size, bool flipY, const char* txt,
        Alignment align = ALIGN_LEFT_TOP) const = 0;
     ...
     * @param align The alignment of the text inside the area.
     */
    inline void DrawString(const float col[4], float x, float y, float w, float h, float size, bool flipY,
        const vislib::StringA& txt, Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, w, h, size, flipY, txt.PeekBuffer(), align);
    }
     ...
     * @param align The alignment of the text inside the area.
     */
    virtual void DrawString(const float col[4], float x, float y, float w, float h, float size, bool flipY,
     ...
     */
    inline void DrawString(
        const float col[4], float x, float y, const wchar_t* txt, Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, this->size, this->flipY, txt, align);
    }
     ...
     */
    inline void DrawString(
        const float col[4], float x, float y, const vislib::StringW& txt, Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, this->size, this->flipY, txt.PeekBuffer(), align);
    }
     ...
     * @param align The alignment of the text inside the area.
     */
    inline void DrawString(const float col[4], float x, float y, float w, float h, const wchar_t* txt,
        Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, w, h, this->size, this->flipY, txt, align);
    }
     ...
     * @param align The alignment of the text inside the area.
     */
    inline void DrawString(const float col[4], float x, float y, float w, float h, const vislib::StringW& txt,
        Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, w, h, this->size, this->flipY, txt.PeekBuffer(), align);
    }
     ...
     * @param align The alignment of the text.
     */
    inline void DrawString(const float col[4], float x, float y, float size, const vislib::StringW& txt,
        Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, size, this->flipY, txt.PeekBuffer(), align);
    }
     ...
     */
    inline void DrawString(
        const float col[4], float x, float y, float size, const wchar_t* txt, Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, size, this->flipY, txt, align);
    }
     ...
     */
    inline void DrawString(const float col[4], float x, float y, float w, float h, float size,
        const vislib::StringW& txt, Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, w, h, size, this->flipY, txt.PeekBuffer(), align);
    }
     ...
     * @param align The alignment of the text inside the area.
     */
    inline void DrawString(const float col[4], float x, float y, float w, float h, float size, const wchar_t* txt,
        Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, w, h, size, this->flipY, txt, align);
    }
     ...
     */
    inline void DrawString(
        const float col[4], float x, float y, bool flipY, const wchar_t* txt, Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, this->size, flipY, txt, align);
    }
     ...
     * @param align The alignment of the text.
     */
    inline void DrawString(const float col[4], float x, float y, bool flipY, const vislib::StringW& txt,
        Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, this->size, flipY, txt.PeekBuffer(), align);
    }
     ...
     * @param align The alignment of the text inside the area.
     */
    inline void DrawString(const float col[4], float x, float y, float w, float h, bool flipY, const wchar_t* txt,
        Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, w, h, this->size, flipY, txt, align);
    }
     ...
     * @param align The alignment of the text.
     */
    inline void DrawString(const float col[4], float x, float y, float size, bool flipY, const vislib::StringW& txt,
        Alignment align = ALIGN_LEFT_TOP) const {
        this->DrawString(col, x, y, size, flipY, txt.PeekBuffer(), align);
    }
     ...
     * @param align The alignment of the text.
     */
    virtual void DrawString(const float col[4], float x, float y, float size, bool flipY, const wchar_t* txt,
        Alignment align = ALIGN_LEFT_TOP) const = 0;
