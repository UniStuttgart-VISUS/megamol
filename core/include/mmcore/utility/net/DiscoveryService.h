...
private:
    ...
    public:
         ...
         */
        PeerNode(const IPEndPoint& discoveryAddress, const IPEndPoint& responseAddress, const UINT cntResponseChances,
...
public:
    ...
    public:
         ...
         */
        DiscoveryConfig(
            const IPEndPoint& responseAddress, const IPAddress& bcastAddress, const USHORT bindPort = DEFAULT_PORT);
         ...
         */
        DiscoveryConfig(
            const IPEndPoint& responseAddress, const IPAddress6& bcastAddress, const USHORT bindPort = DEFAULT_PORT);
         ...
         *                        this port.
         */
        DiscoveryConfig(const IPEndPoint& responseAddress, const IPAgnosticAddress& bcastAddress,
         ...
         */
        DiscoveryConfig(const IPEndPoint& responseAddress, const USHORT bindPort = DEFAULT_PORT);
     ...
     * trailing zero.
     */
    static const SIZE_T MAX_NAME_LEN = MAX_USER_DATA - sizeof(struct sockaddr_storage);
     ...
     */
    UINT SendUserMessage(const UINT32 msgType, const void* msgBody, const SIZE_T msgSize);
     ...
     *                               or 'msgSize' > MAX_USER_DATA.
     */
    UINT SendUserMessage(const PeerHandle& hPeer, const UINT32 msgType, const void* msgBody, const SIZE_T msgSize);
     ...
     *                         available.
     */
    virtual void Start(const char* name, const DiscoveryConfig* configs, const SIZE_T cntConfigs,
        const UINT cntExpectedNodes = 0, const UINT32 flags = 0, const UINT requestInterval = DEFAULT_REQUEST_INTERVAL,
...
private:
    ...
    typedef SingleLinkedList<DiscoveryListener*, vislib::sys::CriticalSection> ListenerList;
     ...
     *                               or 'msgSize' > MAX_USER_DATA.
     */
    void prepareUserMessage(Message& outMsg, const UINT32 msgType, const void* msgBody, const SIZE_T msgSize);
