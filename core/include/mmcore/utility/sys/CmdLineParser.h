...
public:
    ...
    public:
        ...
        private:
            /** private ctor */
            ValueDesc(ValueType type) : name(), description(), type(type), next(NULL) {
         ...
         */
        inline Option(const Char shortName, const Char* longName = NULL, const Char* description = NULL,
            Flags flags = FLAG_NULL, ValueDesc* valueList = NULL) {
            this->initObject(shortName, longName, description, flags, valueList);
        }
         ...
         *                  option directly in the command line.
         */
        inline Option(const Char shortName, const String<T>& longName, const Char* description = NULL,
            Flags flags = FLAG_NULL, ValueDesc* valueList = NULL) {
            this->initObject(shortName, longName.PeekBuffer(), description, flags, valueList);
        }
         ...
         *                  option directly in the command line.
         */
        inline Option(const Char shortName, const Char* longName, const String<T>& description, Flags flags = FLAG_NULL,
            ValueDesc* valueList = NULL) {
            this->initObject(shortName, longName, description.PeekBuffer(), flags, valueList);
        }
         ...
         *                  option directly in the command line.
         */
        inline Option(const Char shortName, const String<T>& longName, const String<T>& description = NULL,
            Flags flags = FLAG_NULL, ValueDesc* valueList = NULL) {
            this->initObject(shortName, longName.PeekBuffer(), description.PeekBuffer(), flags, valueList);
        }
         ...
         *                  option directly in the command line.
         */
        inline Option(const Char* longName = NULL, const Char* description = NULL, Flags flags = FLAG_NULL,
            ValueDesc* valueList = NULL) {
            this->initObject(static_cast<Char>(0), longName, description, flags, valueList);
        }
         ...
         *                  option directly in the command line.
         */
        inline Option(const String<T>& longName, const Char* description = NULL, Flags flags = FLAG_NULL,
            ValueDesc* valueList = NULL) {
            this->initObject(static_cast<Char>(0), longName.PeekBuffer(), description, flags, valueList);
        }
         ...
         */
        inline Option(
            const Char* longName, const String<T>& description, Flags flags = FLAG_NULL, ValueDesc* valueList = NULL) {
            this->initObject(static_cast<Char>(0), longName, description.PeekBuffer(), flags, valueList);
        }
         ...
         *                  option directly in the command line.
         */
        inline Option(const String<T>& longName, const String<T>& description = NULL, Flags flags = FLAG_NULL,
            ValueDesc* valueList = NULL) {
            this->initObject(static_cast<Char>(0), longName.PeekBuffer(), description.PeekBuffer(), flags, valueList);
        }
         ...
         *                  option directly in the command line.
         */
        inline Option(const Char shortName, const Char* longName, const Char* description, int flags,
            ValueDesc* valueList = NULL) {
            this->initObject(shortName, longName, description, static_cast<Flags>(flags), valueList);
        }
         ...
         *                  option directly in the command line.
         */
        inline Option(const Char shortName, const String<T>& longName, const Char* description, int flags,
            ValueDesc* valueList = NULL) {
            this->initObject(shortName, longName.PeekBuffer(), description, static_cast<Flags>(flags), valueList);
        }
         ...
         *                  option directly in the command line.
         */
        inline Option(const Char shortName, const Char* longName, const String<T>& description, int flags,
            ValueDesc* valueList = NULL) {
            this->initObject(shortName, longName, description.PeekBuffer(), static_cast<Flags>(flags), valueList);
        }
         ...
         *                  option directly in the command line.
         */
        inline Option(const Char shortName, const String<T>& longName, const String<T>& description, int flags,
            ValueDesc* valueList = NULL) {
            this->initObject(
                shortName, longName.PeekBuffer(), description.PeekBuffer(), static_cast<Flags>(flags), valueList);
        }
         ...
         *                  option directly in the command line.
         */
        inline Option(const Char* longName, const Char* description, int flags, ValueDesc* valueList = NULL) {
            this->initObject(static_cast<Char>(0), longName, description, static_cast<Flags>(flags), valueList);
        }
         ...
         *                  option directly in the command line.
         */
        inline Option(const String<T>& longName, const Char* description, int flags, ValueDesc* valueList = NULL) {
            this->initObject(
                static_cast<Char>(0), longName.PeekBuffer(), description, static_cast<Flags>(flags), valueList);
        }
         ...
         *                  option directly in the command line.
         */
        inline Option(const Char* longName, const String<T>& description, int flags, ValueDesc* valueList = NULL) {
            this->initObject(
                static_cast<Char>(0), longName, description.PeekBuffer(), static_cast<Flags>(flags), valueList);
        }
         ...
         *                  option directly in the command line.
         */
        inline Option(const String<T>& longName, const String<T>& description, int flags, ValueDesc* valueList = NULL) {
            this->initObject(static_cast<Char>(0), longName.PeekBuffer(), description.PeekBuffer(),
        ...
        inline bool operator==(const Option& rhs) const {
            return (this->shortName == rhs.shortName) && (this->longName == rhs.longName);
        }
    ...
    private:
         ...
         */
        void initObject(
            const Char shortName, const Char* longName, const Char* description, Flags flags, ValueDesc* valueList);
...
public:
    ...
    public:
        ...
        static const char* GetErrorString(ErrorCode errorcode) {
            ...
            case MISSPLACED_EXCLUSIVE_OPTION:
                retval = "An exclusive option was mixed up with other options. The exclusive option must be specified "
                         "as first parameter.";
                break;
            case UNKNOWN:
                // no break
    ...
    public:
        ...
        enum WarnCode { NONE = 0, UNKNOWN_SHORT_NAMES, UNIQUE_OPTION_MORE_THEN_ONCE, UNKNOWN };
...
unsigned int CmdLineParser<T>::Option::ValueDesc::Count(void) const {
    unsigned int i = 0;
    for (const ValueDesc* t = this; t != NULL; t = t->next) {
        i++;
    }
    return i;
}
 ...
 */
template<class T>
const typename CmdLineParser<T>::Option::ValueDesc& CmdLineParser<T>::Option::ValueDesc::element(unsigned int i) const {
 ...
 */
template<class T>
void CmdLineParser<T>::Option::initObject(
    const Char shortName, const Char* longName, const Char* description, Flags flags, ValueDesc* valueList) {
    this->parser = NULL;
 ...
 */
template<class T>
typename CmdLineParser<T>::Argument* CmdLineParser<T>::Option::GetNextOccurrence(
...
CmdLineParser<T>::Argument::Argument(void)
        ...
        , argid(0)
        , pos(0)
        , type(CmdLineParser<T>::Argument::TYPE_UNKNOWN)
        , option(NULL)
        , selected(false)
        , valueArg(NULL)
        , valueType(CmdLineParser<T>::Option::NO_VALUE) {}
 ...
 */
template<class T>
typename CmdLineParser<T>::OptionDescIterator& CmdLineParser<T>::OptionDescIterator::operator=(
    const OptionDescIterator& rhs) {
    if (this != &rhs) {
...
CmdLineParser<T>::OptionDescIterator::OptionDescIterator(OptionPtrList& opts, bool withValues)
        : formatter(withValues ? 3 : 2)
        , output(NULL)
        , withValues(withValues) {
    this->options = &opts;
    this->formatter.SetSeparator(vislib::String<T>(static_cast<Char>(' '), withValues ? 1 : 2));
    UINT consoleWidth = megamol::core::utility::log::Console::GetWidth();
    if (consoleWidth > 0) {
 ...
 */
template<class T>
CmdLineParser<T>::CmdLineParser() : arglist(NULL)
                                  , arglistSize(0) {}
...
void CmdLineParser<T>::AddOption(const Option* opt) {
    if ((opt == NULL) || ((opt->parser != NULL) && (opt->parser != this)) ||
        (this->FindOption(opt->shortName) != NULL) || (this->FindOption(opt->longName) != NULL) ||
...
const typename CmdLineParser<T>::Option* CmdLineParser<T>::FindOption(const Char* longname) const {
    ...
    while (it.HasNext()) {
        Option* o = it.Next();
        if (!o->longName.IsEmpty() && o->longName.Equals(longname, false))
            return o;
    }
    ...
    for (int i = includeFirstArgument ? 0 : 1; i < argc; i++) {
                ...
                if (opt->longName.Equals(&argv[i][2], false)) {
                    ...
                    if (opt->firstArg == NULL) {
                        ...
                        if (opt->unique) { // a secound encounter of a unique option!
                            ...
                            this->arglist[this->arglistSize].type =
                                Argument::TYPE_UNKNOWN; // because this is gonna be ignored!
        ...
        case Argument::TYPE_OPTION_VALUE: {
            ...
            for (int j = this->arglistSize - 1; j >= 0; j--) {
                ...
                if (this->arglist[j].type != Argument::TYPE_OPTION_VALUE)
                    break;
            }
            ...
            if ((optIdx < 0) || (this->arglistSize > optIdx + this->arglist[optIdx].option->GetValueCount())) {
                ...
                case Option::INT_VALUE:
                    ...
                    } catch (...) { this->arglist[this->arglistSize].valueType = Option::NO_VALUE; }
                    break;
                ...
                case Option::INT_OR_STRING_VALUE:
                    try {
                        T::ParseInt(argv[i]);
                        this->arglist[this->arglistSize].valueType = Option::INT_VALUE;
                    } catch (...) { this->arglist[this->arglistSize].valueType = Option::STRING_VALUE; }
                    break;
                ...
                if (this->arglist[this->arglistSize].valueType == Option::NO_VALUE) {
                    ...
                    if ((this->arglist[optIdx].option) &&
                        (this->arglist[optIdx].option->firstArg == &this->arglist[optIdx])) {
 ...
 */
template<class T>
typename CmdLineParser<T>::OptionPtrList CmdLineParser<T>::ListMissingRequiredOptions(void) {
