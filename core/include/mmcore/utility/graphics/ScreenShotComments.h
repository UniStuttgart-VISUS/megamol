...
namespace graphics {
    ...
    public:
         ...
         */
        ScreenShotComments(megamol::core::MegaMolGraph_Serialization const& serialization, const std::optional<comments_storage_map> &additional_comments = std::nullopt);
