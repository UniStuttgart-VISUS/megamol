...
public:
     ...
     * Load textures.
     */
    static bool LoadTextureFromFile(std::shared_ptr<glowl::Texture2D>& out_texture_ptr, const std::string& filename, GLint tex_min_filter = GL_NEAREST, GLint tex_max_filter = GL_LINEAR);
    static bool LoadTextureFromFile(std::shared_ptr<glowl::Texture2D>& out_texture_ptr, const std::wstring& filename, GLint tex_min_filter = GL_NEAREST, GLint tex_max_filter = GL_LINEAR) {
    ...
    static bool LoadTextureFromData(
        std::shared_ptr<glowl::Texture2D>& out_texture_ptr, int width, int height, float* data, GLint tex_min_filter = GL_NEAREST, GLint tex_max_filter = GL_LINEAR);
