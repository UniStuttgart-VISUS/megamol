 ...
 */
static vislib::graphics::BitmapCodecCollection __vl_bitmapcodeccollection_defcol
 ...
 * vislib::graphics::BitmapCodecCollection::BitmapCodecCollection
 */
vislib::graphics::BitmapCodecCollection::BitmapCodecCollection(const vislib::graphics::BitmapCodecCollection& src)
        : codecs(src.codecs) {
    // intentionally empty
}
 ...
 */
bool vislib::graphics::BitmapCodecCollection::LoadBitmapImage(BitmapImage& outImg, const vislib::StringA& filename) {
    vislib::sys::File f;
    ...
    SIZE_T adsize = 0;
    vislib::SmartPtr<char, vislib::ArrayAllocator<char>> admem = new char[MAX_AD_SIZE];
    adsize = static_cast<SIZE_T>(f.Read(admem.operator->(), static_cast<vislib::sys::File::FileSize>(MAX_AD_SIZE)));
    f.Close();
    ...
    for (unsigned int pass = 0; pass < 2; pass++) {
        ...
        CodecArray sure;
        CodecArray unsure;
        this->autodetecCodec(admem.operator->(), adsize, codecs, sure, unsure);
 ...
 * vislib::graphics::BitmapCodecCollection::LoadBitmapImage
 */
bool vislib::graphics::BitmapCodecCollection::LoadBitmapImage(BitmapImage& outImg, const vislib::StringW& filename) {
    vislib::sys::File f;
 ...
 * vislib::graphics::BitmapCodecCollection::LoadBitmapImage
 */
bool vislib::graphics::BitmapCodecCollection::LoadBitmapImage(BitmapImage& outImg, vislib::sys::File& file) {
 ...
 * vislib::graphics::BitmapCodecCollection::LoadBitmapImage
 */
bool vislib::graphics::BitmapCodecCollection::LoadBitmapImage(BitmapImage& outImg, const void* mem, SIZE_T size) {
...
void vislib::graphics::BitmapCodecCollection::selectCodecsByFilename(
    const vislib::StringA& filename, vislib::graphics::BitmapCodecCollection::CodecArray& outCodecs) const {
    outCodecs.Clear();
    for (SIZE_T i = 0; i < this->codecs.Count(); i++) {
 ...
 */
void vislib::graphics::BitmapCodecCollection::selectCodecsByFilename(
    const vislib::StringW& filename, vislib::graphics::BitmapCodecCollection::CodecArray& outCodecs) const {
    outCodecs.Clear();
    for (SIZE_T i = 0; i < this->codecs.Count(); i++) {
 ...
 */
void vislib::graphics::BitmapCodecCollection::autodetecCodec(const void* mem, SIZE_T size,
    ...
    vislib::graphics::BitmapCodecCollection::CodecArray& outUnsureCodecs) const {
