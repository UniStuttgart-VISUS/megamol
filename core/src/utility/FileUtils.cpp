...
bool megamol::core::utility::FileUtils::LoadRawFile(const std::filesystem::path& filename, std::vector<char>& out_data) {
    ...
    try {
        ...
        if (!megamol::core::utility::FileUtils::FileExists<std::filesystem::path>(filename)) {
            megamol::core::utility::log::Log::DefaultLog.WriteError(
...
bool megamol::core::utility::FileUtils::WriteFile(const std::filesystem::path& filename, const std::string& in_content, bool silent) {
...
bool megamol::core::utility::FileUtils::ReadFile(const std::filesystem::path& filename, std::string& out_content, bool silent) {
