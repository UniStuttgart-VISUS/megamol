...
View3D::View3D(void)
    ...
    this->cameraOvrParam.SetUpdateCallback(&View3D::cameraOvrCallback);
...
void View3D::Render(const mmcRenderViewContext& context) {
    ...
    if (cr3d != nullptr) {
        (*cr3d)(view::CallRender3D::FnGetExtents);
 ...
 * View3D::Resize
 */
void View3D::Resize(unsigned int width, unsigned int height) {
 ...
 * View3D::UpdateFreeze
 */
void View3D::UpdateFreeze(bool freeze) {
    // intentionally empty?
}
 ...
 * View3D::OnKey
 */
bool view::View3D::OnKey(view::Key key, view::KeyAction action, view::Modifiers mods) {
    auto* cr = this->rendererSlot.CallAs<CallRender3D>();
    if (cr != nullptr) {
        view::InputEvent evt;
        ...
        if ((*cr)(CallRender3D::FnOnKey)) return true;
    }
 ...
 * View3D::release
 */
void View3D::release(void) { this->removeTitleRenderer(); }

/*
 * View3D::mouseSensitivityChanged
 */
bool View3D::mouseSensitivityChanged(param::ParamSlot& p) { return true; }

/*
 * View3D::OnMouseButton
 */
 bool View3D::OnMouseButton(view::MouseButton button, view::MouseButtonAction action, view::Modifiers mods) {
     return true;
 }
 ...
 * View3D::OnMouseMove
 */
bool View3D::OnMouseMove(double x, double y) {
    return true;
}

/*
 * View3D::OnMouseScroll
 */
bool View3D::OnMouseScroll(double dx, double dy) {
    return true;
}
 ...
 * View3D::OnMouseScroll
 */
void View3D::unpackMouseCoordinates(float& x, float& y) {}

/*
 * View3D::create
 */
bool View3D::create(void) {
...
/*
 * View3D::onStoreCamera
 */
bool View3D::onStoreCamera(param::ParamSlot& p) {
...
/*
 * View3D::onRestoreCamera
 */
bool View3D::onRestoreCamera(param::ParamSlot& p) {
 ...
 * View3D::onResetView
 */
bool View3D::onResetView(param::ParamSlot& p) {
    this->ResetView();
    return true;
}

/*
 * View3D::onToggleButton
 */
bool View3D::onToggleButton(param::ParamSlot& p) {
    // TODO implement
    return true;
}

/*
 * View3D::determineCameraFilePath
 */
std::string View3D::determineCameraFilePath(void) const {
...
/*
 * View3D::handleCameraMovement
 */
void View3D::handleCameraMovement(void) {
...
/*
 * View3D::setCameraValues
 */
void View3D::setCameraValues(const view::Camera_2& cam) {
...
/*
 * View3D::adaptCameraValues
 */
bool View3D::adaptCameraValues(view::Camera_2& cam) {
    bool result = false;
...
bool View3D::cameraOvrCallback(param::ParamSlot& p) {
