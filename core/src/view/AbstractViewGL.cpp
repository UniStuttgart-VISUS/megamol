...
/*
 * view::AbstractViewGL::AbstractViewGL
 */
view::AbstractViewGL::AbstractViewGL(void) : Module(),
        renderSlot("render", "Connects modules requesting renderings"),
        hooks() {
    // InputCall
    this->renderSlot.SetCallback(
        view::CallRenderViewGL::ClassName(), InputCall::FunctionName(InputCall::FnOnKey), &AbstractViewGL::OnKeyCallback);
    this->renderSlot.SetCallback(
        view::CallRenderViewGL::ClassName(), InputCall::FunctionName(InputCall::FnOnChar), &AbstractViewGL::OnCharCallback);
    this->renderSlot.SetCallback(view::CallRenderViewGL::ClassName(), InputCall::FunctionName(InputCall::FnOnMouseButton),
        &AbstractViewGL::OnMouseButtonCallback);
    this->renderSlot.SetCallback(view::CallRenderViewGL::ClassName(), InputCall::FunctionName(InputCall::FnOnMouseMove),
        &AbstractViewGL::OnMouseMoveCallback);
    this->renderSlot.SetCallback(view::CallRenderViewGL::ClassName(), InputCall::FunctionName(InputCall::FnOnMouseScroll),
        &AbstractViewGL::OnMouseScrollCallback);
    // AbstractCallRenderGL
    this->renderSlot.SetCallback(view::CallRenderViewGL::ClassName(),
        AbstractCallRenderGL::FunctionName(AbstractCallRenderGL::FnRender), &AbstractViewGL::OnRenderView);
    this->renderSlot.SetCallback(view::CallRenderViewGL::ClassName(),
        AbstractCallRenderGL::FunctionName(AbstractCallRenderGL::FnGetExtents), &AbstractViewGL::GetExtents);
    // CallRenderViewGL
    this->renderSlot.SetCallback(view::CallRenderViewGL::ClassName(),
        view::CallRenderViewGL::FunctionName(view::CallRenderViewGL::CALL_FREEZE), &AbstractViewGL::OnFreezeView);
    this->renderSlot.SetCallback(view::CallRenderViewGL::ClassName(),
        view::CallRenderViewGL::FunctionName(view::CallRenderViewGL::CALL_UNFREEZE), &AbstractViewGL::OnUnfreezeView);
    this->renderSlot.SetCallback(view::CallRenderViewGL::ClassName(),
        view::CallRenderViewGL::FunctionName(view::CallRenderViewGL::CALL_RESETVIEW), &AbstractViewGL::onResetView);
 ...
 * view::AbstractViewGL::~AbstractViewGL
 */
view::AbstractViewGL::~AbstractViewGL(void) {
    this->hooks.Clear(); // DO NOT DELETE OBJECTS
}


/*
 * view::AbstractViewGL::IsParamRelevant
 */
bool view::AbstractViewGL::IsParamRelevant(
...
/*
 * view::AbstractViewGL::DesiredWindowPosition
 */
bool view::AbstractViewGL::DesiredWindowPosition(int *x, int *y, int *w,
        int *h, bool *nd) {
...
/*
 * view::AbstractViewGL::OnRenderView
 */
bool view::AbstractViewGL::OnRenderView(Call& call) {
    throw vislib::UnsupportedOperationException(
        "AbstractViewGL::OnRenderView", __FILE__, __LINE__);
}

/*
 * view::AbstractViewGL::desiredWindowPosition
 */
bool view::AbstractViewGL::desiredWindowPosition(const vislib::StringW& str,
...
/*
 * view::AbstractViewGL::unpackMouseCoordinates
 */
void view::AbstractViewGL::unpackMouseCoordinates(float &x, float &y) {
    // intentionally empty
    // do something smart in the derived classes
}

/*
 * view::AbstractViewGL::onResetView
 */
bool view::AbstractViewGL::onResetView(Call& call) {
    this->ResetView();
    return true;
}


bool view::AbstractViewGL::GetExtents(Call& call) {
    throw vislib::UnsupportedOperationException("AbstractViewGL::GetExtents", __FILE__, __LINE__);
    return false;
}

bool view::AbstractViewGL::OnKeyCallback(Call& call) {
    try {
...
bool view::AbstractViewGL::OnCharCallback(Call& call) {
    try {
        view::CallRenderViewGL& cr = dynamic_cast<view::CallRenderViewGL&>(call);
        auto& evt = cr.GetInputEvent();
...
bool view::AbstractViewGL::OnMouseButtonCallback(Call& call) {
    try {
        view::CallRenderViewGL& cr = dynamic_cast<view::CallRenderViewGL&>(call);
        auto& evt = cr.GetInputEvent();
...
bool view::AbstractViewGL::OnMouseMoveCallback(Call& call) {
    try {
        view::CallRenderViewGL& cr = dynamic_cast<view::CallRenderViewGL&>(call);
        auto& evt = cr.GetInputEvent();
...
bool view::AbstractViewGL::OnMouseScrollCallback(Call& call) {
    try {
        view::CallRenderViewGL& cr = dynamic_cast<view::CallRenderViewGL&>(call);
        auto& evt = cr.GetInputEvent();
