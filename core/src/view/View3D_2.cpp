...
View3D_2::View3D_2(void)
	...
	this->cam.image_tile(cam_type::screen_rectangle_type(std::array<int, 4>{0, 0, 100, 100}));
...
void View3D_2::Resize(unsigned int width, unsigned int height) {
	...
	this->cam.image_tile(cam_type::screen_rectangle_type(std::array<int, 4>({0, 0, static_cast<int>(width), static_cast<int>(height)})));
}
