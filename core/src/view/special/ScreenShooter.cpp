...
view::special::ScreenShooter::ScreenShooter(const bool reducedParameters) : job::AbstractJob(), Module(),
    ...
    this->imageFilenameSlot << new param::FilePathParam("Unnamed.png", param::FilePathParam::Flag_File_ToBeCreated | param::FilePathParam::Flag_File_RestrictExtension, { "png" });
