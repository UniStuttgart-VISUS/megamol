...
#ifndef MMPROTEINPLUGIN_GROMACSLOADER_H_INCLUDED
#define MMPROTEINPLUGIN_GROMACSLOADER_H_INCLUDED
...
namespace protein {
    ...
    /**
     * Data source for Gromacs files
     */

    class GromacsLoader : public megamol::core::view::AnimDataModule
    {
    public:
    ...
    private:
        ...
        core::param::ParamSlot topFilenameSlot;
...
#endif // MMPROTEINPLUGIN_GROMACSLOADER_H_INCLUDED
