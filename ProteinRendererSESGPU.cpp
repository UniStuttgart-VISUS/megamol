...
/*
 * ProteinRendererSESGPU::ProteinRendererSESGPU
 */
ProteinRendererSESGPU::ProteinRendererSESGPU( void ) : Renderer3DModule(),
 ...
 * ProteinRendererSESGPU::~ProteinRendererSESGPU
 */
ProteinRendererSESGPU::~ProteinRendererSESGPU(void)
{
    this->Release();
}
...
/*
 * ProteinRendererSESGPU::release
 */
void protein::ProteinRendererSESGPU::release( void )
{
...
/*
 * ProteinRendererSESGPU::create
 */
bool ProteinRendererSESGPU::create( void )
{
...
/*
 * ProteinRendererSESGPU::GetCapabilities
 */
bool ProteinRendererSESGPU::GetCapabilities( Call& call) {
...
/*
 * ProteinRendererSESGPU::GetExtents
 */
bool ProteinRendererSESGPU::GetExtents( Call& call) {
    view::CallRender3D *cr3d = dynamic_cast<view::CallRender3D *>(&call);
    if (cr3d == NULL) return false;
...
/*
 * ProteinRendererSESGPU::Render
 */
bool ProteinRendererSESGPU::Render( Call& call )
{
    /*
    ...
    */
	...
	this->FindVisibleAtoms( protein);   // GTX260, 1m40: 420 fps
...
/*
 * ProteinRendererSESGPU::deinitialise
 */
void ProteinRendererSESGPU::deinitialise(void)
{
}
 ...
 */
void ProteinRendererSESGPU::RenderAtomIdGPU( const CallProteinData *protein) {
 ...
 */
void ProteinRendererSESGPU::CreateVisibilityFBO( unsigned int maxSize) {
 ...
 */
void ProteinRendererSESGPU::CreateVisibleAtomsFBO( unsigned int atomCount) {
 ...
 */
void ProteinRendererSESGPU::CreateTriangleFBO( unsigned int atomCount, unsigned int vicinityCount) {
 ...
 * creates the FBO for reduced surface triangle generation
 */
void ProteinRendererSESGPU::CreateVisibleTriangleFBO( unsigned int atomCount, unsigned int vicinityCount) {
 ...
 */
void ProteinRendererSESGPU::FindVisibleAtoms( const CallProteinData *protein) {
    // counter
    unsigned int cnt;
 ...
 */
void ProteinRendererSESGPU::ComputeVisibleAtomsVicinityTable( const CallProteinData *protein) {
 ...
 */
void ProteinRendererSESGPU::ComputeRSGeomShader( const CallProteinData *protein) {
    glDisable( GL_LIGHTING);
    glEnable( GL_DEPTH_TEST);
    // bind textures
    glEnable( GL_TEXTURE_2D );
 ...
 */
void ProteinRendererSESGPU::ComputeRSFragShader( const CallProteinData *protein) {
    // create FBO
 ...
 */
void ProteinRendererSESGPU::RenderTriangles( const CallProteinData *protein) {
 ...
 */
void ProteinRendererSESGPU::FindVisibleTriangles( const CallProteinData *protein) {
    // generate FBO
 ...
 */
void ProteinRendererSESGPU::CreateAdjacentTriangleFBO( unsigned int atomCount, unsigned int vicinityCount) {
 ...
 */
void ProteinRendererSESGPU::FindAdjacentTriangles( const CallProteinData *protein) {
 ...
 */
void ProteinRendererSESGPU::CreateTransformFeedbackVBO() {
    /////////////////
    // set up VBOs //
    /////////////////
 ...
 */
unsigned int ProteinRendererSESGPU::CreateGeometricPrimitives( const CallProteinData *protein) {
    // enable and set up triangle drawing shader
    this->drawVisibleTriangleShader.Enable();
 ...
 */
void ProteinRendererSESGPU::CreateSingularityTexture( const CallProteinData *protein, unsigned int numProbes) {
 ...
 */
void ProteinRendererSESGPU::RenderVisibleAtomsGPU( const CallProteinData *protein) {
    // set viewport
	float viewportStuff[4] =
	{
		cameraInfo->TileRect().Left(),
 ...
 */
void ProteinRendererSESGPU::RenderSES( const CallProteinData *protein, unsigned int primitiveCount) {
 ...
 */
void ProteinRendererSESGPU::MarkAdjacentAtoms( const CallProteinData *protein) {
