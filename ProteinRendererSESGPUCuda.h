...
#ifndef MEGAMOL_PROTRENSESGPUCUDA_H_INCLUDED
#define MEGAMOL_PROTRENSESGPUCUDA_H_INCLUDED
#if (_MSC_VER > 1000)
#pragma once
#endif /* (_MSC_VER > 1000) */
...
namespace protein {
     ...
     */
    class ProteinRendererSESGPUCuda : public megamol::core::view::Renderer3DModule
    {
    public:
        ...
        {
            return "ProteinRendererSESGPUCuda";
        }
        ...
        /** ctor */
        ProteinRendererSESGPUCuda(void);
        
        /** dtor */
        virtual ~ProteinRendererSESGPUCuda(void);
    ...
    protected:
         ...
         * @param protein The protein call.
         */
        void ComputeVicinityTableCUDA( const CallProteinData *protein);
         ...
         */
        bool initCuda( const CallProteinData *protein, uint gridDim);

		/**
		 * Write atom positions and radii to an array for processing in CUDA
		 */
		void writeAtomPositions( const CallProteinData *protein );
...
#endif /* MEGAMOL_PROTRENSESGPUCUDA_H_INCLUDED */
