...
#ifndef MMPROTEINPLUGIN_MOLECULARAOSHADER_H_INCLUDED
#define MMPROTEINPLUGIN_MOLECULARAOSHADER_H_INCLUDED
...
namespace protein {
    ...
    public:
		 ...
		 * volume (delete[] it!)
         */
        float* createVolume(class MolecularDataCall& mol);
        /**
         * Computes the AO Volume. The callee takes ownership of the returned 
		 * volume (delete[] it!)
         */
        float* createVolumeDebug(class MolecularDataCall& mol);
...
#endif /* MMPROTEINPLUGIN_MOLECULARAOSHADER_H_INCLUDED */
