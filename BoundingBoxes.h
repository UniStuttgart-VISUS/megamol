...
namespace core {
    ...
    public:
         ...
         */
        inline void SetObjectSpaceBBox(const float& left, const float& bottom,
         ...
         * @param front  The z-coordinate of the right/top/front point.
         */
        inline void SetObjectSpaceClipBox(const float& left, const float& bottom,
                const float& back, const float& right, const float& top,
                const float& front) {
         ...
         * @param front  The z-coordinate of the right/top/front point.
         */
        inline void SetWorldSpaceBBox(const float& left, const float& bottom,
                const float& back, const float& right, const float& top,
                const float& front) {
         ...
         * @param front  The z-coordinate of the right/top/front point.
         */
        inline void SetWorldSpaceClipBox(const float& left, const float& bottom,
                const float& back, const float& right, const float& top,
                const float& front) {
