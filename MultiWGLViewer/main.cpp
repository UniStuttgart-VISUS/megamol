...
MEGAMOLVIEWER_API bool MEGAMOLVIEWER_CALL(mmvCreateWindow)(void *hView,
    ...
    megamol::wgl::Window *win = new megamol::wgl::Window(*inst, 4);
...
MEGAMOLVIEWER_API void MEGAMOLVIEWER_CALL(mmvSetWindowSize)(void *hWnd,
	...
	// For now, we don't support repositioning the windows, because we want to stick to the
	// virtual screens to keep our GPU affinity.
	return;
