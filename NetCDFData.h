...
namespace protein {
     ...
     */
    class NetCDFData : public view::AnimDataModule {
	public:
	...
	private:
		 ...
		 */
		bool NetCDFDataCallback (Call& call);
		 ...
		 */
		bool readSecondaryStructure(void);
		...
		/** Callee slot */
		CalleeSlot m_generalDataSlot;
		CalleeSlot m_RMSFrameDataSlot1;
		CalleeSlot m_RMSFrameDataSlot2;

		/** parameter slot for filename */
		param::ParamSlot m_filenameParam;
