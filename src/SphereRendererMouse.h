...
#ifndef MMPROTEINCUDAPLUGIN_SPHERERENDERERMOUSE_H_INCLUDED
#define MMPROTEINCUDAPLUGIN_SPHERERENDERERMOUSE_H_INCLUDED
...
#endif // MMPROTEINCUDAPLUGIN_SPHERERENDERERMOUSE_H_INCLUDED
