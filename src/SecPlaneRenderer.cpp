...
SecPlaneRenderer::SecPlaneRenderer(void) : view::Renderer3DModule(),
    ...
    this->textureSlot.SetCompatibleCall<VTIDataCallDescription>();
...
/*
 * SecPlaneRenderer::GetCapabilities
 */
bool SecPlaneRenderer::GetCapabilities(megamol::core::Call& call) {
...
bool SecPlaneRenderer::GetExtents(megamol::core::Call& call) {
    ...
    VTIDataCall *vti = this->textureSlot.CallAs<VTIDataCall>();
    if (vti == NULL) {
        return false;
    }
    if (!(*vti)(VTIDataCall::CallForGetExtent)) {
        return false;
    }
...
bool SecPlaneRenderer::Render(megamol::core::Call& call) {
    ...
    if (!(*vti)(VTIDataCall::CallForGetData)) {
        return false;
    }
