...
bool megamol::infovis::NVGDiagramRenderer::assertData(floattable::CallFloatTableData * ft) {
    this->floatTable = ft;
...
bool megamol::infovis::NVGDiagramRenderer::isAnythingDirty() {
    return this->abcissaSelectorSlot.IsDirty();
}

void megamol::infovis::NVGDiagramRenderer::resetDirtyFlags() {
