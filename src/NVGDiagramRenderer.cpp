...
bool NVGDiagramRenderer::create(void) {
    ...
    auto nvgFontSans = nvgCreateFont((NVGcontext*)this->nvgCtx, "sans", std::string(T2A(font_path)).c_str());
    bndSetFont(nvgFontSans);
    bndSetIconImage(nvgCreateImage((NVGcontext*)this->nvgCtx, std::string(T2A(icon_path)).c_str(), 0));
