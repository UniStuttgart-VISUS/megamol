...
#ifndef MMPROTEINCUDAPLUGIN_CRYSTALSTRCUTUREDATACALL_H_INCLUDED
#define MMPROTEINCUDAPLUGIN_CRYSTALSTRCUTUREDATACALL_H_INCLUDED
...
namespace protein_cuda {
    ...
    typedef core::CallAutoDescription<CrystalStructureDataCall>
...
#endif /* MMPROTEINCUDAPLUGIN_CRYSTALSTRCUTUREDATACALL_H_INCLUDED */
