...
#ifndef MMPROTEINCUDAPLUGIN_TOONRENDERERDEFERRED_H_INCLUDED
#define MMPROTEINCUDAPLUGIN_TOONRENDERERDEFERRED_H_INCLUDED
...
#endif // MMPROTEINCUDAPLUGIN_TOONRENDERERDEFERRED_H_INCLUDED
