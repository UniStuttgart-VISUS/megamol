...
#endif //WITH_OPENBABEL
        case OPENBABAEL_OFFSET + HAPTICS_OFFSET +  0 : return new ModuleAutoDescription<protein::SequenceRenderer>();
        case OPENBABAEL_OFFSET + HAPTICS_OFFSET +  1 : return new ModuleAutoDescription<protein::BindingSiteDataSource>();
        case OPENBABAEL_OFFSET + HAPTICS_OFFSET +  2 : return new ModuleAutoDescription<protein::SolPathDataSource>();
        case OPENBABAEL_OFFSET + HAPTICS_OFFSET +  3 : return new ModuleAutoDescription<protein::SolPathRenderer>();
        case OPENBABAEL_OFFSET + HAPTICS_OFFSET +  4 : return new ModuleAutoDescription<protein::ProteinVolumeRenderer>();
        case OPENBABAEL_OFFSET + HAPTICS_OFFSET +  5 : return new ModuleAutoDescription<protein::CCP4VolumeData>();
        case OPENBABAEL_OFFSET + HAPTICS_OFFSET +  6 : return new ModuleAutoDescription<protein::PDBLoader>();
        case OPENBABAEL_OFFSET + HAPTICS_OFFSET +  7 : return new ModuleAutoDescription<protein::SimpleMoleculeRenderer>();
        case OPENBABAEL_OFFSET + HAPTICS_OFFSET +  8 : return new ModuleAutoDescription<protein::CoarseGrainDataLoader>();
        case OPENBABAEL_OFFSET + HAPTICS_OFFSET +  9 : return new ModuleAutoDescription<protein::SphereRenderer>();
        case OPENBABAEL_OFFSET + HAPTICS_OFFSET + 10 : return new ModuleAutoDescription<protein::MoleculeSESRenderer>();
        case OPENBABAEL_OFFSET + HAPTICS_OFFSET + 11 : return new ModuleAutoDescription<protein::MoleculeCartoonRenderer>();
        case OPENBABAEL_OFFSET + HAPTICS_OFFSET + 12 : return new ModuleAutoDescription<protein::FrodockLoader>();
        case OPENBABAEL_OFFSET + HAPTICS_OFFSET + 13 : return new ModuleAutoDescription<protein::VolumeSliceRenderer>();
        case OPENBABAEL_OFFSET + HAPTICS_OFFSET + 14 : return new ModuleAutoDescription<protein::Diagram2DRenderer>();
