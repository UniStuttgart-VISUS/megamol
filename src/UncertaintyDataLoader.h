...
namespace megamol {
	namespace protein_uncertainty {
		...
		private:
			...
			*/
			void readInputFile(const vislib::StringA &pdbid);
			...
			/** Fiel ending of input file generated by python script */
			const vislib::StringA fileEnding   = ".uid";
			/** Location of input data file generated by python script */
			const vislib::StringA fileLocation = "..\\..\\cache\\";
