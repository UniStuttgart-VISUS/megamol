...
/*
 * moldyn::ParticleWorker::ParticleWorker
 */
moldyn::ParticleWorker::ParticleWorker(void) : Module(),
 ...
 * moldyn::ParticleWorker::~ParticleWorker
 */
moldyn::ParticleWorker::~ParticleWorker(void) {
    this->Release(); // implicitly calls 'release'
}


/*
 * moldyn::ParticleWorker::create
 */
bool moldyn::ParticleWorker::create(void) {
...
/*
 * moldyn::ParticleWorker::release
 */
void moldyn::ParticleWorker::release(void)
{
...
/*
 * moldyn::ParticleWorker::getData
 */
bool moldyn::ParticleWorker::getDataCallback(Call& call) {
 ...
 */
bool moldyn::ParticleWorker::getExtentCallback(Call& call) {
    MultiParticleDataCall *outMpdc = dynamic_cast<MultiParticleDataCall*>(&call);
