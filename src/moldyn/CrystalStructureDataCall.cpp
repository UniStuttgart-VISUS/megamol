 ...
 */
const unsigned int core::moldyn::CrystalStructureDataCall::CallForGetData = 0;


/*
 * core::moldyn::CrystalStructureDataCall:CallForGetExtent
 */
const unsigned int core::moldyn::CrystalStructureDataCall::CallForGetExtent = 1;


/*
 * CrystalStructureDataCall::CrystalStructureDataCall
 */
core::moldyn::CrystalStructureDataCall::CrystalStructureDataCall(void) :
