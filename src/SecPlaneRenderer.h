...
#ifndef MMPROTEINCUDAPLUGIN_SECPLANERENDERER_H_INCLUDED
#define MMPROTEINCUDAPLUGIN_SECPLANERENDERER_H_INCLUDED
...
#endif // MMPROTEINCUDAPLUGIN_SECPLANERENDERER_H_INCLUDED
