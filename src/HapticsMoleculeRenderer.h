...
#ifndef MMPROTEINCUDAPLUGIN_HAPTICSMOLECULERENDERER_H_INCLUDED
#define MMPROTEINCUDAPLUGIN_HAPTICSMOLECULERENDERER_H_INCLUDED
...
#endif // MMPROTEINCUDAPLUGIN_HAPTICSMOLECULERENDERER_H_INCLUDED
