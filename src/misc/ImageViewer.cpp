...
void misc::ImageViewer::interpretLine(const vislib::TString source, vislib::TString& left, vislib::TString& right) {
...
/*
* misc::ImageViewer::onSlideshowPasted
*/
bool misc::ImageViewer::onSlideshowPasted(param::ParamSlot &slot) {
    vislib::TString left, right;
...
/*
* misc::ImageViewer::onFirstPressed
*/
bool misc::ImageViewer::onFirstPressed(param::ParamSlot &slot) {
...
/*
* misc::ImageViewer::onPreviousPressed
*/
bool misc::ImageViewer::onPreviousPressed(param::ParamSlot &slot) {
...
/*
* misc::ImageViewer::onNextPressed
*/
bool misc::ImageViewer::onNextPressed(param::ParamSlot &slot) {
    this->currentSlot.Param<param::IntParam>()->SetValue(this->currentSlot.Param<param::IntParam>()->Value() + 1);
    return true;
}
...
/*
* misc::ImageViewer::onLastPressed
*/
bool misc::ImageViewer::onLastPressed(param::ParamSlot &slot) {
...
/*
* misc::ImageViewer::onCurrentSet
*/
bool misc::ImageViewer::onCurrentSet(param::ParamSlot &slot) {
