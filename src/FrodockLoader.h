...
#ifndef MMPROTEINCUDAPLUGIN_FRODOCKLOADER_H_INCLUDED
#define MMPROTEINCUDAPLUGIN_FRODOCKLOADER_H_INCLUDED
...
#endif // MMPROTEINCUDAPLUGIN_FRODOCKLOADER_H_INCLUDED
