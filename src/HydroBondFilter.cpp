 ...
 */
HydroBondFilter::HydroBondFilter() : Module(),
	...
	this->outDataSlot.SetCallback(MolecularDataCall::ClassName(), MolecularDataCall::FunctionName(MolecularDataCall::CallForGetData), &HydroBondFilter::getData);
	this->outDataSlot.SetCallback(MolecularDataCall::ClassName(), MolecularDataCall::FunctionName(MolecularDataCall::CallForGetExtent), &HydroBondFilter::getExtent);
...
bool HydroBondFilter::getData(Call& call) {
	...
	*outCall = *inCall; // deep copy
	...
	if (this->alphaHelixHBonds.IsDirty() || this->betaSheetHBonds.IsDirty() || this->otherHBonds.IsDirty() || 
		this->cAlphaHBonds.IsDirty() || this->hBondDonorAcceptorDistance.IsDirty() || lastDataHash != inCall->DataHash()) {
...
bool HydroBondFilter::getExtent(Call& call) {
	...
	if (this->hBondDonorAcceptorDistance.IsDirty() || this->alphaHelixHBonds.IsDirty() || this->betaSheetHBonds.IsDirty() || 
		this->otherHBonds.IsDirty() || this->cAlphaHBonds.IsDirty()) {
