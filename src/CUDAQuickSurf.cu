...
int CUDAQuickSurf::free_bufs_map() {
  qsurf_gpuhandle *gpuh = (qsurf_gpuhandle *) voidgpu;
...
int CUDAQuickSurf::get_chunk_bufs_map(int testexisting,
                                  long int natoms, int colorperatom, 
                                  int gx, int gy, int gz,
                                  int &cx, int &cy, int &cz,
                                  int &sx, int &sy, int &sz,
...
int CUDAQuickSurf::getMapSizeX() {
  qsurf_gpuhandle *gpuh = (qsurf_gpuhandle *) voidgpu;
  return gpuh->gx;
}

int CUDAQuickSurf::getMapSizeY() {
  qsurf_gpuhandle *gpuh = (qsurf_gpuhandle *) voidgpu;
  return gpuh->gy;
}

int CUDAQuickSurf::getMapSizeZ() {
  qsurf_gpuhandle *gpuh = (qsurf_gpuhandle *) voidgpu;
  return gpuh->gz;
}
