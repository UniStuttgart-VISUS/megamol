...
#ifndef MMPROTEINCUDAPLUGIN_MDDRIVERCONNECTOR_H_INCLUDED
#define MMPROTEINCUDAPLUGIN_MDDRIVERCONNECTOR_H_INCLUDED
...
namespace protein_cuda {
    ...
    public:
         ...
         */
        struct MDDHeader {
            unsigned int type; // this is always associated with a type from the MDDHeaderType enum, but needs to be an int for byte swapping and to make it easier to send over networks.
            unsigned int length; // the length (in number of atoms) of the coordinates list being transferred, or other special values
        };
...
#endif // MMPROTEINCUDAPLUGIN_MDDRIVERCONNECTOR_H_INCLUDED