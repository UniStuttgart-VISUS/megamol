...
#ifndef MMPROTEINCUDAPLUGIN_VOLDIRRENDERER_H_INCLUDED
#define MMPROTEINCUDAPLUGIN_VOLDIRRENDERER_H_INCLUDED
...
#endif // MMPROTEINCUDAPLUGIN_VOLDIRRENDERER_H_INCLUDED
