...
#ifndef MMPROTEINCUDAPLUGIN_SPHEREDATACALL_H_INCLUDED
#define MMPROTEINCUDAPLUGIN_SPHEREDATACALL_H_INCLUDED
...
namespace protein_cuda {
	...
	typedef megamol::core::CallAutoDescription<SphereDataCall> SphereDataCallDescription;


} /* end namespace protein_cuda */
} /* end namespace megamol */

#endif /* MMPROTEINCUDAPLUGIN_SPHEREDATACALL_H_INCLUDED */
