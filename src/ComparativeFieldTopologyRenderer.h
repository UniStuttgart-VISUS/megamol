...
private:
     ...
     *                   field strength
     */
    void calcElectrostaticField(VTIDataCall *cmd,
     ...
     * @param cmd The data call.
     */
    bool renderFieldArrows(const VTIDataCall *cmd);
    ...
    /** TODO */
    inline float GetPotentialAt(VTIDataCall *dc, unsigned int x, unsigned int y,
            unsigned int z) {
