 ...
 * decodeints
 */
void GROLoader::Frame::decodeints( char *buff, int offset, int num_of_bits,
...
bool GROLoader::Frame::writeFrame(std::ofstream *outfile, float precision,
 ...
 *
 */
bool GROLoader::Frame::encodeints(char *outbuff, int num_of_bits,
 ...
 */
void GROLoader::Frame::encodebits(char *outbuff, int bitsize, int bitoffset,
                                  unsigned int num ) {
 ...
 */
bool GROLoader::Frame::SetAtomPosition( unsigned int idx, float x, float y,
                                        float z) {
...
bool GROLoader::getData( core::Call& call) {
    ...
    if( !this->xtcFileValid) {
        ...
        Frame *fr = NULL;
        fr = dynamic_cast<GROLoader::Frame *>(this->
 ...
 * GROLoader::loadFrame
 */
void GROLoader::loadFrame( view::AnimDataModule::Frame *frame,
                           unsigned int idx) {
 ...
 */
void GROLoader::parseAtomEntry( vislib::StringA &atomEntry, unsigned int atom,
        unsigned int frame, vislib::Array<vislib::TString>& solventResidueNames) {
    // temp variables
    vislib::StringA tmpStr;
    vislib::math::Vector<float, 3> pos;
    // set atom position
    pos.Set( float( atof( atomEntry.Substring( 20, 8))),
 ...
 */
void GROLoader::setAtomPositionToFrame( vislib::StringA &atomEntry, unsigned int atom,
        unsigned int frame) {
    // temp variables
    vislib::StringA tmpStr;
    vislib::math::Vector<float, 3> pos;
