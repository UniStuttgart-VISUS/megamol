 ...
 */
void UncertaintyColor::FillAminoAcidColorTable(
 ...
 */
UncertaintyColor::ColoringMode UncertaintyColor::GetModeByIndex(const megamol::protein_calls::MolecularDataCall *mol,
    unsigned int idx) {
...
void UncertaintyColor::MakeColorTable(const megamol::protein_calls::MolecularDataCall *mol,
    ...
    if(atomColorTable.IsEmpty()) {
        ...
        UncertaintyColor::MakeColorTable(mol, cm0, color0, colorLookupTable, rainbowColors,
            minGradColor, midGradColor, maxGradColor, true, bs);

        // Compute second color table
        UncertaintyColor::MakeColorTable(mol, cm1, color1, colorLookupTable, rainbowColors,
            minGradColor, midGradColor, maxGradColor, true, bs);
 ...
 */
void UncertaintyColor::MakeRainbowColorTable( unsigned int num,
    vislib::Array<vislib::math::Vector<float, 3> > &rainbowColors) {
 ...
 */
void UncertaintyColor::ReadColorTableFromFile( vislib::StringA filename,
          vislib::Array<vislib::math::Vector<float, 3> > &colorLookupTable) {
