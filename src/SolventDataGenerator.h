...
#ifndef MMPROTEINCUDAPLUGIN_SolventDataGenerator_H_INCLUDED
#define MMPROTEINCUDAPLUGIN_SolventDataGenerator_H_INCLUDED
...
#endif // MMPROTEINCUDAPLUGIN_SolventDataGenerator_H_INCLUDED
