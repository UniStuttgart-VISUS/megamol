...
#ifndef MEGAMOL_PROTEIN_DIAGRAMCALL_H_INCLUDED
#define MEGAMOL_PROTEIN_DIAGRAMCALL_H_INCLUDED
...
namespace protein {
    ...
    public:
        ...
        public:
            ...
            /** Ctor. */
            DiagramGuide(float position, GuideTypes type) : pos(position),
                    type(type) {
            }
        ...
        public:
            ...
            /** Ctor. */
            DiagramMarker(SIZE_T index, MarkerTypes type,
                    vislib::StringA tooltip = NULL, void *userData = NULL) : index(index), 
                    type(type), tooltip(tooltip), userData(userData) {
            }
        ...
        public:
             ...
             */
            virtual bool GetAbscissaValue(const SIZE_T index, const SIZE_T abscissaIndex, vislib::StringA *category) const = 0;
        ...
        public:
            /** Ctor. */
            DiagramSeries(vislib::StringA name, DiagramMappable *mappable) : mappable(mappable), color(0.5f, 0.5f, 0.5f, 1.0f),
                    name(name), markers()/*, visible(true)*/ {
            }
